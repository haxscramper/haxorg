...
def get_types():
    return [
        ...
        d_org("Center",
              Doc("Center nested content in export"),
              bases=["Format"]),
        d_org(
            "Command",
        ...
        d_org(
            ...
            methods=list_l(
                Method(
                    ...
                    arguments=list_l(Ident(t_str(), "key")))),
            fields=list_l(
                Field(t_vec(t_id("CmdArgument")), "positional",
                      Doc("Positional arguments that had no keys")),
                Field(t_map(t_str(), t_id("CmdArgument")), "named",
                      Doc("Stored key-value mapping")))),
        d_org("CmdArgument",
              Doc("Single key-value (or positional)"),
              bases=["Org"],
              fields=list_l(opt_field(t_str(), "key", Doc("Key")),
                            Field(t_str(), "value", Doc("Value"))),
              methods=list_l(
                  Method(t_opt("int"),
                         "getInt",
                         Doc("Parse argument as integer value"),
                         isConst=True),
                  Method(t_opt("bool"),
                         "getBool",
                         Doc("Get argument as bool"),
                         isConst=True),
                  Method(t_str(),
                         "getString",
                         Doc("Get original string"),
                         isConst=True))),
        d_org(
            "Export",
            ...
            nested=list_l(
                Enum(
                    "Format", Doc("Export block format type"),
                    list_l(
                        EField("Inline",
                               Doc("Export directly in the paragraph")),
            ...
            fields=list_l(
                Field(
                    "Format",
                    "format",
                    Doc("Export block type"),
                    value="Format::Inline"),
                Field(
                    t_str(), "exporter", Doc("Exporter backend name")),
                id_field("CmdArguments", "parameters",
                         Doc("Additional parameters aside from 'exporter',")),
                opt_field(
                    t_str(), "placement",
                    Doc("Customized position of the text in the final exporting document."
                        )),
                Field(t_str(), "content",
                      Doc("Raw exporter content string")))),
        d_org("AdmonitionBlock",
              Doc("Block of text with admonition tag: 'note',', 'warning','"),
              bases=["Block"]),
        d_org(
            "Code",
                                ...
                                Struct(["Dedent"],
                                       ...
                                       fields=list_l(
                                           Field("int",
                                                 ...
                                                 value="0"))))))),
                Enum(["Results"],
                     Doc("What to do with newly evaluated result"),
                     list_l(
                         EField(
                             "Replace",
                             Doc("Remove old result, replace with new value"))
                     )),
                Enum(
                    ["Exports"],
                    Doc("What part of the code block should be visible in export"
                        ),
                    list_l(
                        EField("None",
                               Doc("Hide both original code and run result")),
                        EField("Both", Doc("Show output and code")),
                        EField("Code", Doc("Show only code")),
                        EField("Results",
                               Doc("Show only evaluation results"))))),
            fields=list_l(
                Field(t_opt(t_str()),
                      "lang",
                      Doc("Code block language name"),
                      value="std::nullopt"),
                Field(t_vec("Switch"),
                      "switches",
                      Doc("Switch options for block"),
                      value="{}"),
                Field("Exports",
                      "exports",
                      Doc("What to export"),
                      value="Exports::Both"),
                id_field(
                    "CmdArguments", "parameters",
                    Doc("Additional parameters that are language-specific")),
                Field("bool", "cache", Doc("Do cache values?"), value="false"),
                Field("bool", "eval", Doc("Eval on export?"), value="false"),
                Field("bool",
                      "noweb",
                      Doc("Web-tangle code on export/run"),
                      value="false"),
        ...
        d_org(
            ...
            nested=list_l(
                ...
                Struct(
                    ...
                    nested=list_l(
                        Enum(
                            ["Mode"], Doc("Timestamp repetition mode"),
                            list_l(
                                EField(
                                    "None",
                                    Doc("Do not repeat task on completion")),
                                EField("Exact", Doc("?")),
                                EField(
                                    "FirstMatch",
                                    Doc("Repeat on the first matching day in the future"
                                        )),
                                EField(
                                    "SameDay",
                                    Doc("Repeat task on the same day next week/month/year"
                                        )))),
                        Enum(
                            ["Period"],
                            ...
                            list_l(EField("Year", Doc("")),
                                   EField("Month", Doc("")),
                                   EField("Week", Doc("")),
                                   EField("Day", Doc("")),
                                   EField("Hour", Doc("")),
                                   EField("Minute", Doc(""))))),
                    fields=list_l(Field("Mode", "mode", Doc("mode")),
                ...
                Group(list_l(
                    Struct(["Static"],
                           Doc(""),
                           fields=list_l(
                               Field(t_opt("Repeat"), "repeat", Doc("")),
                               Field("UserTime", "time", Doc("")))),
                    Struct(["Dynamic"],
                           Doc(""),
                           fields=list_l(Field(t_str(), "expr", Doc(""))))),
        ...
        d_org("TimeRange",
              ...
              bases=["Org"],
              fields=list_l(id_field("Time", "from", Doc("Starting time")),
        ...
        d_org("Macro",
              ...
              fields=list_l(
                  ...
                  Field(t_vec(t_str()),
                        "arguments",
                        Doc("Raw uninterpreted macro arguments"),
                        value="{}"))),
        d_org("Symbol",
              ...
              nested=list_l(
                  Struct(["Param"],
                         ...
                         fields=list_l(
                             Field(t_opt(t_str()), "key",
                                   Doc("Key -- for non-positional")),
                             Field(t_str(), "value",
                                   Doc("Uninterpreted value"))))),
              fields=list_l(
                  Field(t_str(), "name", Doc("Name of the symbol")),
                  Field(t_vec("Param"), "parameters",
                        Doc("Optional list of parameters")),
                  Field(t_vec(t_id()), "positional",
                        Doc("Positional parameters")))),
        d_org(
            "SubtreeLog",
            ...
            methods=list_l(
                Method("void",
                       "setDescription",
                       Doc(""),
                       arguments=list_l(Ident(t_id("StmtList"), "desc")))),
            nested=list_l(
                Struct(["DescribedLog"],
                ...
                Group(list_l(
                    Struct(
                        ...
                        bases=["DescribedLog"],
                        nested=list_l(
                            d_simple_enum("Action",
                                          Doc("Priority change action"),
                                          "Added", "Removed", "Changed")),
                        fields=list_l(
                            opt_field(
                                "QString", "oldPriority",
                                Doc("Previous priority for change and removal")
                            ),
                            opt_field(
                                "QString", "newPriority",
                                Doc("New priority for change and addition")),
                            id_field("Time", "on",
                                     Doc("When priority was changed")))),
                    Struct(["Note"],
                           Doc("Timestamped note"),
                           bases=["DescribedLog"],
                           fields=list_l(
                               id_field("Time", "on",
                                        Doc("Where log was taken")))),
                    Struct(["Refile"],
                           Doc("Refiling action"),
                           bases=["DescribedLog"],
                           fields=list_l(
                               id_field("Time", "on",
                                        Doc("When the refiling happened")),
                               id_field("Link", "from",
                                        Doc("Link to the original subtree")))),
                    Struct(
                        ["Clock"],
        ...
        d_org(
            ...
            fields=list_l(
                ...
                vec_field(t_id("SubtreeLog"), "logbook",
                          Doc("Associated subtree log")),
                vec_field("Property", "properties",
                          Doc("Immediate properties")),
                opt_field(t_id("Time"), "closed",
                          Doc("When subtree was marked as closed")),
                opt_field(t_id("Time"), "deadline",
                          Doc("When is the deadline")),
                opt_field(t_id("Time"), "scheduled",
                          Doc("When the event is scheduled"))),
            methods=list_l(
                Method(t_vec("Period"),
                       "getTimePeriods",
                       Doc(""),
                       isConst=True,
                       arguments=list_l(Ident("IntSet<Period::Kind>",
                                              "kinds"))),
            ...
            nested=list_l(
                Struct(
                    ...
                    fields=list_l(
                        Field(
                            "Kind", "kind",
                            Doc("Time period kind -- not associated with point/range distinction"
                                )),
                        Field(t_var(t_id("Time"), t_id("TimeRange")), "period",
                              Doc("Stored time point/range"))),
                    methods=list_l(
                        Method(t_id("Time"),
                               "getTime",
                               Doc("Get associated time point"),
                    ...
                    nested=list_l(
                        Enum(
                            ["Kind"], Doc("Period kind"),
                            list_l(
                                EField(
                                    "Clocked",
                                    Doc("Time period of the task execution.")),
                                EField(
                                    "Scheduled",
                                ...
                                EField(
                                    "Deadline",
                                    Doc("Date of task completion. Must be a single time point"
                                        )),
                                EField("Created",
                                       Doc("When the subtree was created")),
                                EField(
                                    "Repeated",
                                    Doc("Last repeat time of the recurring tasks"
                                        )))),
                        Pass(
                ...
                Struct(
                    ...
                    nested=list_l(
                        d_simple_enum("SetMode", Doc(""), "Override", "Add",
                                      "Subtract"),
                        d_simple_enum("InheritanceMode", Doc(""), "ThisAndSub",
                                      "OnlyThis", "OnlySub"),
                        Group(
                            list_l(
                                Struct(
                                ...
                                Struct(
                                    ...
                                    Doc(""),
                                    fields=list_l(
                                        Field(t_str(), "text", Doc("")))),
                                Struct(
                                    ["ExportLatexClass"],
                                    Doc(""),
                                    fields=list_l(
                                        Field(t_str(), "latexClass",
                                              Doc("")))),
                                Struct(
                                    ["ExportLatexClassOptions"],
                                    Doc(""),
                                    fields=list_l(
                                        Field(t_vec(t_str()), "options",
                                              Doc("")))),
                                Struct(
                                    ["ExportLatexHeader"],
                                    Doc(""),
                                    fields=list_l(
                                        Field(t_str(), "header", Doc("")))),
                                Struct(
                                    ["ExportLatexCompiler"],
                                    Doc(""),
                                    fields=list_l(
                                        Field(t_str(), "compiler", Doc("")))),
                                Struct(
                                    ["Ordered"],
                                    Doc(""),
                                    fields=list_l(
                                        Field("bool", "isOrdered", Doc("")))),
                                Struct(
                                    ["Effort"],
                                    Doc(""),
                                    fields=list_l(
                                ...
                                Struct(
                                    ...
                                    Doc(""),
                                    nested=list_l(
                                        d_simple_enum("Level", Doc(""),
                                                      "Folded", "Children",
                                                      "Content", "All")),
                                    fields=list_l(
                                        Field("Level", "level", Doc("")))),
                                Struct(
                                    ["ExportOptions"],
                                    Doc(""),
                                    fields=list_l(
                                        Field(t_str(), "backend", Doc("")),
                                        Field("UnorderedMap<Str, Str>",
                                              "values", Doc("")))),
                                Struct(
                                    ["Blocker"],
                                    Doc(""),
                                    fields=list_l(
                                        Field(t_vec(t_str()), "blockers",
                                              Doc("")))),
                                Struct(
                                    ["Unnumbered"],
                                    Doc("")),
        ...
        d_org("Leaf",
              ...
              concreteKind=False,
              fields=list_l(
                  Field(t_str(), "text", Doc("Final leaf value"),
                        value="\"\""))),
        ...
        d_org("List",
              ...
              bases=["Org"],
              methods=list_l(
                  Method("bool", "isDescriptionList", Doc(""), isConst=True))),
        d_org("ListItem",
              Doc(""),
              bases=["Org"],
              fields=list_l(
                  Field("Checkbox",
                        ...
                        Doc(""),
                        value="Checkbox::None"),
                  Field(t_opt(t_id("Paragraph")),
                        "header",
                        Doc(""),
                        value="std::nullopt")),
              nested=list_l(
                  d_simple_enum("Checkbox", Doc(""), "None", "Done", "Empty")),
              methods=list_l(
                  Method("bool",
                         "isDescriptionItem",
                         Doc(""),
        ...
        d_org("Link",
              ...
              methods=list_l(
                  Method(t_opt(t_id()),
                         ...
                         Doc(""),
                         isConst=True,
                         arguments=list_l(Ident(t_cr("Document"), "doc"))),
                  Method(t_opt(t_id()), "resolve", Doc(""), isConst=True)),
              nested=list_l(
                  Group(list_l(
                      Struct(["Raw"],
                             Doc(""),
                             fields=list_l(Field(t_str(), "text", Doc("")))),
                      Struct(["Id"],
                             Doc(""),
                             fields=list_l(Field(t_str(), "text", Doc("")))),
                      Struct(["Person"],
                             Doc(""),
                             fields=list_l(Field(t_str(), "name", Doc("")))),
                      Struct(["Footnote"],
                             Doc(""),
                             fields=list_l(Field(t_str(), "target", Doc("")))),
                      Struct(["File"],
                             Doc(""),
                             fields=list_l(Field(t_str(), "file", Doc(""))))),
        ...
        d_org("Document",
              ...
              methods=list_l(
                  Method(t_opt(t_id()),
                         ...
                         Doc(""),
                         isConst=True,
                         arguments=list_l(Ident(t_cr(t_id()), "node"))),
                  Method(t_opt(t_id("Subtree")),
                         "getSubtree",
                         Doc(""),
                         isConst=True,
                         arguments=list_l(Ident(t_cr(t_str()), "id"))),
                  Method(t_vec("Subtree::Property"),
                         "getProperties",
                         Doc(""),
                         isConst=True,
                         arguments=list_l(
                             Ident("Subtree::Property::Kind", "kind"),
                             Ident(t_cr(t_str()), "subKind", value="\"\""))),
        ...
        d_org("Include",
              ...
              bases=["Org"],
              nested=list_l(
                  Group(list_l(Struct(["Example"], Doc("")),
                               Struct(["Export"], Doc("")),
                               Struct(["Src"], Doc("")),
        ...
        d_org("DocumentOptions",
              ...
              nested=list_l(
                  ...
                  d_simple_enum("BrokenLinks", Doc(""), "Raise", "Ignore",
                                "Mark"),
                  d_simple_enum("Visibility", Doc(""), "Overview", "Content",
                                "ShowAll", "Show2Levels", "Show3Levels",
                                "Show4Levels", "Show5Levels",
                                "ShowEverything")),
              fields=list_l(
                  Field("BrokenLinks",
                        "brokenLinks",
