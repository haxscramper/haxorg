...
void proto_serde<ext::visual::proto::VisColor, ext::visual::VisColor>::write(
...
void proto_serde<ext::visual::proto::VisColor, ext::visual::VisColor>::read(
...
void proto_serde<ext::visual::proto::VisPen, ext::visual::VisPen>::write(
    ...
    proto_serde<ext::visual::proto::VisColor, ext::visual::VisColor>::write(
...
void proto_serde<ext::visual::proto::VisPen, ext::visual::VisPen>::read(
    ...
    out->width = in.width();
    out->style = (in.style()
                  == ext::visual::proto::VisPen_LineStyle_LINE_STYLE_UNSPECIFIED)
                   ? static_cast<ext::visual::VisPen::LineStyle>(0)
                   : static_cast<ext::visual::VisPen::LineStyle>(
                         static_cast<int>(in.style()) - 1);
}

void proto_serde<ext::visual::proto::VisBrush, ext::visual::VisBrush>::write(
...
void proto_serde<ext::visual::proto::VisBrush, ext::visual::VisBrush>::read(
    ext::visual::proto::VisBrush const& in,
    ext::visual::VisBrush*              out) {
    proto_serde<ext::visual::proto::VisColor, ext::visual::VisColor>::read(
        in.color(), &out->color);
    out->style = (in.style()
                  == ext::visual::proto::VisBrush_BrushStyle_BRUSH_STYLE_UNSPECIFIED)
...
void proto_serde<ext::visual::proto::VisFont, ext::visual::VisFont>::write(
    ...
    out->set_weight(
        static_cast<ext::visual::proto::VisFont_Weight>(static_cast<int>(in.weight) + 1));
    out->set_font_style(
...
void proto_serde<ext::visual::proto::VisFont, ext::visual::VisFont>::read(
    ...
    out->weight = (in.weight() == ext::visual::proto::VisFont_Weight_WEIGHT_UNSPECIFIED)
    ...
    out->fontStyle = (in.font_style()
                      == ext::visual::proto::VisFont_FontStyle_FONT_STYLE_UNSPECIFIED)
                       ? static_cast<ext::visual::VisFont::FontStyle>(0)
                       : static_cast<ext::visual::VisFont::FontStyle>(
                             static_cast<int>(in.font_style()) - 1);
}

void proto_serde<ext::visual::proto::VisTextAlign, ext::visual::VisTextAlign>::write(
...
void proto_serde<ext::visual::proto::VisCustom, ext::visual::VisCustom>::read(
    ...
    out->attrs.clear();
    for (auto const& [k, v] : in.attrs()) { out->attrs.insert_or_assign(k, v); }

    out->debugMode = (in.debug_mode()
                      == ext::visual::proto::VisCustom_DebugMode_DEBUG_MODE_UNSPECIFIED)
                       ? static_cast<ext::visual::VisCustom::DebugMode>(0)
                       : static_cast<ext::visual::VisCustom::DebugMode>(
                             static_cast<int>(in.debug_mode()) - 1);
}

void proto_serde<ext::visual::proto::RectShape, ext::visual::VisElement::RectShape>::
    write(
    ...
    proto_serde<ext::visual::proto::VisBrush, ext::visual::VisBrush>::write(
        out->mutable_brush(), in.brush);
...
void proto_serde<ext::visual::proto::RectShape, ext::visual::VisElement::RectShape>::read(
...
void proto_serde<ext::visual::proto::LineShape, ext::visual::VisElement::LineShape>::
    write(
...
void proto_serde<ext::visual::proto::LineShape, ext::visual::VisElement::LineShape>::read(
...
void proto_serde<ext::visual::proto::PathShape, ext::visual::VisElement::PathShape>::
    write(
...
void proto_serde<ext::visual::proto::PathShape, ext::visual::VisElement::PathShape>::read(
...
void proto_serde<
    ...
    proto_serde<ext::geometry::proto::Polygon, ext::geometry::Polygon>::write(
        out->mutable_points(), in.points);
    proto_serde<ext::visual::proto::VisPen, ext::visual::VisPen>::write(
        out->mutable_pen(), in.pen);
    proto_serde<ext::visual::proto::VisBrush, ext::visual::VisBrush>::write(
        out->mutable_brush(), in.brush);
...
void proto_serde<
    ...
    proto_serde<ext::geometry::proto::Polygon, ext::geometry::Polygon>::read(
...
void proto_serde<ext::visual::proto::TextShape, ext::visual::VisElement::TextShape>::
    write(
    ...
    if (in.boundingBox.has_value()) {
        proto_serde<ext::geometry::proto::Rect, ext::geometry::Rect>::write(
            out->mutable_bounding_box(), *in.boundingBox);
    } else {
    ...
    proto_serde<ext::visual::proto::VisTextAlign, ext::visual::VisTextAlign>::write(
        out->mutable_alignment(), in.alignment);
    proto_serde<ext::visual::proto::VisColor, ext::visual::VisColor>::write(
        out->mutable_color(), in.color);
}

void proto_serde<ext::visual::proto::TextShape, ext::visual::VisElement::TextShape>::read(
    ...
    proto_serde<ext::visual::proto::VisFont, ext::visual::VisFont>::read(
        in.font(), &out->font);
    proto_serde<ext::visual::proto::VisTextAlign, ext::visual::VisTextAlign>::read(
        in.alignment(), &out->alignment);
    proto_serde<ext::visual::proto::VisColor, ext::visual::VisColor>::read(
        in.color(), &out->color);
}

void proto_serde<ext::visual::proto::PixmapShape, ext::visual::VisElement::PixmapShape>::
    write(
...
void proto_serde<ext::visual::proto::PointShape, ext::visual::VisElement::PointShape>::
    write(
...
void proto_serde<ext::visual::proto::VisElementData, ext::visual::VisElement::Data>::
    write(
    ...
    std::visit(
        [&](auto const& v) {
            ...
            if constexpr (std::is_same_v<T, ext::visual::VisElement::RectShape>) {
            ...
            } else if constexpr (std::is_same_v<T, ext::visual::VisElement::LineShape>) {
                proto_serde<ext::visual::proto::LineShape, T>::write(
                    out->mutable_line(), v);
            } else if constexpr (std::is_same_v<T, ext::visual::VisElement::PathShape>) {
            ...
            } else if constexpr (std::is_same_v<T, ext::visual::VisElement::TextShape>) {
            ...
            } else if constexpr (std::is_same_v<T, ext::visual::VisElement::PointShape>) {
...
void proto_serde<ext::visual::proto::VisElementData, ext::visual::VisElement::Data>::read(
    ...
    switch (in.data_case()) {
        ...
        case ext::visual::proto::VisElementData::kEllipse: {
            ...
            proto_serde<
                ext::visual::proto::EllipseShape,
                ext::visual::VisElement::EllipseShape>::read(in.ellipse(), &v);
            *out = v;
            return;
        }
        ...
        case ext::visual::proto::VisElementData::kPolygon: {
            ...
            proto_serde<
                ext::visual::proto::PolygonShape,
                ext::visual::VisElement::PolygonShape>::read(in.polygon(), &v);
            *out = v;
            return;
        }
        ...
        case ext::visual::proto::VisElementData::kPixmap: {
            ...
            proto_serde<
                ...
                ext::visual::VisElement::PixmapShape>::read(in.pixmap(), &v);
            *out = v;
            return;
        }
...
void proto_serde<ext::visual::proto::VisElement, ext::visual::VisElement>::write(
    ext::visual::proto::VisElement* out,
    ext::visual::VisElement const&  in) {

    proto_serde<ext::visual::proto::VisElementData, ext::visual::VisElement::Data>::write(
        out->mutable_data(), in.data);

    proto_serde<ext::visual::proto::VisCustom, ext::visual::VisCustom>::write(
        out->mutable_custom(), in.custom);
}

void proto_serde<ext::visual::proto::VisElement, ext::visual::VisElement>::read(
    ext::visual::proto::VisElement const& in,
    ext::visual::VisElement*              out) {
    proto_serde<ext::visual::proto::VisElementData, ext::visual::VisElement::Data>::read(
        in.data(), &out->data);

    proto_serde<ext::visual::proto::VisCustom, ext::visual::VisCustom>::read(
        in.custom(), &out->custom);
}

void proto_serde<ext::visual::proto::VisGroup, ext::visual::VisGroup>::write(
    ...
    for (auto const& it : in.elements) {
        proto_serde<ext::visual::proto::VisElement, ext::visual::VisElement>::write(
            out->add_elements(), it);
    }

    out->clear_subgroups();
    for (auto const& it : in.subgroups) {
        proto_serde<ext::visual::proto::VisGroup, ext::visual::VisGroup>::write(
            out->add_subgroups(), it);
    }
    ...
    if (in.max_point.has_value()) {
        proto_serde<ext::geometry::proto::Point, ext::geometry::Point>::write(
            out->mutable_max_point(), *in.max_point);
    } else {
        out->clear_max_point();
    }
...
void proto_serde<ext::visual::proto::VisGroup, ext::visual::VisGroup>::read(
    ...
    for (auto const& it : in.elements()) {
        ...
        proto_serde<ext::visual::proto::VisElement, ext::visual::VisElement>::read(
            it, &el);
    ...
    for (auto const& it : in.subgroups()) {
        ...
        proto_serde<ext::visual::proto::VisGroup, ext::visual::VisGroup>::read(it, &g);
