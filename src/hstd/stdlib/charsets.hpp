...
Const<CharSet> Utf8Starts2{slice(char(0b11000000), char(0b11011111))};
/// Start of the three-byte utf8 rune
Const<CharSet> Utf8Starts3{slice(char(0b11100000), char(0b11101111))};
/// Start of the four-byte utf8 rune
Const<CharSet> Utf8Starts4{slice(char(0b11110000), char(0b11110111))};
