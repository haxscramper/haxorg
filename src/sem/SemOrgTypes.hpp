...
struct StmtList : public sem::Org {
    ...
    static sem::SemIdT<StmtList> create(
        sem::SemId      parent,
...
struct Empty : public sem::Org {
    ...
    /// \brief Document
    static OrgSemKind const   staticKind;
    static sem::SemIdT<Empty> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Table : public sem::Stmt {
    ...
    static sem::SemIdT<Table>  create(
         sem::SemId      parent,
         Opt<OrgAdapter> original = std::nullopt);
...
struct HashTag : public sem::Inline {
    ...
    static sem::SemIdT<HashTag>    create(
           sem::SemId      parent,
           Opt<OrgAdapter> original = std::nullopt);
    virtual OrgSemKind getKind() const { return OrgSemKind::HashTag; }
    /// \brief Check if list of tag names is a prefix for either of the
    /// nested hash tags in this one
...
struct Footnote : public sem::Inline {
    ...
    static sem::SemIdT<Footnote> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Completion : public sem::Inline {
    ...
    static sem::SemIdT<Completion> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Paragraph : public sem::Stmt {
    ...
    /// \brief Document
    static OrgSemKind const       staticKind;
    static sem::SemIdT<Paragraph> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Center : public sem::Format {
    ...
    /// \brief Document
    static OrgSemKind const    staticKind;
    static sem::SemIdT<Center> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Caption : public sem::Attached {
    ...
    static sem::SemIdT<Caption> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct CommandGroup : public sem::Stmt {
    ...
    /// \brief Document
    static OrgSemKind const          staticKind;
    static sem::SemIdT<CommandGroup> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Quote : public sem::Org {
    ...
    /// \brief Quote content
    sem::SemIdT<sem::Paragraph> text = SemIdT<Paragraph>::Nil();
    static sem::SemIdT<Quote>   create(
          sem::SemId      parent,
          Opt<OrgAdapter> original = std::nullopt);
...
struct Example : public sem::Block {
    ...
    /// \brief Document
    static OrgSemKind const     staticKind;
    static sem::SemIdT<Example> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct CmdArguments : public sem::Org {
    ...
    static sem::SemIdT<CmdArguments>                 create(
                        sem::SemId      parent,
                        Opt<OrgAdapter> original = std::nullopt);
    ...
    ///
    /// Some argument values can be processed directly during convert,
    /// others will be mapped in respective exporter backends. This is a
    /// convenience method to remove things during convert stage
...
struct CmdArgument : public sem::Org {
    ...
    /// \brief Value
    Str                             value;
    static sem::SemIdT<CmdArgument> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Export : public sem::Block {
    ...
    sem::SemIdT<sem::CmdArguments>
        parameters = SemIdT<CmdArguments>::Nil();
    /// \brief Customized position of the text in the final exporting
    /// document.
    Opt<Str> placement = std::nullopt;
    /// \brief Raw exporter content string
    Str                        content;
    static sem::SemIdT<Export> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct AdmonitionBlock : public sem::Block {
    ...
    /// \brief Document
    static OrgSemKind const             staticKind;
    static sem::SemIdT<AdmonitionBlock> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Code : public sem::Block {
    ...
    struct Switch {
        ...
        struct LineStart {
            ...
            int start;
            /// \brief Continue numbering from the previous block nstead of
            /// starting anew
        ...
        BOOST_DESCRIBE_CLASS(
            ...
            (data,
             ...
             (sem::Code::Switch::CalloutFormat const&()
                  const)getCalloutFormat,
             (sem::Code::Switch::CalloutFormat & ()) getCalloutFormat,
             (sem::Code::Switch::RemoveCallout const&()
                  const)getRemoveCallout,
             (sem::Code::Switch::RemoveCallout & ()) getRemoveCallout,
             (sem::Code::Switch::EmphasizeLine const&()
                  const)getEmphasizeLine,
             ...
             (sem::Code::Switch::Kind(sem::Code::Switch::Data const&))
                 getKind,
             (sem::Code::Switch::Kind() const)getKind))
        sem::Code::Switch::Data             data;
        sem::Code::Switch::LineStart const& getLineStart() const {
            return std::get<0>(data);
        }
        sem::Code::Switch::LineStart& getLineStart() {
            return std::get<0>(data);
        }
        sem::Code::Switch::CalloutFormat const& getCalloutFormat() const {
            return std::get<1>(data);
        }
        sem::Code::Switch::CalloutFormat& getCalloutFormat() {
            return std::get<1>(data);
        }
        sem::Code::Switch::RemoveCallout const& getRemoveCallout() const {
            return std::get<2>(data);
        }
        sem::Code::Switch::RemoveCallout& getRemoveCallout() {
            return std::get<2>(data);
        }
        sem::Code::Switch::EmphasizeLine const& getEmphasizeLine() const {
            return std::get<3>(data);
        }
        sem::Code::Switch::EmphasizeLine& getEmphasizeLine() {
            return std::get<3>(data);
        }
        sem::Code::Switch::Dedent const& getDedent() const {
            return std::get<4>(data);
        }
        sem::Code::Switch::Dedent& getDedent() {
            return std::get<4>(data);
        }
        static sem::Code::Switch::Kind getKind(
            sem::Code::Switch::Data const& __input) {
            return static_cast<sem::Code::Switch::Kind>(__input.index());
        }
...
struct Time : public sem::Org {
    ...
    struct Repeat {
        ...
        /// \brief Repetition period. Temporary placeholder for now, until
        /// I figure out what would be the proper way to represent whatever
    ...
    static sem::SemIdT<Time> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
    virtual OrgSemKind       getKind() const { return OrgSemKind::Time; }
    sem::Time::Static const& getStatic() const {
        return std::get<0>(time);
    }
    sem::Time::Static&        getStatic() { return std::get<0>(time); }
    sem::Time::Dynamic const& getDynamic() const {
        return std::get<1>(time);
    }
    sem::Time::Dynamic&        getDynamic() { return std::get<1>(time); }
    static sem::Time::TimeKind getTimeKind(
        sem::Time::TimeVariant const& __input) {
        return static_cast<sem::Time::TimeKind>(__input.index());
    }
...
struct TimeRange : public sem::Org {
    ...
    static sem::SemIdT<TimeRange> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Macro : public sem::Org {
    ...
    Vec<Str>                  arguments = {};
    static sem::SemIdT<Macro> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Symbol : public sem::Org {
    ...
    static sem::SemIdT<Symbol> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct SubtreeLog : public sem::Org {
    ...
    struct Priority : public sem::SubtreeLog::DescribedLog {
        ...
        BOOST_DESCRIBE_CLASS(
            ...
            (),
            (),
            (oldPriority, newPriority, on))
        /// \brief Previous priority for change and removal
        Opt<Str> oldPriority = std::nullopt;
        /// \brief New priority for change and addition
        Opt<Str> newPriority = std::nullopt;
    ...
    using LogEntry = std::
        variant<Priority, Note, Refile, Clock, State, Tag>;
    enum class Kind : short int
    {
        Priority,
        Note,
    ...
    BOOST_DESCRIBE_CLASS(
        ...
        (staticKind,
         ...
         (sem::SubtreeLog::Kind(sem::SubtreeLog::LogEntry const&))
             getLogKind,
         (sem::SubtreeLog::Kind() const)getLogKind))
    /// \brief Document
    static OrgSemKind const        staticKind;
    sem::SubtreeLog::LogEntry      log = Note{};
    static sem::SemIdT<SubtreeLog> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
    virtual OrgSemKind getKind() const { return OrgSemKind::SubtreeLog; }
    void               setDescription(sem::SemIdT<sem::StmtList> desc);
    sem::SubtreeLog::Priority const& getPriority() const {
        return std::get<0>(log);
    }
    sem::SubtreeLog::Priority&   getPriority() { return std::get<0>(log); }
    sem::SubtreeLog::Note const& getNote() const {
        return std::get<1>(log);
    }
    sem::SubtreeLog::Note&         getNote() { return std::get<1>(log); }
    sem::SubtreeLog::Refile const& getRefile() const {
        return std::get<2>(log);
    }
    sem::SubtreeLog::Refile&      getRefile() { return std::get<2>(log); }
    sem::SubtreeLog::Clock const& getClock() const {
        return std::get<3>(log);
    }
    sem::SubtreeLog::Clock&       getClock() { return std::get<3>(log); }
    sem::SubtreeLog::State const& getState() const {
        return std::get<4>(log);
    }
    ...
    static sem::SubtreeLog::Kind getLogKind(
        sem::SubtreeLog::LogEntry const& __input) {
        return static_cast<sem::SubtreeLog::Kind>(__input.index());
    }
...
struct Subtree : public sem::Org {
    ...
    struct Period {
        ...
        enum class Kind : short int
        {
            ...
            Clocked,
            /// \brief Date of task execution start plus it's estimated
            /// effort duration. If the latter one is missing then only a
            /// single time point is returned
            Scheduled,
            /// \brief Single point or time range used in title. Single
            /// point can also be a simple time, such as `12:20`
            Titled,
        ...
        /// \brief Time period kind -- not associated with point/range
        /// distinction
        Kind kind;
        /// \brief Stored time point/range
        Variant<sem::SemIdT<sem::Time>, sem::SemIdT<sem::TimeRange>>
            period = sem::SemIdT<sem::Time>::Nil();
        /// \brief Get associated time point
        sem::SemIdT<sem::Time> getTime() {
            return std::get<SemIdT<Time>>(period);
        }
    ...
    struct Property {
        ...
        bool matches(Kind kind, CR<Str> subkind = "") const;
        BOOST_DESCRIBE_CLASS(
            Property,
            (),
            (),
            ...
            (mainSetRule,
             ...
             inheritanceMode,
             data,
             (sem::Subtree::Property::Nonblocking const&()
                  const)getNonblocking,
             ...
             (sem::Subtree::Property::ExportLatexClass const&()
                  const)getExportLatexClass,
             (sem::Subtree::Property::ExportLatexClass & ())
                 getExportLatexClass,
             (sem::Subtree::Property::ExportLatexClassOptions const&()
                  const)getExportLatexClassOptions,
             (sem::Subtree::Property::ExportLatexClassOptions & ())
                 getExportLatexClassOptions,
             (sem::Subtree::Property::ExportLatexHeader const&()
                  const)getExportLatexHeader,
             (sem::Subtree::Property::ExportLatexHeader & ())
                 getExportLatexHeader,
             (sem::Subtree::Property::ExportLatexCompiler const&()
                  const)getExportLatexCompiler,
             (sem::Subtree::Property::ExportLatexCompiler & ())
             ...
             (sem::Subtree::Property::Visibility const&()
                  const)getVisibility,
             (sem::Subtree::Property::Visibility & ()) getVisibility,
             (sem::Subtree::Property::ExportOptions const&()
             ...
             (sem::Subtree::Property::Unnumbered const&()
                  const)getUnnumbered,
             ...
             (sem::Subtree::Property::Kind(
                 sem::Subtree::Property::Data const&))getKind,
        ...
        sem::Subtree::Property::InheritanceMode inheritanceMode = InheritanceMode::
            ThisAndSub;
        sem::Subtree::Property::Data               data;
        sem::Subtree::Property::Nonblocking const& getNonblocking() const {
            return std::get<0>(data);
        }
        sem::Subtree::Property::Nonblocking& getNonblocking() {
            return std::get<0>(data);
        }
        sem::Subtree::Property::Trigger const& getTrigger() const {
            return std::get<1>(data);
        }
        sem::Subtree::Property::Trigger& getTrigger() {
            return std::get<1>(data);
        }
        sem::Subtree::Property::Origin const& getOrigin() const {
            return std::get<2>(data);
        }
        sem::Subtree::Property::Origin& getOrigin() {
            return std::get<2>(data);
        ...
        sem::Subtree::Property::Ordered const& getOrdered() const {
            return std::get<7>(data);
        }
        sem::Subtree::Property::Ordered& getOrdered() {
            return std::get<7>(data);
        }
        sem::Subtree::Property::Effort const& getEffort() const {
            return std::get<8>(data);
        }
        sem::Subtree::Property::Effort& getEffort() {
            return std::get<8>(data);
        }
        sem::Subtree::Property::Visibility const& getVisibility() const {
        ...
        sem::Subtree::Property::Blocker const& getBlocker() const {
            return std::get<11>(data);
        }
        sem::Subtree::Property::Blocker& getBlocker() {
            return std::get<11>(data);
        }
        sem::Subtree::Property::Unnumbered const& getUnnumbered() const {
            return std::get<12>(data);
        }
        sem::Subtree::Property::Unnumbered& getUnnumbered() {
            return std::get<12>(data);
        }
        sem::Subtree::Property::Created const& getCreated() const {
            return std::get<13>(data);
        }
        sem::Subtree::Property::Created& getCreated() {
            return std::get<13>(data);
        }
        static sem::Subtree::Property::Kind getKind(
            sem::Subtree::Property::Data const& __input) {
            return static_cast<sem::Subtree::Property::Kind>(
                __input.index());
        }
        sem::Subtree::Property::Kind getKind() const {
            return getKind(data);
        }
    };
    ...
    BOOST_DESCRIBE_CLASS(
        ...
        (staticKind,
         ...
         (OrgSemKind() const)getKind,
         (Vec<sem::Subtree::Period>(IntSet<sem::Subtree::Period::Kind>)
              const)getTimePeriods,
         (Vec<sem::Subtree::Property>(
             sem::Subtree::Property::Kind,
             Str const&) const)getProperties,
         (Opt<sem::Subtree::Property>(
             sem::Subtree::Property::Kind,
             Str const&) const)getProperty,
         (Vec<sem::Subtree::Property>(
             sem::Subtree::Property::Kind,
             Str const&) const)getContextualProperties,
         (Opt<sem::Subtree::Property>(
             sem::Subtree::Property::Kind,
             Str const&) const)getContextualProperty))
    /// \brief Document
    static OrgSemKind const staticKind;
    /// \brief Subtree level
    int level = 0;
    ...
    static sem::SemIdT<Subtree> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
    virtual OrgSemKind getKind() const { return OrgSemKind::Subtree; }
    Vec<sem::Subtree::Period> getTimePeriods(
        IntSet<sem::Subtree::Period::Kind> kinds) const;
    Vec<sem::Subtree::Property> getProperties(
        sem::Subtree::Property::Kind kind,
        Str const&                   subkind = "") const;
    Opt<sem::Subtree::Property> getProperty(
        sem::Subtree::Property::Kind kind,
        Str const&                   subkind = "") const;
    Vec<sem::Subtree::Property> getContextualProperties(
        sem::Subtree::Property::Kind kind,
        Str const&                   subkind = "") const;
    Opt<sem::Subtree::Property> getContextualProperty(
        sem::Subtree::Property::Kind kind,
        Str const&                   subkind = "") const;
};
...
struct InlineMath : public sem::LatexBody {
    ...
    /// \brief Document
    static OrgSemKind const        staticKind;
    static sem::SemIdT<InlineMath> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Escaped : public sem::Leaf {
    ...
    /// \brief Document
    static OrgSemKind const     staticKind;
    static sem::SemIdT<Escaped> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Newline : public sem::Leaf {
    ...
    /// \brief Document
    static OrgSemKind const     staticKind;
    static sem::SemIdT<Newline> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Space : public sem::Leaf {
    ...
    /// \brief Document
    static OrgSemKind const   staticKind;
    static sem::SemIdT<Space> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct AtMention : public sem::Leaf {
    ...
    /// \brief Document
    static OrgSemKind const       staticKind;
    static sem::SemIdT<AtMention> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct RawText : public sem::Leaf {
    ...
    /// \brief Document
    static OrgSemKind const     staticKind;
    static sem::SemIdT<RawText> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Punctuation : public sem::Leaf {
    ...
    /// \brief Document
    static OrgSemKind const         staticKind;
    static sem::SemIdT<Punctuation> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Placeholder : public sem::Leaf {
    ...
    /// \brief Document
    static OrgSemKind const         staticKind;
    static sem::SemIdT<Placeholder> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct BigIdent : public sem::Leaf {
    ...
    /// \brief Document
    static OrgSemKind const      staticKind;
    static sem::SemIdT<BigIdent> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Underline : public sem::Markup {
    ...
    /// \brief Document
    static OrgSemKind const       staticKind;
    static sem::SemIdT<Underline> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Monospace : public sem::Markup {
    ...
    /// \brief Document
    static OrgSemKind const       staticKind;
    static sem::SemIdT<Monospace> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct MarkQuote : public sem::Markup {
    ...
    /// \brief Document
    static OrgSemKind const       staticKind;
    static sem::SemIdT<MarkQuote> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Verbatim : public sem::Markup {
    ...
    /// \brief Document
    static OrgSemKind const      staticKind;
    static sem::SemIdT<Verbatim> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Italic : public sem::Markup {
    ...
    /// \brief Document
    static OrgSemKind const    staticKind;
    static sem::SemIdT<Italic> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct Strike : public sem::Markup {
    ...
    /// \brief Document
    static OrgSemKind const    staticKind;
    static sem::SemIdT<Strike> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct ListItem : public sem::Org {
    ...
    static sem::SemIdT<ListItem>     create(
            sem::SemId      parent,
            Opt<OrgAdapter> original = std::nullopt);
...
struct Link : public sem::Org {
    ...
    sem::Link::Person const& getPerson() const {
        return std::get<2>(data);
    }
    sem::Link::Person&         getPerson() { return std::get<2>(data); }
    sem::Link::Footnote const& getFootnote() const {
        return std::get<3>(data);
    }
    ...
    static sem::Link::Kind getLinkKind(sem::Link::Data const& __input) {
        return static_cast<sem::Link::Kind>(__input.index());
    }
...
struct Document : public sem::Org {
    ...
    sem::SemIdT<sem::DocumentOptions>
                                 options = SemIdT<DocumentOptions>::Nil();
    Opt<Str>                     exportFileName = std::nullopt;
    static sem::SemIdT<Document> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct ParseError : public sem::Org {
    ...
    /// \brief Document
    static OrgSemKind const        staticKind;
    static sem::SemIdT<ParseError> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct FileTarget : public sem::Org {
    ...
    static sem::SemIdT<FileTarget> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
...
struct TextSeparator : public sem::Org {
    ...
    /// \brief Document
    static OrgSemKind const           staticKind;
    static sem::SemIdT<TextSeparator> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
    virtual OrgSemKind getKind() const {
...
struct Include : public sem::Org {
    ...
    static sem::SemIdT<Include> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
    virtual OrgSemKind getKind() const { return OrgSemKind::Include; }
    sem::Include::Example const& getExample() const {
        return std::get<0>(data);
    }
    sem::Include::Example&      getExample() { return std::get<0>(data); }
    sem::Include::Export const& getExport() const {
        return std::get<1>(data);
    }
    ...
    sem::Include::OrgDocument const& getOrgDocument() const {
        return std::get<3>(data);
    }
    sem::Include::OrgDocument& getOrgDocument() {
        return std::get<3>(data);
    }
    static sem::Include::Kind getIncludeKind(
        sem::Include::Data const& __input) {
        return static_cast<sem::Include::Kind>(__input.index());
    }
    sem::Include::Kind getIncludeKind() const {
        return getIncludeKind(data);
    }
};
...
struct DocumentOptions : public sem::Org {
    ...
    sem::DocumentOptions::Visibility  initialVisibility = Visibility::
        ShowEverything;
    ...
    static sem::SemIdT<DocumentOptions> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
    virtual OrgSemKind getKind() const {
...
struct DocumentGroup : public sem::Org {
    ...
    /// \brief Document
    static OrgSemKind const           staticKind;
    static sem::SemIdT<DocumentGroup> create(
        sem::SemId      parent,
        Opt<OrgAdapter> original = std::nullopt);
    virtual OrgSemKind getKind() const {
