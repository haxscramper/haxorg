...
Opt<NlpDepKind> enum_serde<NlpDepKind>::from_string(std::string value) {
    if (value == "ROOT") {
        return NlpDepKind::ROOT;
    } else if (value == "acl") {
        return NlpDepKind::acl;
    } else if (value == "advcl") {
        return NlpDepKind::advcl;
    } else if (value == "advmod") {
        return NlpDepKind::advmod;
    } else if (value == "amod") {
        return NlpDepKind::amod;
    } else if (value == "appos") {
        return NlpDepKind::appos;
    } else if (value == "aux") {
        return NlpDepKind::aux;
    } else if (value == "_case") {
        return NlpDepKind::_case;
    } else if (value == "cc") {
        return NlpDepKind::cc;
    } else if (value == "ccomp") {
        return NlpDepKind::ccomp;
    } else if (value == "compound") {
        return NlpDepKind::compound;
    } else if (value == "conj") {
        return NlpDepKind::conj;
    } else if (value == "cop") {
        return NlpDepKind::cop;
    } else if (value == "csubj") {
        return NlpDepKind::csubj;
    } else if (value == "dep") {
        return NlpDepKind::dep;
    } else if (value == "det") {
        return NlpDepKind::det;
    } else if (value == "discourse") {
        return NlpDepKind::discourse;
    } else if (value == "expl") {
        return NlpDepKind::expl;
    } else if (value == "fixed") {
        return NlpDepKind::fixed;
    } else if (value == "iobj") {
        return NlpDepKind::iobj;
    } else if (value == "mark") {
        return NlpDepKind::mark;
    } else if (value == "nmod") {
        return NlpDepKind::nmod;
    } else if (value == "nsubj") {
        return NlpDepKind::nsubj;
    } else if (value == "nummod") {
        return NlpDepKind::nummod;
    } else if (value == "obj") {
        return NlpDepKind::obj;
    } else if (value == "obl") {
        return NlpDepKind::obl;
    } else if (value == "parataxis") {
        return NlpDepKind::parataxis;
    } else if (value == "punct") {
        return NlpDepKind::punct;
    } else if (value == "ref") {
        return NlpDepKind::ref;
    } else if (value == "xcomp") {
        return NlpDepKind::xcomp;
    } else {
        return std::nullopt;
    }
}
...
Opt<NlpPosTag> enum_serde<NlpPosTag>::from_string(std::string value) {
    if (value == "ADJP") {
        return NlpPosTag::ADJP;
    } else if (value == "ADVP") {
        return NlpPosTag::ADVP;
    } else if (value == "ADD") {
        return NlpPosTag::ADD;
    } else if (value == "AFX") {
        return NlpPosTag::AFX;
    } else if (value == "CC") {
        return NlpPosTag::CC;
    } else if (value == "CD") {
        return NlpPosTag::CD;
    } else if (value == "CONJP") {
        return NlpPosTag::CONJP;
    } else if (value == "DT") {
        return NlpPosTag::DT;
    } else if (value == "EX") {
        return NlpPosTag::EX;
    } else if (value == "FRAG") {
        return NlpPosTag::FRAG;
    } else if (value == "FW") {
        return NlpPosTag::FW;
    } else if (value == "HYPH") {
        return NlpPosTag::HYPH;
    } else if (value == "IN") {
        return NlpPosTag::IN;
    } else if (value == "INTJ") {
        return NlpPosTag::INTJ;
    } else if (value == "JJ") {
        return NlpPosTag::JJ;
    } else if (value == "JJR") {
        return NlpPosTag::JJR;
    } else if (value == "JJS") {
        return NlpPosTag::JJS;
    } else if (value == "LRB") {
        return NlpPosTag::LRB;
    } else if (value == "LS") {
        return NlpPosTag::LS;
    } else if (value == "LST") {
        return NlpPosTag::LST;
    } else if (value == "MD") {
        return NlpPosTag::MD;
    } else if (value == "META") {
        return NlpPosTag::META;
    } else if (value == "NAC") {
        return NlpPosTag::NAC;
    } else if (value == "NFP") {
        return NlpPosTag::NFP;
    } else if (value == "NML") {
        return NlpPosTag::NML;
    } else if (value == "NN") {
        return NlpPosTag::NN;
    } else if (value == "NNP") {
        return NlpPosTag::NNP;
    } else if (value == "NNPS") {
        return NlpPosTag::NNPS;
    } else if (value == "NNS") {
        return NlpPosTag::NNS;
    } else if (value == "NP") {
        return NlpPosTag::NP;
    } else if (value == "NPS") {
        return NlpPosTag::NPS;
    } else if (value == "NP_TMP") {
        return NlpPosTag::NP_TMP;
    } else if (value == "PDT") {
        return NlpPosTag::PDT;
    } else if (value == "POS") {
        return NlpPosTag::POS;
    } else if (value == "PP") {
        return NlpPosTag::PP;
    } else if (value == "PPZ") {
        return NlpPosTag::PPZ;
    } else if (value == "PRN") {
        return NlpPosTag::PRN;
    } else if (value == "PRP") {
        return NlpPosTag::PRP;
    } else if (value == "PRT") {
        return NlpPosTag::PRT;
    } else if (value == "PUNCT_COLON") {
        return NlpPosTag::PUNCT_COLON;
    } else if (value == "PUNCT_COMMA") {
        return NlpPosTag::PUNCT_COMMA;
    } else if (value == "PUNCT_PERIOD") {
        return NlpPosTag::PUNCT_PERIOD;
    } else if (value == "PUNCT_QUOTE_CLOSE") {
        return NlpPosTag::PUNCT_QUOTE_CLOSE;
    } else if (value == "PUNCT_QUOTE_OPEN") {
        return NlpPosTag::PUNCT_QUOTE_OPEN;
    } else if (value == "QP") {
        return NlpPosTag::QP;
    } else if (value == "RB") {
        return NlpPosTag::RB;
    } else if (value == "RBR") {
        return NlpPosTag::RBR;
    } else if (value == "RBS") {
        return NlpPosTag::RBS;
    } else if (value == "ROOT") {
        return NlpPosTag::ROOT;
    } else if (value == "RP") {
        return NlpPosTag::RP;
    } else if (value == "RRB") {
        return NlpPosTag::RRB;
    } else if (value == "RRC") {
        return NlpPosTag::RRC;
    } else if (value == "S") {
        return NlpPosTag::S;
    } else if (value == "SBAR") {
        return NlpPosTag::SBAR;
    } else if (value == "SBARQ") {
        return NlpPosTag::SBARQ;
    } else if (value == "SENT") {
        return NlpPosTag::SENT;
    } else if (value == "SINV") {
        return NlpPosTag::SINV;
    } else if (value == "SQ") {
        return NlpPosTag::SQ;
    } else if (value == "SYM") {
        return NlpPosTag::SYM;
    } else if (value == "TO") {
        return NlpPosTag::TO;
    } else if (value == "UCP") {
        return NlpPosTag::UCP;
    } else if (value == "UH") {
        return NlpPosTag::UH;
    } else if (value == "VB") {
        return NlpPosTag::VB;
    } else if (value == "VBD") {
        return NlpPosTag::VBD;
    } else if (value == "VBG") {
        return NlpPosTag::VBG;
    } else if (value == "VBN") {
        return NlpPosTag::VBN;
    } else if (value == "VBP") {
        return NlpPosTag::VBP;
    } else if (value == "VBZ") {
        return NlpPosTag::VBZ;
    } else if (value == "VH") {
        return NlpPosTag::VH;
    } else if (value == "VHD") {
        return NlpPosTag::VHD;
    } else if (value == "VHG") {
        return NlpPosTag::VHG;
    } else if (value == "VHN") {
        return NlpPosTag::VHN;
    } else if (value == "VHP") {
        return NlpPosTag::VHP;
    } else if (value == "VHZ") {
        return NlpPosTag::VHZ;
    } else if (value == "VP") {
        return NlpPosTag::VP;
    } else if (value == "VV") {
        return NlpPosTag::VV;
    } else if (value == "VVD") {
        return NlpPosTag::VVD;
    } else if (value == "VVG") {
        return NlpPosTag::VVG;
    } else if (value == "VVN") {
        return NlpPosTag::VVN;
    } else if (value == "VVP") {
        return NlpPosTag::VVP;
    } else if (value == "VVZ") {
        return NlpPosTag::VVZ;
    } else if (value == "WDT") {
        return NlpPosTag::WDT;
    } else if (value == "WHADJP") {
        return NlpPosTag::WHADJP;
    } else if (value == "WHADVP") {
        return NlpPosTag::WHADVP;
    } else if (value == "WHNP") {
        return NlpPosTag::WHNP;
    } else if (value == "WHPP") {
        return NlpPosTag::WHPP;
    } else if (value == "WP") {
        return NlpPosTag::WP;
    } else if (value == "WP_POS") {
        return NlpPosTag::WP_POS;
    } else if (value == "WRB") {
        return NlpPosTag::WRB;
    } else if (value == "X") {
        return NlpPosTag::X;
    } else {
        return std::nullopt;
