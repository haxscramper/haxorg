...
BOOST_DESCRIBE_ENUM_BEGIN(OrgTokenKind)
  ...
  BOOST_DESCRIBE_ENUM_ENTRY(OrgTokenKind, SrcTangleClose)
  BOOST_DESCRIBE_ENUM_ENTRY(OrgTokenKind, SrcTangleOpen)
  ...
  BOOST_DESCRIBE_ENUM_ENTRY(OrgTokenKind, WeekdayName)
