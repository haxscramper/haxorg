...
NB_MAKE_OPAQUE(org::sem::SemId<org::sem::Org>)
NB_MAKE_OPAQUE(hstd::SharedPtrApi<org::parse::OrgParseParameters>)
NB_MAKE_OPAQUE(hstd::SharedPtrApi<org::parse::OrgDirectoryParseParameters>)
NB_MAKE_OPAQUE(std::shared_ptr<hstd::ext::Cache>)
NB_MAKE_OPAQUE(std::shared_ptr<org::parse::OrgParseParameters>)
NB_MAKE_OPAQUE(std::shared_ptr<org::parse::OrgDirectoryParseParameters>)
NB_MAKE_OPAQUE(org::sem::SemId<org::sem::File>)
...
NB_MAKE_OPAQUE(org::sem::SemId<org::sem::ErrorGroup>)
NB_MAKE_OPAQUE(hstd::SharedPtrApi<org::parse::ParseContext>)
NB_MAKE_OPAQUE(hstd::SharedPtrApi<org::imm::ImmAstReplaceEpoch>)
NB_MAKE_OPAQUE(hstd::SharedPtrApi<org::imm::ImmAstContext>)
NB_MAKE_OPAQUE(std::shared_ptr<org::imm::ImmAstContext>)
NB_MAKE_OPAQUE(std::shared_ptr<org::imm::ImmAstReplaceEpoch>)
...
NB_MAKE_OPAQUE(std::pair<OrgSemKind, org::imm::ImmReflFieldId>)
...
NB_MAKE_OPAQUE(hstd::SharedPtrApi<org::graph::MapGraph>)
NB_MAKE_OPAQUE(hstd::SharedPtrApi<org::graph::MapConfig>)
NB_MAKE_OPAQUE(std::shared_ptr<org::graph::MapGraph>)
NB_MAKE_OPAQUE(std::shared_ptr<org::graph::MapGraphState>)
NB_MAKE_OPAQUE(std::shared_ptr<org::graph::MapConfig>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterT<org::imm::ImmSubtree>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterT<org::imm::ImmLink>)
NB_MAKE_OPAQUE(hstd::SharedPtrApi<org::graph::MapGraphState>)
NB_MAKE_OPAQUE(org::algo::Exporter<org::bind::python::ExporterPython, nanobind::object>)
NB_MAKE_OPAQUE(std::variant<org::sem::LispCode::Call, org::sem::LispCode::List, org::sem::LispCode::KeyValue, org::sem::LispCode::Number, org::sem::LispCode::Text, org::sem::LispCode::Ident, org::sem::LispCode::Boolean, org::sem::LispCode::Real>)
...
NB_MAKE_OPAQUE(std::variant<org::sem::Tblfm::Expr::AxisRef, org::sem::Tblfm::Expr::AxisName, org::sem::Tblfm::Expr::IntLiteral, org::sem::Tblfm::Expr::FloatLiteral, org::sem::Tblfm::Expr::RangeRef, org::sem::Tblfm::Expr::Call, org::sem::Tblfm::Expr::Elisp>)
NB_MAKE_OPAQUE(std::variant<org::sem::Tblfm::Expr::AxisRef::Position::Index, org::sem::Tblfm::Expr::AxisRef::Position::Name>)
...
NB_MAKE_OPAQUE(std::variant<org::sem::AttrValue::TextValue, org::sem::AttrValue::FileReference, org::sem::AttrValue::LispValue>)
...
NB_MAKE_OPAQUE(std::variant<org::sem::LinkTarget::Raw, org::sem::LinkTarget::Id, org::sem::LinkTarget::CustomId, org::sem::LinkTarget::SubtreeTitle, org::sem::LinkTarget::Person, org::sem::LinkTarget::UserProtocol, org::sem::LinkTarget::Internal, org::sem::LinkTarget::Footnote, org::sem::LinkTarget::File, org::sem::LinkTarget::Attachment>)
NB_MAKE_OPAQUE(std::variant<org::sem::SubtreeLogHead::Priority, org::sem::SubtreeLogHead::Note, org::sem::SubtreeLogHead::Refile, org::sem::SubtreeLogHead::Clock, org::sem::SubtreeLogHead::State, org::sem::SubtreeLogHead::Deadline, org::sem::SubtreeLogHead::Schedule, org::sem::SubtreeLogHead::Tag, org::sem::SubtreeLogHead::Unknown>)
...
NB_MAKE_OPAQUE(std::variant<org::sem::ColumnView::Summary::CheckboxAggregate, org::sem::ColumnView::Summary::MathAggregate>)
NB_MAKE_OPAQUE(hstd::Vec<org::sem::BlockCodeLine::Part>)
NB_MAKE_OPAQUE(std::vector<org::sem::BlockCodeLine::Part>)
NB_MAKE_OPAQUE(std::variant<org::sem::BlockCodeLine::Part::Raw, org::sem::BlockCodeLine::Part::Callout, org::sem::BlockCodeLine::Part::Tangle>)
NB_MAKE_OPAQUE(std::variant<org::sem::DocumentExportConfig::DoExport, org::sem::DocumentExportConfig::ExportFixed>)
NB_MAKE_OPAQUE(std::variant<org::sem::NamedProperty::Nonblocking, org::sem::NamedProperty::ArchiveTime, org::sem::NamedProperty::ArchiveFile, org::sem::NamedProperty::ArchiveOlpath, org::sem::NamedProperty::ArchiveTarget, org::sem::NamedProperty::ArchiveCategory, org::sem::NamedProperty::ArchiveTodo, org::sem::NamedProperty::Trigger, org::sem::NamedProperty::ExportLatexClass, org::sem::NamedProperty::CookieData, org::sem::NamedProperty::ExportLatexClassOptions, org::sem::NamedProperty::ExportLatexHeader, org::sem::NamedProperty::ExportLatexCompiler, org::sem::NamedProperty::Ordered, org::sem::NamedProperty::Effort, org::sem::NamedProperty::Visibility, org::sem::NamedProperty::ExportOptions, org::sem::NamedProperty::Blocker, org::sem::NamedProperty::Unnumbered, org::sem::NamedProperty::Created, org::sem::NamedProperty::RadioId, org::sem::NamedProperty::HashtagDef, org::sem::NamedProperty::CustomArgs, org::sem::NamedProperty::CustomRaw, org::sem::NamedProperty::CustomId, org::sem::NamedProperty::CustomSubtreeJson, org::sem::NamedProperty::CustomSubtreeFlags>)
NB_MAKE_OPAQUE(hstd::UnorderedMap<hstd::Str, hstd::Str>)
NB_MAKE_OPAQUE(std::unordered_map<hstd::Str, hstd::Str>)
NB_MAKE_OPAQUE(std::variant<org::sem::OrgDiagnostics::ParseTokenError, org::sem::OrgDiagnostics::ParseError, org::sem::OrgDiagnostics::IncludeError, org::sem::OrgDiagnostics::ConvertError, org::sem::OrgDiagnostics::InternalError>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmNoNode>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmErrorItem>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmErrorGroup>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmStmt>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmInline>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmStmtList>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmEmpty>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCmd>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmBlock>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmLineCommand>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmAttached>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmLeaf>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCmdCaption>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCmdCreator>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCmdAuthor>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCmdEmail>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCmdLanguage>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCmdColumns>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCmdName>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCmdCustomArgs>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCmdCustomRaw>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCmdCustomText>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCmdCall>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCmdTblfm>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmHashTag>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmInlineFootnote>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmInlineExport>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmTime>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmTimeRange>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmMacro>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmSymbol>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmEscaped>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmNewline>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmSpace>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmWord>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmAtMention>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmRawText>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmPunctuation>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmPlaceholder>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmBigIdent>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmTextTarget>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmErrorSkipToken>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmErrorSkipGroup>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmMarkup>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmBold>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmUnderline>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmMonospace>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmMarkQuote>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmVerbatim>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmItalic>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmStrike>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmPar>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmRadioTarget>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmLatex>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmLink>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmBlockCenter>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmBlockQuote>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmBlockComment>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmBlockVerse>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmBlockDynamicFallback>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmBlockExample>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmBlockExport>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmBlockAdmonition>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmBlockCodeEvalResult>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmBlockCode>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmSubtreeLog>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmSubtree>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCell>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmRow>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmTable>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmParagraph>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmColonExample>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCmdAttr>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCmdExport>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCall>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmList>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmListItem>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmDocumentOptions>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmDocumentFragment>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCriticMarkup>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmDocument>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmFileTarget>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmTextSeparator>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmDocumentGroup>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmFile>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmDirectory>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmSymlink>)
NB_MAKE_OPAQUE(org::imm::ImmAdapterTBase<org::imm::ImmCmdInclude>)
NB_MAKE_OPAQUE(hstd::Vec<org::sem::SemId<org::sem::ErrorItem>>)
NB_MAKE_OPAQUE(std::vector<org::sem::SemId<org::sem::ErrorItem>>)
NB_MAKE_OPAQUE(org::sem::SemId<org::sem::ErrorItem>)
NB_MAKE_OPAQUE(std::variant<org::sem::Time::Static, org::sem::Time::Dynamic>)
NB_MAKE_OPAQUE(hstd::Vec<org::sem::Time::Repeat>)
NB_MAKE_OPAQUE(std::vector<org::sem::Time::Repeat>)
NB_MAKE_OPAQUE(org::sem::SemId<org::sem::Time>)
...
NB_MAKE_OPAQUE(org::sem::SemId<org::sem::ErrorSkipToken>)
NB_MAKE_OPAQUE(org::sem::SemId<org::sem::StmtList>)
NB_MAKE_OPAQUE(org::sem::SemId<org::sem::Paragraph>)
NB_MAKE_OPAQUE(hstd::Vec<org::sem::SemId<org::sem::HashTag>>)
NB_MAKE_OPAQUE(std::vector<org::sem::SemId<org::sem::HashTag>>)
NB_MAKE_OPAQUE(org::sem::SemId<org::sem::HashTag>)
NB_MAKE_OPAQUE(hstd::Vec<org::sem::SemId<org::sem::SubtreeLog>>)
NB_MAKE_OPAQUE(std::vector<org::sem::SemId<org::sem::SubtreeLog>>)
NB_MAKE_OPAQUE(org::sem::SemId<org::sem::SubtreeLog>)
...
NB_MAKE_OPAQUE(std::int_set<org::sem::SubtreePeriod::Kind>)
NB_MAKE_OPAQUE(hstd::Vec<org::sem::TodoKeyword>)
NB_MAKE_OPAQUE(std::vector<org::sem::TodoKeyword>)
NB_MAKE_OPAQUE(org::sem::SemId<org::sem::RawText>)
NB_MAKE_OPAQUE(org::sem::SemId<org::sem::DocumentOptions>)
NB_MAKE_OPAQUE(std::variant<org::sem::File::Document, org::sem::File::Attachment, org::sem::File::Source>)
NB_MAKE_OPAQUE(std::variant<org::sem::CmdInclude::Example, org::sem::CmdInclude::Export, org::sem::CmdInclude::Custom, org::sem::CmdInclude::Src, org::sem::CmdInclude::OrgDocument>)
NB_MAKE_OPAQUE(hstd::ext::ImmVec<org::imm::ImmIdT<org::imm::ImmErrorItem>>)
NB_MAKE_OPAQUE(org::imm::ImmIdT<org::imm::ImmErrorItem>)
NB_MAKE_OPAQUE(hstd::ext::ImmVec<org::imm::ImmIdT<org::imm::ImmOrg>>)
NB_MAKE_OPAQUE(org::imm::ImmIdT<org::imm::ImmOrg>)
NB_MAKE_OPAQUE(hstd::ext::ImmBox<hstd::Str>)
NB_MAKE_OPAQUE(std::variant<org::imm::ImmTime::Static, org::imm::ImmTime::Dynamic>)
NB_MAKE_OPAQUE(hstd::ext::ImmVec<org::imm::ImmTime::Repeat>)
NB_MAKE_OPAQUE(hstd::ext::ImmBox<hstd::Opt<org::imm::ImmTime::Repeat>>)
NB_MAKE_OPAQUE(org::imm::ImmIdT<org::imm::ImmTime>)
...
NB_MAKE_OPAQUE(org::imm::ImmIdT<org::imm::ImmParagraph>)
NB_MAKE_OPAQUE(hstd::ext::ImmVec<org::imm::ImmIdT<org::imm::ImmHashTag>>)
NB_MAKE_OPAQUE(org::imm::ImmIdT<org::imm::ImmHashTag>)
NB_MAKE_OPAQUE(hstd::ext::ImmVec<org::imm::ImmIdT<org::imm::ImmSubtreeLog>>)
NB_MAKE_OPAQUE(org::imm::ImmIdT<org::imm::ImmSubtreeLog>)
...
NB_MAKE_OPAQUE(org::imm::ImmIdT<org::imm::ImmRawText>)
NB_MAKE_OPAQUE(org::imm::ImmIdT<org::imm::ImmDocumentOptions>)
NB_MAKE_OPAQUE(std::variant<org::imm::ImmFile::Document, org::imm::ImmFile::Attachment, org::imm::ImmFile::Source>)
NB_MAKE_OPAQUE(std::variant<org::imm::ImmCmdInclude::Example, org::imm::ImmCmdInclude::Export, org::imm::ImmCmdInclude::Custom, org::imm::ImmCmdInclude::Src, org::imm::ImmCmdInclude::OrgDocument>)
...
NB_MAKE_OPAQUE(org::sem::SemId<org::sem::BigIdent>)
...
NB_MAKE_OPAQUE(org::sem::SemId<org::sem::Cell>)
NB_MAKE_OPAQUE(hstd::ext::ImmVec<org::imm::ImmIdT<org::imm::ImmCell>>)
NB_MAKE_OPAQUE(org::imm::ImmIdT<org::imm::ImmCell>)
...
NB_MAKE_OPAQUE(org::sem::SemId<org::sem::BlockCodeEvalResult>)
...
NB_MAKE_OPAQUE(org::sem::SemId<org::sem::Row>)
...
NB_MAKE_OPAQUE(org::imm::ImmIdT<org::imm::ImmBlockCodeEvalResult>)
NB_MAKE_OPAQUE(hstd::ext::ImmVec<org::sem::BlockCodeLine>)
NB_MAKE_OPAQUE(hstd::ext::ImmVec<org::imm::ImmIdT<org::imm::ImmRow>>)
NB_MAKE_OPAQUE(org::imm::ImmIdT<org::imm::ImmRow>)
NB_MAKE_OPAQUE(org::sem::SemId<org::sem::Document>)
...
NB_MAKE_OPAQUE(std::shared_ptr<org::parse::ParseContext>)
NB_MODULE(pyhaxorg, m) {
  org::bind::python::PyTypeRegistryGuard type_registry_guard{};
  bind_hstdVec<org::sem::OrgJson>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::OrgJson>(m, "StdVec", type_registry_guard);
  bind_hstdVec<org::sem::SemId<org::sem::Org>>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::SemId<org::sem::Org>>(m, "StdVec", type_registry_guard);
  bind_orgsemSemId<org::sem::Org>(m, "SemId", type_registry_guard);
  bind_hstdSharedPtrApi<org::parse::OrgParseParameters>(m, "SharedPtrApi", type_registry_guard);
  bind_hstdSharedPtrApi<org::parse::OrgDirectoryParseParameters>(m, "SharedPtrApi", type_registry_guard);
  bind_stdshared_ptr<hstd::ext::Cache>(m, "StdShared_ptr", type_registry_guard);
  bind_stdshared_ptr<org::parse::OrgParseParameters>(m, "StdShared_ptr", type_registry_guard);
  bind_stdshared_ptr<org::parse::OrgDirectoryParseParameters>(m, "StdShared_ptr", type_registry_guard);
  bind_orgsemSemId<org::sem::File>(m, "SemId", type_registry_guard);
  bind_hstdVec<hstd::ext::Report>(m, "HstdVec", type_registry_guard);
  bind_stdvector<hstd::ext::Report>(m, "StdVec", type_registry_guard);
  bind_hstdVec<org::sem::SemId<org::sem::ErrorGroup>>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::SemId<org::sem::ErrorGroup>>(m, "StdVec", type_registry_guard);
  bind_orgsemSemId<org::sem::ErrorGroup>(m, "SemId", type_registry_guard);
  bind_hstdSharedPtrApi<org::parse::ParseContext>(m, "SharedPtrApi", type_registry_guard);
  bind_hstdSharedPtrApi<org::imm::ImmAstReplaceEpoch>(m, "SharedPtrApi", type_registry_guard);
  bind_hstdSharedPtrApi<org::imm::ImmAstContext>(m, "SharedPtrApi", type_registry_guard);
  bind_stdshared_ptr<org::imm::ImmAstContext>(m, "StdShared_ptr", type_registry_guard);
  bind_stdshared_ptr<org::imm::ImmAstReplaceEpoch>(m, "StdShared_ptr", type_registry_guard);
  bind_hstdVec<int>(m, "HstdVec", type_registry_guard);
  bind_stdvector<int>(m, "StdVec", type_registry_guard);
  bind_hstdVec<org::imm::ImmAdapter>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::imm::ImmAdapter>(m, "StdVec", type_registry_guard);
  bind_hstdUnorderedSet<std::pair<OrgSemKind, org::imm::ImmReflFieldId>>(m, "UnorderedSet", type_registry_guard);
  bind_stdpair<OrgSemKind, org::imm::ImmReflFieldId>(m, "StdPair", type_registry_guard);
  bind_hstdUnorderedMap<org::sem::HashTagFlat, org::AstTrackingPath>(m, "HstdMap", type_registry_guard);
  bind_stdunordered_map<org::sem::HashTagFlat, org::AstTrackingPath>(m, "StdMap", type_registry_guard);
  bind_hstdUnorderedMap<hstd::Str, org::AstTrackingAlternatives>(m, "HstdMap", type_registry_guard);
  bind_stdunordered_map<hstd::Str, org::AstTrackingAlternatives>(m, "StdMap", type_registry_guard);
  bind_hstdUnorderedMap<org::sem::HashTagFlat, org::AstTrackingAlternatives>(m, "HstdMap", type_registry_guard);
  bind_stdunordered_map<org::sem::HashTagFlat, org::AstTrackingAlternatives>(m, "StdMap", type_registry_guard);
  bind_hstdVec<hstd::SequenceSegment>(m, "HstdVec", type_registry_guard);
  bind_stdvector<hstd::SequenceSegment>(m, "StdVec", type_registry_guard);
  bind_hstdVec<hstd::SequenceAnnotationTag>(m, "HstdVec", type_registry_guard);
  bind_stdvector<hstd::SequenceAnnotationTag>(m, "StdVec", type_registry_guard);
  bind_hstdVec<org::imm::ImmUniqId>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::imm::ImmUniqId>(m, "StdVec", type_registry_guard);
  bind_hstdVec<org::graph::MapLink>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::graph::MapLink>(m, "StdVec", type_registry_guard);
  bind_hstdUnorderedMap<org::graph::MapNode, org::graph::MapNodeProp>(m, "HstdMap", type_registry_guard);
  bind_stdunordered_map<org::graph::MapNode, org::graph::MapNodeProp>(m, "StdMap", type_registry_guard);
  bind_hstdUnorderedMap<org::graph::MapEdge, org::graph::MapEdgeProp>(m, "HstdMap", type_registry_guard);
  bind_stdunordered_map<org::graph::MapEdge, org::graph::MapEdgeProp>(m, "StdMap", type_registry_guard);
  bind_hstdUnorderedMap<org::graph::MapNode, org::graph::AdjNodesList>(m, "HstdMap", type_registry_guard);
  bind_stdunordered_map<org::graph::MapNode, org::graph::AdjNodesList>(m, "StdMap", type_registry_guard);
  bind_hstdVec<org::graph::MapNode>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::graph::MapNode>(m, "StdVec", type_registry_guard);
  bind_hstdVec<org::graph::MapEdge>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::graph::MapEdge>(m, "StdVec", type_registry_guard);
  bind_hstdSharedPtrApi<org::graph::MapGraph>(m, "SharedPtrApi", type_registry_guard);
  bind_hstdSharedPtrApi<org::graph::MapConfig>(m, "SharedPtrApi", type_registry_guard);
  bind_stdshared_ptr<org::graph::MapGraph>(m, "StdShared_ptr", type_registry_guard);
  bind_stdshared_ptr<org::graph::MapGraphState>(m, "StdShared_ptr", type_registry_guard);
  bind_stdshared_ptr<org::graph::MapConfig>(m, "StdShared_ptr", type_registry_guard);
  bind_orgimmImmAdapterT<org::imm::ImmSubtree>(m, "ImmAdapterT", type_registry_guard);
  bind_orgimmImmAdapterT<org::imm::ImmLink>(m, "ImmAdapterT", type_registry_guard);
  bind_hstdSharedPtrApi<org::graph::MapGraphState>(m, "SharedPtrApi", type_registry_guard);
  bind_orgalgoExporter<org::bind::python::ExporterPython, nanobind::object>(m, "Exporter", type_registry_guard);
  bind_stdvariant<org::sem::LispCode::Call, org::sem::LispCode::List, org::sem::LispCode::KeyValue, org::sem::LispCode::Number, org::sem::LispCode::Text, org::sem::LispCode::Ident, org::sem::LispCode::Boolean, org::sem::LispCode::Real>(m, "StdVariant", type_registry_guard);
  bind_hstdVec<org::sem::LispCode>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::LispCode>(m, "StdVec", type_registry_guard);
  bind_hstdVec<org::sem::Tblfm::Assign>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::Tblfm::Assign>(m, "StdVec", type_registry_guard);
  bind_stdvariant<org::sem::Tblfm::Expr::AxisRef, org::sem::Tblfm::Expr::AxisName, org::sem::Tblfm::Expr::IntLiteral, org::sem::Tblfm::Expr::FloatLiteral, org::sem::Tblfm::Expr::RangeRef, org::sem::Tblfm::Expr::Call, org::sem::Tblfm::Expr::Elisp>(m, "StdVariant", type_registry_guard);
  bind_stdvariant<org::sem::Tblfm::Expr::AxisRef::Position::Index, org::sem::Tblfm::Expr::AxisRef::Position::Name>(m, "StdVariant", type_registry_guard);
  bind_hstdVec<org::sem::Tblfm::Expr>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::Tblfm::Expr>(m, "StdVec", type_registry_guard);
  bind_hstdVec<org::sem::Tblfm::Assign::Flag>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::Tblfm::Assign::Flag>(m, "StdVec", type_registry_guard);
  bind_hstdVec<org::sem::AttrValue::DimensionSpan>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::AttrValue::DimensionSpan>(m, "StdVec", type_registry_guard);
  bind_stdvariant<org::sem::AttrValue::TextValue, org::sem::AttrValue::FileReference, org::sem::AttrValue::LispValue>(m, "StdVariant", type_registry_guard);
  bind_hstdVec<hstd::Str>(m, "HstdVec", type_registry_guard);
  bind_stdvector<hstd::Str>(m, "StdVec", type_registry_guard);
  bind_hstdVec<org::sem::HashTagText>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::HashTagText>(m, "StdVec", type_registry_guard);
  bind_hstdVec<org::sem::HashTagFlat>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::HashTagFlat>(m, "StdVec", type_registry_guard);
  bind_stdvariant<org::sem::LinkTarget::Raw, org::sem::LinkTarget::Id, org::sem::LinkTarget::CustomId, org::sem::LinkTarget::SubtreeTitle, org::sem::LinkTarget::Person, org::sem::LinkTarget::UserProtocol, org::sem::LinkTarget::Internal, org::sem::LinkTarget::Footnote, org::sem::LinkTarget::File, org::sem::LinkTarget::Attachment>(m, "StdVariant", type_registry_guard);
  bind_stdvariant<org::sem::SubtreeLogHead::Priority, org::sem::SubtreeLogHead::Note, org::sem::SubtreeLogHead::Refile, org::sem::SubtreeLogHead::Clock, org::sem::SubtreeLogHead::State, org::sem::SubtreeLogHead::Deadline, org::sem::SubtreeLogHead::Schedule, org::sem::SubtreeLogHead::Tag, org::sem::SubtreeLogHead::Unknown>(m, "StdVariant", type_registry_guard);
  bind_hstdVec<org::sem::AttrValue>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::AttrValue>(m, "StdVec", type_registry_guard);
  bind_hstdUnorderedMap<hstd::Str, org::sem::AttrList>(m, "HstdMap", type_registry_guard);
  bind_stdunordered_map<hstd::Str, org::sem::AttrList>(m, "StdMap", type_registry_guard);
  bind_hstdVec<org::sem::OrgCodeEvalInput::Var>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::OrgCodeEvalInput::Var>(m, "StdVec", type_registry_guard);
  bind_hstdVec<org::sem::ColumnView::Column>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::ColumnView::Column>(m, "StdVec", type_registry_guard);
  bind_stdvariant<org::sem::ColumnView::Summary::CheckboxAggregate, org::sem::ColumnView::Summary::MathAggregate>(m, "StdVariant", type_registry_guard);
  bind_hstdVec<org::sem::BlockCodeLine::Part>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::BlockCodeLine::Part>(m, "StdVec", type_registry_guard);
  bind_stdvariant<org::sem::BlockCodeLine::Part::Raw, org::sem::BlockCodeLine::Part::Callout, org::sem::BlockCodeLine::Part::Tangle>(m, "StdVariant", type_registry_guard);
  bind_stdvariant<org::sem::DocumentExportConfig::DoExport, org::sem::DocumentExportConfig::ExportFixed>(m, "StdVariant", type_registry_guard);
  bind_stdvariant<org::sem::NamedProperty::Nonblocking, org::sem::NamedProperty::ArchiveTime, org::sem::NamedProperty::ArchiveFile, org::sem::NamedProperty::ArchiveOlpath, org::sem::NamedProperty::ArchiveTarget, org::sem::NamedProperty::ArchiveCategory, org::sem::NamedProperty::ArchiveTodo, org::sem::NamedProperty::Trigger, org::sem::NamedProperty::ExportLatexClass, org::sem::NamedProperty::CookieData, org::sem::NamedProperty::ExportLatexClassOptions, org::sem::NamedProperty::ExportLatexHeader, org::sem::NamedProperty::ExportLatexCompiler, org::sem::NamedProperty::Ordered, org::sem::NamedProperty::Effort, org::sem::NamedProperty::Visibility, org::sem::NamedProperty::ExportOptions, org::sem::NamedProperty::Blocker, org::sem::NamedProperty::Unnumbered, org::sem::NamedProperty::Created, org::sem::NamedProperty::RadioId, org::sem::NamedProperty::HashtagDef, org::sem::NamedProperty::CustomArgs, org::sem::NamedProperty::CustomRaw, org::sem::NamedProperty::CustomId, org::sem::NamedProperty::CustomSubtreeJson, org::sem::NamedProperty::CustomSubtreeFlags>(m, "StdVariant", type_registry_guard);
  bind_hstdUnorderedMap<hstd::Str, hstd::Str>(m, "HstdMap", type_registry_guard);
  bind_stdunordered_map<hstd::Str, hstd::Str>(m, "StdMap", type_registry_guard);
  bind_stdvariant<org::sem::OrgDiagnostics::ParseTokenError, org::sem::OrgDiagnostics::ParseError, org::sem::OrgDiagnostics::IncludeError, org::sem::OrgDiagnostics::ConvertError, org::sem::OrgDiagnostics::InternalError>(m, "StdVariant", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmNoNode>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmErrorItem>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmErrorGroup>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmStmt>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmInline>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmStmtList>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmEmpty>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCmd>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmBlock>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmLineCommand>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmAttached>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmLeaf>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCmdCaption>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCmdCreator>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCmdAuthor>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCmdEmail>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCmdLanguage>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCmdColumns>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCmdName>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCmdCustomArgs>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCmdCustomRaw>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCmdCustomText>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCmdCall>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCmdTblfm>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmHashTag>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmInlineFootnote>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmInlineExport>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmTime>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmTimeRange>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmMacro>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmSymbol>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmEscaped>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmNewline>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmSpace>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmWord>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmAtMention>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmRawText>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmPunctuation>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmPlaceholder>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmBigIdent>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmTextTarget>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmErrorSkipToken>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmErrorSkipGroup>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmMarkup>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmBold>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmUnderline>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmMonospace>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmMarkQuote>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmVerbatim>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmItalic>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmStrike>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmPar>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmRadioTarget>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmLatex>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmLink>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmBlockCenter>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmBlockQuote>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmBlockComment>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmBlockVerse>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmBlockDynamicFallback>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmBlockExample>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmBlockExport>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmBlockAdmonition>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmBlockCodeEvalResult>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmBlockCode>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmSubtreeLog>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmSubtree>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCell>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmRow>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmTable>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmParagraph>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmColonExample>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCmdAttr>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCmdExport>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCall>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmList>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmListItem>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmDocumentOptions>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmDocumentFragment>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCriticMarkup>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmDocument>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmFileTarget>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmTextSeparator>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmDocumentGroup>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmFile>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmDirectory>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmSymlink>(m, "ImmAdapterTBase", type_registry_guard);
  bind_orgimmImmAdapterTBase<org::imm::ImmCmdInclude>(m, "ImmAdapterTBase", type_registry_guard);
  bind_hstdVec<org::sem::SemId<org::sem::ErrorItem>>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::SemId<org::sem::ErrorItem>>(m, "StdVec", type_registry_guard);
  bind_orgsemSemId<org::sem::ErrorItem>(m, "SemId", type_registry_guard);
  bind_stdvariant<org::sem::Time::Static, org::sem::Time::Dynamic>(m, "StdVariant", type_registry_guard);
  bind_hstdVec<org::sem::Time::Repeat>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::Time::Repeat>(m, "StdVec", type_registry_guard);
  bind_orgsemSemId<org::sem::Time>(m, "SemId", type_registry_guard);
  bind_hstdVec<org::sem::Symbol::Param>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::Symbol::Param>(m, "StdVec", type_registry_guard);
  bind_hstdVec<org::sem::SemId<org::sem::ErrorSkipToken>>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::SemId<org::sem::ErrorSkipToken>>(m, "StdVec", type_registry_guard);
  bind_orgsemSemId<org::sem::ErrorSkipToken>(m, "SemId", type_registry_guard);
  bind_orgsemSemId<org::sem::StmtList>(m, "SemId", type_registry_guard);
  bind_orgsemSemId<org::sem::Paragraph>(m, "SemId", type_registry_guard);
  bind_hstdVec<org::sem::SemId<org::sem::HashTag>>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::SemId<org::sem::HashTag>>(m, "StdVec", type_registry_guard);
  bind_orgsemSemId<org::sem::HashTag>(m, "SemId", type_registry_guard);
  bind_hstdVec<org::sem::SemId<org::sem::SubtreeLog>>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::SemId<org::sem::SubtreeLog>>(m, "StdVec", type_registry_guard);
  bind_orgsemSemId<org::sem::SubtreeLog>(m, "SemId", type_registry_guard);
  bind_hstdVec<org::sem::NamedProperty>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::NamedProperty>(m, "StdVec", type_registry_guard);
  bind_hstdVec<org::sem::SubtreePeriod>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::SubtreePeriod>(m, "StdVec", type_registry_guard);
  bind_hstdIntSet<org::sem::SubtreePeriod::Kind>(m, "IntSet", type_registry_guard);
  bind_stdint_set<org::sem::SubtreePeriod::Kind>(m, "StdInt_set", type_registry_guard);
  bind_hstdVec<org::sem::TodoKeyword>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::TodoKeyword>(m, "StdVec", type_registry_guard);
  bind_orgsemSemId<org::sem::RawText>(m, "SemId", type_registry_guard);
  bind_orgsemSemId<org::sem::DocumentOptions>(m, "SemId", type_registry_guard);
  bind_stdvariant<org::sem::File::Document, org::sem::File::Attachment, org::sem::File::Source>(m, "StdVariant", type_registry_guard);
  bind_stdvariant<org::sem::CmdInclude::Example, org::sem::CmdInclude::Export, org::sem::CmdInclude::Custom, org::sem::CmdInclude::Src, org::sem::CmdInclude::OrgDocument>(m, "StdVariant", type_registry_guard);
  bind_hstdextImmVec<org::imm::ImmIdT<org::imm::ImmErrorItem>>(m, "ImmVec", type_registry_guard);
  bind_orgimmImmIdT<org::imm::ImmErrorItem>(m, "ImmIdT", type_registry_guard);
  bind_hstdextImmVec<org::imm::ImmIdT<org::imm::ImmOrg>>(m, "ImmVec", type_registry_guard);
  bind_orgimmImmIdT<org::imm::ImmOrg>(m, "ImmIdT", type_registry_guard);
  bind_hstdextImmBox<hstd::Str>(m, "ImmBox", type_registry_guard);
  bind_stdvariant<org::imm::ImmTime::Static, org::imm::ImmTime::Dynamic>(m, "StdVariant", type_registry_guard);
  bind_hstdextImmVec<org::imm::ImmTime::Repeat>(m, "ImmVec", type_registry_guard);
  bind_hstdextImmBox<hstd::Opt<org::imm::ImmTime::Repeat>>(m, "ImmBox", type_registry_guard);
  bind_orgimmImmIdT<org::imm::ImmTime>(m, "ImmIdT", type_registry_guard);
  bind_hstdextImmVec<org::imm::ImmSymbol::Param>(m, "ImmVec", type_registry_guard);
  bind_hstdextImmBox<hstd::Opt<hstd::Str>>(m, "ImmBox", type_registry_guard);
  bind_hstdextImmVec<org::imm::ImmIdT<org::imm::ImmErrorSkipToken>>(m, "ImmVec", type_registry_guard);
  bind_orgimmImmIdT<org::imm::ImmErrorSkipToken>(m, "ImmIdT", type_registry_guard);
  bind_hstdextImmVec<hstd::Str>(m, "ImmVec", type_registry_guard);
  bind_hstdextImmBox<hstd::Opt<org::imm::ImmIdT<org::imm::ImmStmtList>>>(m, "ImmBox", type_registry_guard);
  bind_orgimmImmIdT<org::imm::ImmStmtList>(m, "ImmIdT", type_registry_guard);
  bind_hstdextImmBox<hstd::Opt<org::sem::SubtreeCompletion>>(m, "ImmBox", type_registry_guard);
  bind_hstdextImmBox<hstd::Opt<org::imm::ImmIdT<org::imm::ImmParagraph>>>(m, "ImmBox", type_registry_guard);
  bind_orgimmImmIdT<org::imm::ImmParagraph>(m, "ImmIdT", type_registry_guard);
  bind_hstdextImmVec<org::imm::ImmIdT<org::imm::ImmHashTag>>(m, "ImmVec", type_registry_guard);
  bind_orgimmImmIdT<org::imm::ImmHashTag>(m, "ImmIdT", type_registry_guard);
  bind_hstdextImmVec<org::imm::ImmIdT<org::imm::ImmSubtreeLog>>(m, "ImmVec", type_registry_guard);
  bind_orgimmImmIdT<org::imm::ImmSubtreeLog>(m, "ImmIdT", type_registry_guard);
  bind_hstdextImmVec<org::sem::NamedProperty>(m, "ImmVec", type_registry_guard);
  bind_hstdextImmBox<hstd::Opt<org::imm::ImmIdT<org::imm::ImmTime>>>(m, "ImmBox", type_registry_guard);
  bind_hstdextImmBox<hstd::Opt<bool>>(m, "ImmBox", type_registry_guard);
  bind_hstdextImmBox<hstd::Opt<int>>(m, "ImmBox", type_registry_guard);
  bind_hstdextImmBox<hstd::Opt<org::sem::ColumnView>>(m, "ImmBox", type_registry_guard);
  bind_hstdextImmVec<org::sem::TodoKeyword>(m, "ImmVec", type_registry_guard);
  bind_hstdextImmBox<hstd::Opt<org::imm::ImmIdT<org::imm::ImmRawText>>>(m, "ImmBox", type_registry_guard);
  bind_orgimmImmIdT<org::imm::ImmRawText>(m, "ImmIdT", type_registry_guard);
  bind_orgimmImmIdT<org::imm::ImmDocumentOptions>(m, "ImmIdT", type_registry_guard);
  bind_stdvariant<org::imm::ImmFile::Document, org::imm::ImmFile::Attachment, org::imm::ImmFile::Source>(m, "StdVariant", type_registry_guard);
  bind_stdvariant<org::imm::ImmCmdInclude::Example, org::imm::ImmCmdInclude::Export, org::imm::ImmCmdInclude::Custom, org::imm::ImmCmdInclude::Src, org::imm::ImmCmdInclude::OrgDocument>(m, "StdVariant", type_registry_guard);
  bind_hstdextImmBox<hstd::Opt<org::sem::SubtreePath>>(m, "ImmBox", type_registry_guard);
  bind_hstdVec<org::sem::SemId<org::sem::BigIdent>>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::SemId<org::sem::BigIdent>>(m, "StdVec", type_registry_guard);
  bind_orgsemSemId<org::sem::BigIdent>(m, "SemId", type_registry_guard);
  bind_hstdVec<hstd::UserTime>(m, "HstdVec", type_registry_guard);
  bind_stdvector<hstd::UserTime>(m, "StdVec", type_registry_guard);
  bind_hstdVec<org::sem::SemId<org::sem::Time>>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::SemId<org::sem::Time>>(m, "StdVec", type_registry_guard);
  bind_hstdextImmBox<hstd::Opt<org::imm::ImmIdT<org::imm::ImmOrg>>>(m, "ImmBox", type_registry_guard);
  bind_hstdVec<org::sem::SemId<org::sem::Cell>>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::SemId<org::sem::Cell>>(m, "StdVec", type_registry_guard);
  bind_orgsemSemId<org::sem::Cell>(m, "SemId", type_registry_guard);
  bind_hstdextImmVec<org::imm::ImmIdT<org::imm::ImmCell>>(m, "ImmVec", type_registry_guard);
  bind_orgimmImmIdT<org::imm::ImmCell>(m, "ImmIdT", type_registry_guard);
  bind_hstdVec<org::sem::OrgCodeEvalOutput>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::OrgCodeEvalOutput>(m, "StdVec", type_registry_guard);
  bind_hstdVec<org::sem::SemId<org::sem::BlockCodeEvalResult>>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::SemId<org::sem::BlockCodeEvalResult>>(m, "StdVec", type_registry_guard);
  bind_orgsemSemId<org::sem::BlockCodeEvalResult>(m, "SemId", type_registry_guard);
  bind_hstdVec<org::sem::BlockCodeLine>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::BlockCodeLine>(m, "StdVec", type_registry_guard);
  bind_hstdVec<org::sem::SemId<org::sem::Row>>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::sem::SemId<org::sem::Row>>(m, "StdVec", type_registry_guard);
  bind_orgsemSemId<org::sem::Row>(m, "SemId", type_registry_guard);
  bind_hstdextImmVec<org::sem::OrgCodeEvalOutput>(m, "ImmVec", type_registry_guard);
  bind_hstdextImmVec<org::imm::ImmIdT<org::imm::ImmBlockCodeEvalResult>>(m, "ImmVec", type_registry_guard);
  bind_orgimmImmIdT<org::imm::ImmBlockCodeEvalResult>(m, "ImmIdT", type_registry_guard);
  bind_hstdextImmVec<org::sem::BlockCodeLine>(m, "ImmVec", type_registry_guard);
  bind_hstdextImmVec<org::imm::ImmIdT<org::imm::ImmRow>>(m, "ImmVec", type_registry_guard);
  bind_orgimmImmIdT<org::imm::ImmRow>(m, "ImmIdT", type_registry_guard);
  bind_orgsemSemId<org::sem::Document>(m, "SemId", type_registry_guard);
  bind_hstdVec<org::AstTrackingGroup>(m, "HstdVec", type_registry_guard);
  bind_stdvector<org::AstTrackingGroup>(m, "StdVec", type_registry_guard);
  bind_hstdVec<hstd::SequenceAnnotation>(m, "HstdVec", type_registry_guard);
  bind_stdvector<hstd::SequenceAnnotation>(m, "StdVec", type_registry_guard);
  bind_hstdVec<hstd::SequenceSegmentGroup>(m, "HstdVec", type_registry_guard);
  bind_stdvector<hstd::SequenceSegmentGroup>(m, "StdVec", type_registry_guard);
  bind_stdshared_ptr<org::parse::ParseContext>(m, "StdShared_ptr", type_registry_guard);
