...
PYBIND11_MODULE(pyhaxorg, m) {
  ...
  pybind11::enum_<OrgTokenKind>(m, "OrgTokenKind")
    ...
    .value("CmdTableInnerPipe", OrgTokenKind::CmdTableInnerPipe)
    .value("CmdTableLeadPipe", OrgTokenKind::CmdTableLeadPipe)
    .value("CmdTableTrailPipe", OrgTokenKind::CmdTableTrailPipe)
    .value("CmdTableSeparator", OrgTokenKind::CmdTableSeparator)
    .value("CmdTableRow", OrgTokenKind::CmdTableRow)
    .value("CmdTableCell", OrgTokenKind::CmdTableCell)
