...
PYBIND11_MODULE(pyhaxorg, m) {
  ...
  pybind11::enum_<OrgTokenKind>(m, "OrgTokenKind")
    ...
    .value("GroupStart", OrgTokenKind::GroupBegin, R"RAW(Start of the tokenizer token group)RAW")
    ...
    .value("CommandPrefix", OrgTokenKind::CmdPrefix)
    .value("LineCommand", OrgTokenKind::CmdLine)
    .value("CommandBegin", OrgTokenKind::CmdBegin, R"RAW(`#+begin` part of the multiline command. `begin_<block-type>` is split into two tokens - `begin_` prefix and `ockBegin<block-type>` section.)RAW")
    .value("CommandEnd", OrgTokenKind::CmdEnd)
    ...
    .value("StmtListOpen", OrgTokenKind::StmtListBegin, R"RAW(Start of the expanded statement list content)RAW")
    .value("StmtListClose", OrgTokenKind::StmtListEnd, R"RAW(End of the expanded statement list content)RAW")
    .value("ListStart", OrgTokenKind::ListBegin, R"RAW(Start of the list token group)RAW")
    .value("ListItemStart", OrgTokenKind::ListItemBegin, R"RAW(Start of the list item element)RAW")
    .value("ListClock", OrgTokenKind::ListClock, R"RAW(`CLOCK:` entry at the Begin of the logbook entry list)RAW")
    .value("ListPlus", OrgTokenKind::ListPlus)
    .value("ListStar", OrgTokenKind::ListStar)
    .value("ListDescOpen", OrgTokenKind::ListDescBegin, R"RAW(Start of the description list key,)RAW")
    .value("ListDescClose", OrgTokenKind::ListDescEnd, R"RAW(End of the description list key `::`)RAW")
   ...
   write it in the random place in the subtree.)RAW")
    ...
    .value("InactiveTimeBegin", OrgTokenKind::InactiveTimeBegin, R"RAW(Begin of the inactive timestamp (`[2022-03-12]`))RAW")
    .value("InactiveTimeEnd", OrgTokenKind::InactiveTimeEnd)
    .value("ActiveTimeBegin", OrgTokenKind::ActiveTimeBegin, R"RAW(Begin of the active timestamp `<2030-02-03>`)RAW")
    ...
    .value("TimeDash", OrgTokenKind::TimeDash, R"RAW(Separator dash between two periods in the time range (`<Begin>--<finish.`))RAW")
    ...
    .value("CommandArgumentsBegin", OrgTokenKind::CmdArgumentsBegin, R"RAW(List of command arguments)RAW")
    .value("CommandArgumentsEnd", OrgTokenKind::CmdArgumentsEnd, R"RAW(End of the command arguments list)RAW")
    .value("CommandKey", OrgTokenKind::CmdKey)
    .value("CommandValue", OrgTokenKind::CmdValue)
    .value("CommandFlag", OrgTokenKind::CmdFlag)
    .value("CommandBracket", OrgTokenKind::CmdBracket, R"RAW(`#+results[HASH...]`)RAW")
    ...
    .value("ColonProperties", OrgTokenKind::ColonProperties, R"RAW(Begin of the `:PROPERTIES:` block drawer block)RAW")
    .value("ColonDescription", OrgTokenKind::ColonDescription, R"RAW(Begin of the `:description:` drawer block)RAW")
    .value("ColonEnd", OrgTokenKind::ColonEnd)
    .value("ColonLogbook", OrgTokenKind::ColonLogbook)
    .value("RawLogbook", OrgTokenKind::RawLogbook)
    .value("LogbookStart", OrgTokenKind::LogbookBegin)
    ...
    .value("CommandContentStart", OrgTokenKind::CommandContentBegin)
    ...
    .value("CodeContentBegin", OrgTokenKind::CodeContentBegin, R"RAW(Begin of the expanded code content)RAW")
    ...
    .value("BoldOpen", OrgTokenKind::BoldBegin)
    .value("BoldClose", OrgTokenKind::BoldEnd)
    .value("BoldInline", OrgTokenKind::BoldInline)
    .value("BoldInlineOpen", OrgTokenKind::BoldInlineBegin)
    .value("BoldInlineClose", OrgTokenKind::BoldInlineEnd)
    .value("ItalicOpen", OrgTokenKind::ItalicBegin)
    .value("ItalicClose", OrgTokenKind::ItalicEnd)
    .value("ItalicInline", OrgTokenKind::ItalicInline)
    .value("ItalicInlineOpen", OrgTokenKind::ItalicInlineBegin)
    .value("ItalicInlineClose", OrgTokenKind::ItalicInlineEnd)
    .value("VerbatimOpen", OrgTokenKind::VerbatimBegin)
    .value("VerbatimClose", OrgTokenKind::VerbatimEnd)
    .value("VerbatimInline", OrgTokenKind::VerbatimInline)
    .value("VerbatimInlineOpen", OrgTokenKind::VerbatimInlineBegin)
    .value("VerbatimInlineClose", OrgTokenKind::VerbatimInlineEnd)
    .value("MonospaceOpen", OrgTokenKind::MonospaceBegin)
    .value("MonospaceClose", OrgTokenKind::MonospaceEnd)
    .value("MonospaceInline", OrgTokenKind::MonospaceInline)
    .value("MonospaceInlineOpen", OrgTokenKind::MonospaceInlineBegin)
    .value("MonospaceInlineClose", OrgTokenKind::MonospaceInlineEnd)
    .value("BacktickOpen", OrgTokenKind::BacktickBegin)
    .value("BacktickClose", OrgTokenKind::BacktickEnd)
    .value("BacktickInline", OrgTokenKind::BacktickInline)
    .value("BacktickInlineOpen", OrgTokenKind::BacktickInlineBegin)
    .value("BacktickInlineClose", OrgTokenKind::BacktickInlineEnd)
    .value("UnderlineOpen", OrgTokenKind::UnderlineBegin)
    .value("UnderlineClose", OrgTokenKind::UnderlineEnd)
    .value("UnderlineInline", OrgTokenKind::UnderlineInline)
    .value("UnderlineInlineOpen", OrgTokenKind::UnderlineInlineBegin)
    .value("UnderlineInlineClose", OrgTokenKind::UnderlineInlineEnd)
    .value("StrikeOpen", OrgTokenKind::StrikeBegin)
    .value("StrikeClose", OrgTokenKind::StrikeEnd)
    .value("StrikeInline", OrgTokenKind::StrikeInline)
    .value("StrikeInlineOpen", OrgTokenKind::StrikeInlineBegin)
    .value("StrikeInlineClose", OrgTokenKind::StrikeInlineEnd)
    .value("QuoteOpen", OrgTokenKind::QuoteBegin)
    .value("QuoteClose", OrgTokenKind::QuoteEnd)
    .value("Punctuation", OrgTokenKind::Punctuation)
    .value("LinkOpen", OrgTokenKind::LinkBegin)
    .value("LinkClose", OrgTokenKind::LinkEnd)
    .value("RawUrl", OrgTokenKind::RawUrl)
    .value("LinkTargetOpen", OrgTokenKind::LinkTargetBegin)
    .value("LinkTargetClose", OrgTokenKind::LinkTargetEnd)
    ...
    .value("LinkDescriptionOpen", OrgTokenKind::LinkDescriptionBegin)
    .value("LinkDescriptionClose", OrgTokenKind::LinkDescriptionEnd)
    .value("TextSeparator", OrgTokenKind::TextSeparator)
    .value("ParagraphStart", OrgTokenKind::ParagraphBegin, R"RAW(Fake token inserted by the lexer to delimit start of the paragraph)RAW")
    .value("ParagraphEnd", OrgTokenKind::ParagraphEnd)
    .value("FootnoteStart", OrgTokenKind::FootnoteBegin)
    ...
    .value("InlineSrc", OrgTokenKind::InlineSrc, R"RAW(Begin of an inline source code block: `src_nim[]{}`)RAW")
    .value("InlineCall", OrgTokenKind::InlineCall, R"RAW(Begin of an inline call block: `call_name[]{}`)RAW")
    .value("CurlyStart", OrgTokenKind::CurlyBegin, R"RAW(Start of the curly section of an inline source/call)RAW")
    .value("CurlyEnd", OrgTokenKind::CurlyEnd, R"RAW(End of the curly section of an inline source/call)RAW")
    .value("SymbolStart", OrgTokenKind::SymbolBegin, R"RAW(Unquoted `\symbol` directly in the text)RAW")
    .value("Ident", OrgTokenKind::Ident)
    .value("DollarOpen", OrgTokenKind::DollarBegin, R"RAW(Opening dollar inline latex math)RAW")
    .value("DollarClose", OrgTokenKind::DollarEnd, R"RAW(Closing dollar for inline latex math)RAW")
    .value("DoubleDollarOpen", OrgTokenKind::DoubleDollarBegin, R"RAW(Opening `$` for inline latex)RAW")
    .value("DoubleDollarClose", OrgTokenKind::DoubleDollarEnd, R"RAW(Closing `$` for inline latex)RAW")
    .value("LatexParOpen", OrgTokenKind::LatexParBegin, R"RAW(Opening `\(` for inline latex math)RAW")
    .value("LatexParClose", OrgTokenKind::LatexParEnd, R"RAW(Closing `\)` for inline latex math)RAW")
    .value("LatexBraceOpen", OrgTokenKind::LatexBraceBegin, R"RAW(Opening `\[` for inline display latex equation)RAW")
    .value("LatexBraceClose", OrgTokenKind::LatexBraceEnd, R"RAW(Closing `\]` for inline display latex equation)RAW")
    .value("LatexInlineRaw", OrgTokenKind::LatexInlineRaw, R"RAW(Content of the brace/par-enEndd math)RAW")
    ...
    .value("HashTag", OrgTokenKind::HashTag, R"RAW(Begin of the inline hashtag `#tag`)RAW")
    .value("HashTagSub", OrgTokenKind::HashTagSub, R"RAW(Nested hashtag separator)RAW")
    .value("HashTagOpen", OrgTokenKind::HashTagBegin, R"RAW(Start of the nested hashtag grop bracket)RAW")
    .value("HashTagClose", OrgTokenKind::HashTagEnd, R"RAW(End of the nested hashtag group separator)RAW")
    .value("Comma", OrgTokenKind::Comma, R"RAW(Comma - punctuation or a syntax element (e.g. for macro arguments))RAW")
    .value("ParOpen", OrgTokenKind::ParBegin, R"RAW(Paren open - punctuation or a syntax element)RAW")
    .value("ParClose", OrgTokenKind::ParEnd, R"RAW(Paren close - punctuation or a syntax element)RAW")
    .value("Colon", OrgTokenKind::Colon)
    .value("Circumflex", OrgTokenKind::Circumflex, R"RAW(`^` possible superscript in the text)RAW")
    .value("MacroOpen", OrgTokenKind::MacroBegin, R"RAW(Start of the macro call `{{{`)RAW")
    .value("MacroClose", OrgTokenKind::MacroEnd, R"RAW(Close of the macro call `}}}`)RAW")
    .value("MetaBraceOpen", OrgTokenKind::MetaBraceBegin)
    .value("MetaBraceBody", OrgTokenKind::MetaBraceBody)
    .value("MetaBraceClose", OrgTokenKind::MetaBraceEnd)
    .value("MetaArgsOpen", OrgTokenKind::MetaArgsBegin)
    .value("MetaArgsBody", OrgTokenKind::MetaArgsBody)
    .value("MetaArgsClose", OrgTokenKind::MetaArgsEnd)
    .value("SrcOpen", OrgTokenKind::SrcBegin)
    .value("SrcName", OrgTokenKind::SrcName)
    .value("SrcArgs", OrgTokenKind::SrcArgs)
    .value("SrcBody", OrgTokenKind::SrcBody)
    .value("SrcClose", OrgTokenKind::SrcEnd)
    .value("CallOpen", OrgTokenKind::CallBegin)
    ...
    .value("CallClose", OrgTokenKind::CallEnd)
    ...
    .value("ContentStart", OrgTokenKind::ContentBegin, R"RAW(Start of the table cell content section)RAW")
    .value("ContentEnd", OrgTokenKind::ContentEnd, R"RAW(End of the table cell content section)RAW")
    .value("PipeOpen", OrgTokenKind::PipeBegin)
    .value("PipeSeparator", OrgTokenKind::PipeSeparator, R"RAW(Vertical pipe (`|`) cell separator)RAW")
    .value("PipeClose", OrgTokenKind::PipeEnd)
    .value("PipeCellOpen", OrgTokenKind::PipeCellBegin)
    ...
    .value("DoubleAngleOpen", OrgTokenKind::DoubleAngleBegin, R"RAW(`<<` - open for noweb or anchor placeholder)RAW")
    .value("DoubleAngleClose", OrgTokenKind::DoubleAngleEnd, R"RAW(`>>` - close for noweb or anchor placeholder)RAW")
    .value("TripleAngleOpen", OrgTokenKind::TripleAngleBegin, R"RAW(`<<<` - radio target open)RAW")
    .value("TripleAngleClose", OrgTokenKind::TripleAngleEnd, R"RAW(`>>>` - radio target close)RAW")
    .value("AngleOpen", OrgTokenKind::AngleBegin, R"RAW(Placeholder open)RAW")
    .value("AngleClose", OrgTokenKind::AngleEnd, R"RAW(Placeholder close)RAW")
...
return state.)RAW")
  ...
  pybind11::class_<ExporterPython>(m, "ExporterPython")
    ...
    .def("setVisitAnyIdAround",
         ...
         pybind11::arg("cb"))
    .def("setVisitAnyIdIn",
         static_cast<void(ExporterPython::*)(pybind11::function)>(&ExporterPython::setVisitAnyIdIn),
         pybind11::arg("cb"))
    .def("setVisitAnyField",
         static_cast<void(ExporterPython::*)(pybind11::function)>(&ExporterPython::setVisitAnyField),
         pybind11::arg("cb"))
    .def("setEvalTopCb",
         static_cast<void(ExporterPython::*)(pybind11::function)>(&ExporterPython::setEvalTopCb),
         pybind11::arg("cb"))
    .def("setVisitIdAround",
         static_cast<void(ExporterPython::*)(OrgSemKind, pybind11::function)>(&ExporterPython::setVisitIdAround),
         pybind11::arg("kind"),
         pybind11::arg("cb"))
    .def("setEvalIdAround",
         static_cast<void(ExporterPython::*)(OrgSemKind, pybind11::function)>(&ExporterPython::setEvalIdAround),
         pybind11::arg("kind"),
         pybind11::arg("cb"))
    .def("setVisitIdInCb",
         static_cast<void(ExporterPython::*)(OrgSemKind, pybind11::function)>(&ExporterPython::setVisitIdInCb),
         pybind11::arg("kind"),
         pybind11::arg("cb"))
    .def("setEvalIdIn",
         static_cast<void(ExporterPython::*)(OrgSemKind, pybind11::function)>(&ExporterPython::setEvalIdIn),
         pybind11::arg("kind"),
         pybind11::arg("cb"))
    .def("setVisitLeafField",
         static_cast<void(ExporterPython::*)(LeafFieldType, pybind11::function)>(&ExporterPython::setVisitLeafField),
         pybind11::arg("kind"),
         pybind11::arg("cb"))
    .def("setEvalLeafField",
         static_cast<void(ExporterPython::*)(LeafFieldType, pybind11::function)>(&ExporterPython::setEvalLeafField),
         pybind11::arg("kind"),
         pybind11::arg("cb"))
    .def("setVisitOrgField",
         static_cast<void(ExporterPython::*)(OrgSemKind, pybind11::function)>(&ExporterPython::setVisitOrgField),
         pybind11::arg("kind"),
         pybind11::arg("cb"))
    .def("setEvalOrgField",
         static_cast<void(ExporterPython::*)(OrgSemKind, pybind11::function)>(&ExporterPython::setEvalOrgField),
         pybind11::arg("kind"),
         pybind11::arg("cb"))
    .def("setSelf",
         ...
         pybind11::arg("val"))
    .def("setNewOrgRes",
         static_cast<void(ExporterPython::*)(OrgSemKind, pybind11::function)>(&ExporterPython::setNewOrgRes),
         pybind11::arg("kind"),
         pybind11::arg("cb"))
    .def("setNewAnyOrgRes",
         static_cast<void(ExporterPython::*)(pybind11::function)>(&ExporterPython::setNewAnyOrgRes),
         pybind11::arg("cb"))
    .def("setNewLeafRes",
         static_cast<void(ExporterPython::*)(LeafFieldType, pybind11::function)>(&ExporterPython::setNewLeafRes),
         pybind11::arg("kind"),
         pybind11::arg("cb"))
    .def("setNewAnyLeafRes",
         static_cast<void(ExporterPython::*)(pybind11::function)>(&ExporterPython::setNewAnyLeafRes),
         pybind11::arg("cb"))
    .def("setPushVisitAnyId",
         static_cast<void(ExporterPython::*)(pybind11::function)>(&ExporterPython::setPushVisitAnyId),
         pybind11::arg("cb"))
    .def("setPopVisitAnyId",
         static_cast<void(ExporterPython::*)(pybind11::function)>(&ExporterPython::setPopVisitAnyId),
         pybind11::arg("cb"))
    .def("setPushVisitId",
         static_cast<void(ExporterPython::*)(OrgSemKind, pybind11::function)>(&ExporterPython::setPushVisitId),
         pybind11::arg("kind"),
         pybind11::arg("cb"))
    .def("setPopVisitIdCb",
         static_cast<void(ExporterPython::*)(OrgSemKind, pybind11::function)>(&ExporterPython::setPopVisitIdCb),
         pybind11::arg("kind"),
         pybind11::arg("cb"))
    .def("setVisitAnyHookCb",
         static_cast<void(ExporterPython::*)(pybind11::function)>(&ExporterPython::setVisitAnyHookCb),
         pybind11::arg("cb"))
    .def("setVisitIdHook",
         static_cast<void(ExporterPython::*)(OrgSemKind, pybind11::function)>(&ExporterPython::setVisitIdHook),
         pybind11::arg("kind"),
         pybind11::arg("cb"))
    .def("evalTop",
