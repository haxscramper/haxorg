...
NB_MODULE(py_adaptagrams, m) {
  ...
  nanobind::enum_<hstd::ext::GraphDimension>(m, "GraphDimension")
    ...
    .def("__int__",
         [](hstd::ext::GraphDimension const& _self, hstd::ext::GraphDimension v) -> int {
  ...
  nanobind::enum_<hstd::ext::GraphNodeConstraint::Kind>(m, "GraphNodeConstraintKind")
    ...
    .def("__int__",
         [](hstd::ext::GraphNodeConstraint::Kind const& _self, hstd::ext::GraphNodeConstraint::Kind v) -> int {
         return static_cast<int>(v);
         },
         nanobind::arg("v"))
    .def("__index__",
  ...
  nanobind::enum_<hstd::ext::GraphEdgeConstraint::Port>(m, "GraphEdgeConstraintPort")
    ...
    .def("__int__",
         [](hstd::ext::GraphEdgeConstraint::Port const& _self, hstd::ext::GraphEdgeConstraint::Port v) -> int {
         return static_cast<int>(v);
         },
         nanobind::arg("v"))
    .def("__index__",
