...
OrgSpec getOrgSpec() {
    ...
    OrgSpec orgSpecInstance = OrgSpec(Vec<SpecPair>{
        ...
        SpecPair{
            ...
            OrgPattern({
                ...
                Field(
                    Range(3, N::Title)
                        .doc("Paragraph of text -- title of the "
                             "subtree"),
                ...
                Field(
                    Range(6, N::Times)
                        .doc("Scheduled, closed, and/or deadline "
                             "times for "
                             "the subtree"),
            ...
            OrgPattern({
                ...
                Field(
                    Range(slice(1, 1_B), N::Subnodes)
                        .doc("Zero or more nested elements for nested "
                             "tag "
                             "path"),
        ...
        SpecPair{
            ...
            OrgPattern({
                ...
                Field(
                    Range(1, N::Logbook)
                        .doc("Optional list of log entries attached "
                             "to the "
                             "subtree"),
            ...
            OrgPattern({
                ...
                Field(
                    Range(1, N::Description)
                        .doc("Additional annotation or the "
                             "description of "
                             "the transition"),
                    OrgPattern({
                        org::StmtList,
        ...
        SpecPair{
            ...
            OrgPattern({
                Field(
                    Range(0, N::Newstate)
                        .doc("State that subtree was transitioned "
                             "from"),
                    OrgPattern({org::BigIdent, org::Empty})),
                Field(
                    Range(1, N::Oldstate)
                ...
                Field(
                    Range(5, N::Body)
                        .doc("Additional list items - more sublists, "
                             "extended N::Body (with code blocks, "
                             "extra "
                             "parargaphs etc.)"),
                    OrgPattern({org::StmtList, org::Empty})),
            })},
        ...
        SpecPair{
            ...
            OrgPattern({
                ...
                Field(
                    Range(1, N::Text)
                        .doc("N::It is possible to put text on the* "
                             "row* "
                             "level."),
                    OrgPattern({org::Paragraph, org::Empty})),
                Field(
