...
HAXORG_C_API_LINKAGE haxorg_ptr_payload haxorg_HstdMapOfKVHash_keys_const(OrgContext* org_context, haxorg_HstdMap __this);
HAXORG_C_API_LINKAGE haxorg_ptr_payload haxorg_ImmMapOfKV_get_const(OrgContext* org_context, haxorg_ImmMap __this, haxorg_ptr_payload const& key);
HAXORG_C_API_LINKAGE bool haxorg_ImmMapOfKV_contains_const(OrgContext* org_context, haxorg_ImmMap __this, haxorg_ptr_payload const& key);
HAXORG_C_API_LINKAGE haxorg_ptr_payload haxorg_ImmMapOfKV_keys_const(OrgContext* org_context, haxorg_ImmMap __this);
HAXORG_C_API_LINKAGE haxorg_ptr_payload haxorg_OptOfT_value(OrgContext* org_context, haxorg_Opt __this);
...
HAXORG_C_API_LINKAGE haxorg_HstdVecOfAttrValue haxorg_AttrGroup_getAttrs_const(OrgContext* org_context, haxorg_AttrGroup __this, haxorg_Opt key);
...
HAXORG_C_API_LINKAGE haxorg_HstdVecOfSemIdOfOrg haxorg_Stmt_getAttached_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_Opt kind);
...
HAXORG_C_API_LINKAGE haxorg_HstdVecOfAttrValue haxorg_Stmt_getAttrs_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_Opt kind);
...
HAXORG_C_API_LINKAGE haxorg_HstdVecOfNamedProperty haxorg_Subtree_getProperties_const(OrgContext* org_context, haxorg_Subtree __this, haxorg_HstdStr kind, haxorg_Opt subkind);
...
HAXORG_C_API_LINKAGE haxorg_HstdVecOfNamedProperty haxorg_DocumentOptions_getProperties_const(OrgContext* org_context, haxorg_DocumentOptions __this, haxorg_HstdStr kind, haxorg_Opt subKind);
...
HAXORG_C_API_LINKAGE haxorg_HstdVecOfNamedProperty haxorg_Document_getProperties_const(OrgContext* org_context, haxorg_Document __this, haxorg_HstdStr kind, haxorg_Opt subKind);
...
HAXORG_C_API_LINKAGE haxorg_HstdVecOfAttrValue haxorg_Cmd_getAttrs_const(OrgContext* org_context, haxorg_Cmd __this, haxorg_Opt key);
