...
/// \brief ['hstd', 'IntSet', [['org', 'sem', 'SubtreePeriod', 'Kind']]]
struct haxorg_IntSetOfSubtreePeriodKind {
  haxorg_ptr_payload data;
};
...
typedef haxorg_StdOptional haxorg_OptOfT;
...
HAXORG_C_API_LINKAGE haxorg_OptOfTblfmExprAxisRefPosition haxorg_TblfmExprAxisRef_get_row(OrgContext* org_context, haxorg_TblfmExprAxisRef __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfTblfmExprAxisRef haxorg_TblfmExprRangeRef_get_first(OrgContext* org_context, haxorg_TblfmExprRangeRef __this);
HAXORG_C_API_LINKAGE haxorg_OptOfTblfmExprAxisRef haxorg_TblfmExprRangeRef_get_last(OrgContext* org_context, haxorg_TblfmExprRangeRef __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_AttrValue_get_name(OrgContext* org_context, haxorg_AttrValue __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_AttrValue_get_varname(OrgContext* org_context, haxorg_AttrValue __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_AttrValue_getBool_const(OrgContext* org_context, haxorg_AttrValue __this);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_AttrValue_getInt_const(OrgContext* org_context, haxorg_AttrValue __this);
HAXORG_C_API_LINKAGE haxorg_HstdStr haxorg_AttrValue_getString_const(OrgContext* org_context, haxorg_AttrValue __this);
HAXORG_C_API_LINKAGE haxorg_OptOfDouble haxorg_AttrValue_getDouble_const(OrgContext* org_context, haxorg_AttrValue __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_AttrValueDimensionSpan_get_last(OrgContext* org_context, haxorg_AttrValueDimensionSpan __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_TodoKeyword_get_shortcut(OrgContext* org_context, haxorg_TodoKeyword __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStdString haxorg_SubtreeLogHeadPriority_get_oldPriority(OrgContext* org_context, haxorg_SubtreeLogHeadPriority __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStdString haxorg_SubtreeLogHeadPriority_get_newPriority(OrgContext* org_context, haxorg_SubtreeLogHeadPriority __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfUserTime haxorg_SubtreeLogHeadClock_get_to(OrgContext* org_context, haxorg_SubtreeLogHeadClock __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfUserTime haxorg_SubtreeLogHeadDeadline_get_from(OrgContext* org_context, haxorg_SubtreeLogHeadDeadline __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfUserTime haxorg_SubtreeLogHeadSchedule_get_from(OrgContext* org_context, haxorg_SubtreeLogHeadSchedule __this);
...
HAXORG_C_API_LINKAGE haxorg_HstdVecOfAttrValue haxorg_AttrGroup_getAttrs_const(OrgContext* org_context, haxorg_AttrGroup __this, haxorg_OptOfStr key);
...
HAXORG_C_API_LINKAGE haxorg_OptOfAttrValue haxorg_AttrGroup_getPositional_const(OrgContext* org_context, haxorg_AttrGroup __this, int index);
...
HAXORG_C_API_LINKAGE haxorg_OptOfAttrList haxorg_AttrGroup_getNamed_const(OrgContext* org_context, haxorg_AttrGroup __this, haxorg_HstdStr index);
...
HAXORG_C_API_LINKAGE haxorg_OptOfAttrValue haxorg_AttrGroup_getFirstNamed_const(OrgContext* org_context, haxorg_AttrGroup __this, haxorg_HstdStr index);
...
HAXORG_C_API_LINKAGE haxorg_OptOfAttrList haxorg_AttrGroup_getVarNamed_const(OrgContext* org_context, haxorg_AttrGroup __this, haxorg_HstdStr index);
...
HAXORG_C_API_LINKAGE haxorg_OptOfAttrValue haxorg_AttrGroup_getFirstVarNamed_const(OrgContext* org_context, haxorg_AttrGroup __this, haxorg_HstdStr index);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_OrgCodeEvalInput_get_exportType(OrgContext* org_context, haxorg_OrgCodeEvalInput __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfOrgCodeEvalInputVar haxorg_OrgCodeEvalInput_getVariable_const(OrgContext* org_context, haxorg_OrgCodeEvalInput __this, haxorg_HstdStr name);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_OrgCodeEvalOutput_get_cmd(OrgContext* org_context, haxorg_OrgCodeEvalOutput __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_ColumnViewSummaryMathAggregate_get_formatDigits(OrgContext* org_context, haxorg_ColumnViewSummaryMathAggregate __this);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_ColumnViewSummaryMathAggregate_get_formatPrecision(OrgContext* org_context, haxorg_ColumnViewSummaryMathAggregate __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfColumnViewSummary haxorg_ColumnViewColumn_get_summary(OrgContext* org_context, haxorg_ColumnViewColumn __this);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_ColumnViewColumn_get_width(OrgContext* org_context, haxorg_ColumnViewColumn __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ColumnViewColumn_get_property(OrgContext* org_context, haxorg_ColumnViewColumn __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ColumnViewColumn_get_propertyTitle(OrgContext* org_context, haxorg_ColumnViewColumn __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_inlinetasks(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_footnotes(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_clock(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_author(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_emphasis(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_specialStrings(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_propertyDrawers(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_statisticsCookies(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_todoText(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_smartQuotes(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_fixedWidth(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_timestamps(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_preserveBreaks(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_subSuperscripts(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_expandLinks(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_creator(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_drawers(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_date(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_entities(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_email(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_sectionNumbers(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_planning(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_priority(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_latex(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_timestamp(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_title(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentExportConfig_get_tables(OrgContext* org_context, haxorg_DocumentExportConfig __this);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_DocumentExportConfig_get_headlineLevels(OrgContext* org_context, haxorg_DocumentExportConfig __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfUserTime haxorg_SubtreePeriod_get_to(OrgContext* org_context, haxorg_SubtreePeriod __this);
...
HAXORG_C_API_LINKAGE bool haxorg_NamedProperty_isMatching_const(OrgContext* org_context, haxorg_NamedProperty __this, haxorg_HstdStr kind, haxorg_OptOfStr subKind);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_NamedProperty_getSubKind_const(OrgContext* org_context, haxorg_NamedProperty __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_NamedPropertyCustomArgs_get_sub(OrgContext* org_context, haxorg_NamedPropertyCustomArgs __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfParseSourceLoc haxorg_OrgDiagnosticsParseError_get_loc(OrgContext* org_context, haxorg_OrgDiagnosticsParseError __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfParseSourceLoc haxorg_OrgDiagnosticsConvertError_get_loc(OrgContext* org_context, haxorg_OrgDiagnosticsConvertError __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfParseSourceLoc haxorg_OrgDiagnosticsInternalError_get_loc(OrgContext* org_context, haxorg_OrgDiagnosticsInternalError __this);
...
HAXORG_C_API_LINKAGE haxorg_HstdVecOfSemIdOfOrg haxorg_Stmt_getAttached_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_OptOfStr kind);
...
HAXORG_C_API_LINKAGE haxorg_HstdVecOfAttrValue haxorg_Stmt_getAttrs_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_OptOfStr kind);
HAXORG_C_API_LINKAGE haxorg_OptOfAttrValue haxorg_Stmt_getFirstAttr_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_HstdStr kind);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_Stmt_getFirstAttrString_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_HstdStr kind);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_Stmt_getFirstAttrInt_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_HstdStr kind);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_Stmt_getFirstAttrBool_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_HstdStr kind);
HAXORG_C_API_LINKAGE haxorg_OptOfDouble haxorg_Stmt_getFirstAttrDouble_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_HstdStr kind);
HAXORG_C_API_LINKAGE haxorg_OptOfAttrValueLispValue haxorg_Stmt_getFirstAttrLisp_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_HstdStr kind);
HAXORG_C_API_LINKAGE haxorg_OptOfAttrValueKind haxorg_Stmt_getFirstAttrKind_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_HstdStr kind);
...
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_Time_getYear_const(OrgContext* org_context, haxorg_Time __this);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_Time_getMonth_const(OrgContext* org_context, haxorg_Time __this);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_Time_getDay_const(OrgContext* org_context, haxorg_Time __this);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_Time_getHour_const(OrgContext* org_context, haxorg_Time __this);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_Time_getMinute_const(OrgContext* org_context, haxorg_Time __this);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_Time_getSecond_const(OrgContext* org_context, haxorg_Time __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfTimeRepeat haxorg_TimeStatic_get_warn(OrgContext* org_context, haxorg_TimeStatic __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfInt64_t haxorg_TimeRange_getClockedTimeSeconds_const(OrgContext* org_context, haxorg_TimeRange __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_SymbolParam_get_key(OrgContext* org_context, haxorg_SymbolParam __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfSemIdOfStmtList haxorg_SubtreeLog_get_desc(OrgContext* org_context, haxorg_SubtreeLog __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_Subtree_get_treeId(OrgContext* org_context, haxorg_Subtree __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_Subtree_get_todo(OrgContext* org_context, haxorg_Subtree __this);
HAXORG_C_API_LINKAGE haxorg_OptOfSubtreeCompletion haxorg_Subtree_get_completion(OrgContext* org_context, haxorg_Subtree __this);
HAXORG_C_API_LINKAGE haxorg_OptOfSemIdOfParagraph haxorg_Subtree_get_description(OrgContext* org_context, haxorg_Subtree __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfSemIdOfTime haxorg_Subtree_get_closed(OrgContext* org_context, haxorg_Subtree __this);
HAXORG_C_API_LINKAGE haxorg_OptOfSemIdOfTime haxorg_Subtree_get_deadline(OrgContext* org_context, haxorg_Subtree __this);
HAXORG_C_API_LINKAGE haxorg_OptOfSemIdOfTime haxorg_Subtree_get_scheduled(OrgContext* org_context, haxorg_Subtree __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_Subtree_get_priority(OrgContext* org_context, haxorg_Subtree __this);
HAXORG_C_API_LINKAGE haxorg_HstdVecOfSubtreePeriod haxorg_Subtree_getTimePeriods_const(OrgContext* org_context, haxorg_Subtree __this, haxorg_IntSetOfSubtreePeriodKind kinds);
HAXORG_C_API_LINKAGE haxorg_HstdVecOfNamedProperty haxorg_Subtree_getProperties_const(OrgContext* org_context, haxorg_Subtree __this, haxorg_HstdStr kind, haxorg_OptOfStr subkind);
HAXORG_C_API_LINKAGE haxorg_OptOfNamedProperty haxorg_Subtree_getProperty_const(OrgContext* org_context, haxorg_Subtree __this, haxorg_HstdStr kind, haxorg_OptOfStr subkind);
HAXORG_C_API_LINKAGE void haxorg_Subtree_removeProperty(OrgContext* org_context, haxorg_Subtree __this, haxorg_HstdStr kind, haxorg_OptOfStr subkind);
...
HAXORG_C_API_LINKAGE void haxorg_Subtree_setPropertyStrValue(OrgContext* org_context, haxorg_Subtree __this, haxorg_HstdStr value, haxorg_HstdStr kind, haxorg_OptOfStr subkind);
HAXORG_C_API_LINKAGE haxorg_HstdStr haxorg_Subtree_getCleanTitle_const(OrgContext* org_context, haxorg_Subtree __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_Subtree_getTodoKeyword_const(OrgContext* org_context, haxorg_Subtree __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfSemIdOfParagraph haxorg_ListItem_get_header(OrgContext* org_context, haxorg_ListItem __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ListItem_get_bullet(OrgContext* org_context, haxorg_ListItem __this);
HAXORG_C_API_LINKAGE bool haxorg_ListItem_isDescriptionItem_const(OrgContext* org_context, haxorg_ListItem __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ListItem_getCleanHeader_const(OrgContext* org_context, haxorg_ListItem __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentOptions_get_fixedWidthSections(OrgContext* org_context, haxorg_DocumentOptions __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_DocumentOptions_get_startupIndented(OrgContext* org_context, haxorg_DocumentOptions __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_DocumentOptions_get_category(OrgContext* org_context, haxorg_DocumentOptions __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_DocumentOptions_get_setupfile(OrgContext* org_context, haxorg_DocumentOptions __this);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_DocumentOptions_get_maxSubtreeLevelExport(OrgContext* org_context, haxorg_DocumentOptions __this);
HAXORG_C_API_LINKAGE haxorg_OptOfColumnView haxorg_DocumentOptions_get_columns(OrgContext* org_context, haxorg_DocumentOptions __this);
...
HAXORG_C_API_LINKAGE haxorg_HstdVecOfNamedProperty haxorg_DocumentOptions_getProperties_const(OrgContext* org_context, haxorg_DocumentOptions __this, haxorg_HstdStr kind, haxorg_OptOfStr subKind);
HAXORG_C_API_LINKAGE haxorg_OptOfNamedProperty haxorg_DocumentOptions_getProperty_const(OrgContext* org_context, haxorg_DocumentOptions __this, haxorg_HstdStr kind, haxorg_OptOfStr subKind);
...
HAXORG_C_API_LINKAGE haxorg_OptOfSemIdOfParagraph haxorg_Document_get_title(OrgContext* org_context, haxorg_Document __this);
HAXORG_C_API_LINKAGE haxorg_OptOfSemIdOfParagraph haxorg_Document_get_author(OrgContext* org_context, haxorg_Document __this);
HAXORG_C_API_LINKAGE haxorg_OptOfSemIdOfParagraph haxorg_Document_get_creator(OrgContext* org_context, haxorg_Document __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfSemIdOfRawText haxorg_Document_get_email(OrgContext* org_context, haxorg_Document __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_Document_get_exportFileName(OrgContext* org_context, haxorg_Document __this);
HAXORG_C_API_LINKAGE haxorg_HstdVecOfNamedProperty haxorg_Document_getProperties_const(OrgContext* org_context, haxorg_Document __this, haxorg_HstdStr kind, haxorg_OptOfStr subKind);
HAXORG_C_API_LINKAGE haxorg_OptOfNamedProperty haxorg_Document_getProperty_const(OrgContext* org_context, haxorg_Document __this, haxorg_HstdStr kind, haxorg_OptOfStr subKind);
...
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_FileTarget_get_line(OrgContext* org_context, haxorg_FileTarget __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_FileTarget_get_searchTarget(OrgContext* org_context, haxorg_FileTarget __this);
HAXORG_C_API_LINKAGE bool haxorg_FileTarget_get_restrictToHeadlines(OrgContext* org_context, haxorg_FileTarget __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_FileTarget_get_targetId(OrgContext* org_context, haxorg_FileTarget __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_FileTarget_get_regexp(OrgContext* org_context, haxorg_FileTarget __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_CmdInclude_get_firstLine(OrgContext* org_context, haxorg_CmdInclude __this);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_CmdInclude_get_lastLine(OrgContext* org_context, haxorg_CmdInclude __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_CmdIncludeOrgDocument_get_onlyContent(OrgContext* org_context, haxorg_CmdIncludeOrgDocument __this);
HAXORG_C_API_LINKAGE haxorg_OptOfSubtreePath haxorg_CmdIncludeOrgDocument_get_subtreePath(OrgContext* org_context, haxorg_CmdIncludeOrgDocument __this);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_CmdIncludeOrgDocument_get_minLevel(OrgContext* org_context, haxorg_CmdIncludeOrgDocument __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_CmdIncludeOrgDocument_get_customIdTarget(OrgContext* org_context, haxorg_CmdIncludeOrgDocument __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfImmTimeRepeat haxorg_ImmTimeStatic_get_warn(OrgContext* org_context, haxorg_ImmTimeStatic __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmSymbolParam_get_key(OrgContext* org_context, haxorg_ImmSymbolParam __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfImmIdTOfImmStmtList haxorg_ImmSubtreeLog_get_desc(OrgContext* org_context, haxorg_ImmSubtreeLog __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmSubtree_get_treeId(OrgContext* org_context, haxorg_ImmSubtree __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmSubtree_get_todo(OrgContext* org_context, haxorg_ImmSubtree __this);
HAXORG_C_API_LINKAGE haxorg_OptOfSubtreeCompletion haxorg_ImmSubtree_get_completion(OrgContext* org_context, haxorg_ImmSubtree __this);
HAXORG_C_API_LINKAGE haxorg_OptOfImmIdTOfImmParagraph haxorg_ImmSubtree_get_description(OrgContext* org_context, haxorg_ImmSubtree __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfImmIdTOfImmTime haxorg_ImmSubtree_get_closed(OrgContext* org_context, haxorg_ImmSubtree __this);
HAXORG_C_API_LINKAGE haxorg_OptOfImmIdTOfImmTime haxorg_ImmSubtree_get_deadline(OrgContext* org_context, haxorg_ImmSubtree __this);
HAXORG_C_API_LINKAGE haxorg_OptOfImmIdTOfImmTime haxorg_ImmSubtree_get_scheduled(OrgContext* org_context, haxorg_ImmSubtree __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmSubtree_get_priority(OrgContext* org_context, haxorg_ImmSubtree __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfImmIdTOfImmParagraph haxorg_ImmListItem_get_header(OrgContext* org_context, haxorg_ImmListItem __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmListItem_get_bullet(OrgContext* org_context, haxorg_ImmListItem __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_ImmDocumentOptions_get_fixedWidthSections(OrgContext* org_context, haxorg_ImmDocumentOptions __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_ImmDocumentOptions_get_startupIndented(OrgContext* org_context, haxorg_ImmDocumentOptions __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmDocumentOptions_get_category(OrgContext* org_context, haxorg_ImmDocumentOptions __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmDocumentOptions_get_setupfile(OrgContext* org_context, haxorg_ImmDocumentOptions __this);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_ImmDocumentOptions_get_maxSubtreeLevelExport(OrgContext* org_context, haxorg_ImmDocumentOptions __this);
HAXORG_C_API_LINKAGE haxorg_OptOfColumnView haxorg_ImmDocumentOptions_get_columns(OrgContext* org_context, haxorg_ImmDocumentOptions __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfImmIdTOfImmParagraph haxorg_ImmDocument_get_title(OrgContext* org_context, haxorg_ImmDocument __this);
HAXORG_C_API_LINKAGE haxorg_OptOfImmIdTOfImmParagraph haxorg_ImmDocument_get_author(OrgContext* org_context, haxorg_ImmDocument __this);
HAXORG_C_API_LINKAGE haxorg_OptOfImmIdTOfImmParagraph haxorg_ImmDocument_get_creator(OrgContext* org_context, haxorg_ImmDocument __this);
HAXORG_C_API_LINKAGE haxorg_ImmVec haxorg_ImmDocument_get_filetags(OrgContext* org_context, haxorg_ImmDocument __this);
HAXORG_C_API_LINKAGE haxorg_OptOfImmIdTOfImmRawText haxorg_ImmDocument_get_email(OrgContext* org_context, haxorg_ImmDocument __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmDocument_get_exportFileName(OrgContext* org_context, haxorg_ImmDocument __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_ImmFileTarget_get_line(OrgContext* org_context, haxorg_ImmFileTarget __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmFileTarget_get_searchTarget(OrgContext* org_context, haxorg_ImmFileTarget __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmFileTarget_get_targetId(OrgContext* org_context, haxorg_ImmFileTarget __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmFileTarget_get_regexp(OrgContext* org_context, haxorg_ImmFileTarget __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_ImmCmdInclude_get_firstLine(OrgContext* org_context, haxorg_ImmCmdInclude __this);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_ImmCmdInclude_get_lastLine(OrgContext* org_context, haxorg_ImmCmdInclude __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_ImmCmdIncludeOrgDocument_get_onlyContent(OrgContext* org_context, haxorg_ImmCmdIncludeOrgDocument __this);
HAXORG_C_API_LINKAGE haxorg_OptOfSubtreePath haxorg_ImmCmdIncludeOrgDocument_get_subtreePath(OrgContext* org_context, haxorg_ImmCmdIncludeOrgDocument __this);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_ImmCmdIncludeOrgDocument_get_minLevel(OrgContext* org_context, haxorg_ImmCmdIncludeOrgDocument __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmCmdIncludeOrgDocument_get_customIdTarget(OrgContext* org_context, haxorg_ImmCmdIncludeOrgDocument __this);
...
HAXORG_C_API_LINKAGE haxorg_HstdVecOfAttrValue haxorg_Cmd_getAttrs_const(OrgContext* org_context, haxorg_Cmd __this, haxorg_OptOfStr key);
HAXORG_C_API_LINKAGE haxorg_OptOfAttrValue haxorg_Cmd_getFirstAttr_const(OrgContext* org_context, haxorg_Cmd __this, haxorg_HstdStr kind);
...
HAXORG_C_API_LINKAGE haxorg_OptOfSemIdOfParagraph haxorg_Link_get_description(OrgContext* org_context, haxorg_Link __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_Paragraph_getFootnoteName_const(OrgContext* org_context, haxorg_Paragraph __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfSemIdOfOrg haxorg_InlineFootnote_get_definition(OrgContext* org_context, haxorg_InlineFootnote __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfImmIdTOfImmParagraph haxorg_ImmLink_get_description(OrgContext* org_context, haxorg_ImmLink __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfImmIdTOfImmOrg haxorg_ImmInlineFootnote_get_definition(OrgContext* org_context, haxorg_ImmInlineFootnote __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmAdapterTOfImmSubtree_getTreeId_const(OrgContext* org_context, haxorg_ImmSubtreeAdapter __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmAdapterTOfImmSubtree_getTodo_const(OrgContext* org_context, haxorg_ImmSubtreeAdapter __this);
HAXORG_C_API_LINKAGE haxorg_OptOfSubtreeCompletion haxorg_ImmAdapterTOfImmSubtree_getCompletion_const(OrgContext* org_context, haxorg_ImmSubtreeAdapter __this);
HAXORG_C_API_LINKAGE haxorg_OptOfImmAdapterTOfImmParagraph haxorg_ImmAdapterTOfImmSubtree_getDescription_const(OrgContext* org_context, haxorg_ImmSubtreeAdapter __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfImmAdapterTOfImmTime haxorg_ImmAdapterTOfImmSubtree_getClosed_const(OrgContext* org_context, haxorg_ImmSubtreeAdapter __this);
HAXORG_C_API_LINKAGE haxorg_OptOfImmAdapterTOfImmTime haxorg_ImmAdapterTOfImmSubtree_getDeadline_const(OrgContext* org_context, haxorg_ImmSubtreeAdapter __this);
HAXORG_C_API_LINKAGE haxorg_OptOfImmAdapterTOfImmTime haxorg_ImmAdapterTOfImmSubtree_getScheduled_const(OrgContext* org_context, haxorg_ImmSubtreeAdapter __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmAdapterTOfImmSubtree_getPriority_const(OrgContext* org_context, haxorg_ImmSubtreeAdapter __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfImmAdapterTOfImmStmtList haxorg_ImmAdapterTOfImmSubtreeLog_getDesc_const(OrgContext* org_context, haxorg_ImmSubtreeLogAdapter __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfImmAdapterTOfImmParagraph haxorg_ImmAdapterTOfImmListItem_getHeader_const(OrgContext* org_context, haxorg_ImmListItemAdapter __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmAdapterTOfImmListItem_getBullet_const(OrgContext* org_context, haxorg_ImmListItemAdapter __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_ImmAdapterTOfImmDocumentOptions_getFixedWidthSections_const(OrgContext* org_context, haxorg_ImmDocumentOptionsAdapter __this);
HAXORG_C_API_LINKAGE haxorg_OptOfBool haxorg_ImmAdapterTOfImmDocumentOptions_getStartupIndented_const(OrgContext* org_context, haxorg_ImmDocumentOptionsAdapter __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmAdapterTOfImmDocumentOptions_getCategory_const(OrgContext* org_context, haxorg_ImmDocumentOptionsAdapter __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmAdapterTOfImmDocumentOptions_getSetupfile_const(OrgContext* org_context, haxorg_ImmDocumentOptionsAdapter __this);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_ImmAdapterTOfImmDocumentOptions_getMaxSubtreeLevelExport_const(OrgContext* org_context, haxorg_ImmDocumentOptionsAdapter __this);
HAXORG_C_API_LINKAGE haxorg_OptOfColumnView haxorg_ImmAdapterTOfImmDocumentOptions_getColumns_const(OrgContext* org_context, haxorg_ImmDocumentOptionsAdapter __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfImmAdapterTOfImmParagraph haxorg_ImmAdapterTOfImmDocument_getTitle_const(OrgContext* org_context, haxorg_ImmDocumentAdapter __this);
HAXORG_C_API_LINKAGE haxorg_OptOfImmAdapterTOfImmParagraph haxorg_ImmAdapterTOfImmDocument_getAuthor_const(OrgContext* org_context, haxorg_ImmDocumentAdapter __this);
HAXORG_C_API_LINKAGE haxorg_OptOfImmAdapterTOfImmParagraph haxorg_ImmAdapterTOfImmDocument_getCreator_const(OrgContext* org_context, haxorg_ImmDocumentAdapter __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfImmAdapterTOfImmRawText haxorg_ImmAdapterTOfImmDocument_getEmail_const(OrgContext* org_context, haxorg_ImmDocumentAdapter __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmAdapterTOfImmDocument_getExportFileName_const(OrgContext* org_context, haxorg_ImmDocumentAdapter __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_ImmAdapterTOfImmFileTarget_getLine_const(OrgContext* org_context, haxorg_ImmFileTargetAdapter __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmAdapterTOfImmFileTarget_getSearchTarget_const(OrgContext* org_context, haxorg_ImmFileTargetAdapter __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmAdapterTOfImmFileTarget_getTargetId_const(OrgContext* org_context, haxorg_ImmFileTargetAdapter __this);
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmAdapterTOfImmFileTarget_getRegexp_const(OrgContext* org_context, haxorg_ImmFileTargetAdapter __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_ImmAdapterTOfImmCmdInclude_getFirstLine_const(OrgContext* org_context, haxorg_ImmCmdIncludeAdapter __this);
HAXORG_C_API_LINKAGE haxorg_OptOfInt haxorg_ImmAdapterTOfImmCmdInclude_getLastLine_const(OrgContext* org_context, haxorg_ImmCmdIncludeAdapter __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_BlockExport_getPlacement_const(OrgContext* org_context, haxorg_BlockExport __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_BlockCode_get_lang(OrgContext* org_context, haxorg_BlockCode __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfAttrValue haxorg_BlockCode_getVariable_const(OrgContext* org_context, haxorg_BlockCode __this, haxorg_HstdStr varname);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmBlockCode_get_lang(OrgContext* org_context, haxorg_ImmBlockCode __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfImmAdapterTOfImmParagraph haxorg_ImmAdapterTOfImmLink_getDescription_const(OrgContext* org_context, haxorg_ImmLinkAdapter __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfImmAdapter haxorg_ImmAdapterTOfImmInlineFootnote_getDefinition_const(OrgContext* org_context, haxorg_ImmInlineFootnoteAdapter __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_CmdCall_get_fileName(OrgContext* org_context, haxorg_CmdCall __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmCmdCall_get_fileName(OrgContext* org_context, haxorg_ImmCmdCall __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmAdapterTOfImmBlockCode_getLang_const(OrgContext* org_context, haxorg_ImmBlockCodeAdapter __this);
...
HAXORG_C_API_LINKAGE haxorg_OptOfStr haxorg_ImmAdapterTOfImmCmdCall_getFileName_const(OrgContext* org_context, haxorg_ImmCmdCallAdapter __this);
