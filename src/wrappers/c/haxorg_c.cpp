/* clang-format off */
#include <haxorg/wrappers/c/haxorg_c.h>
#include <haxorg/wrappers/c/haxorg_c_utils.hpp>
haxorg_SemIdOfTime newSemTimeStatic(haxorg_UserTimeBreakdown breakdown, bool isActive, OrgContext* org_context) { return convert_cpp_execution<haxorg_SemIdOfTime, haxorg_UserTimeBreakdown, bool>(&org::newSemTimeStatic, org_context, breakdown, isActive); }
...
haxorg_SemIdOfOrg asOneNode(haxorg_SemIdOfOrg arg, OrgContext* org_context) { return convert_cpp_execution<haxorg_SemIdOfOrg, haxorg_SemIdOfOrg>(&org::asOneNode, org_context, arg); }

haxorg_StdString formatToString(haxorg_SemIdOfOrg arg, OrgContext* org_context) { return convert_cpp_execution<haxorg_StdString, haxorg_SemIdOfOrg>(&org::formatToString, org_context, arg); }

haxorg_StdString exportToYamlString(haxorg_SemIdOfOrg node, haxorg_OrgYamlExportOpts opts, OrgContext* org_context) { return convert_cpp_execution<haxorg_StdString, haxorg_SemIdOfOrg, haxorg_OrgYamlExportOpts>(&org::exportToYamlString, org_context, node, opts); }

void exportToYamlFile(haxorg_SemIdOfOrg node, haxorg_StdString path, haxorg_OrgYamlExportOpts opts, OrgContext* org_context) { return convert_cpp_execution<void, haxorg_SemIdOfOrg, haxorg_StdString, haxorg_OrgYamlExportOpts>(&org::exportToYamlFile, org_context, node, path, opts); }

haxorg_StdString exportToJsonString(haxorg_SemIdOfOrg node, OrgContext* org_context) { return convert_cpp_execution<haxorg_StdString, haxorg_SemIdOfOrg>(&org::exportToJsonString, org_context, node); }

void exportToJsonFile(haxorg_SemIdOfOrg node, haxorg_StdString path, OrgContext* org_context) { return convert_cpp_execution<void, haxorg_SemIdOfOrg, haxorg_StdString>(&org::exportToJsonFile, org_context, node, path); }

haxorg_SemIdOfDocument readProtobufFile(haxorg_StdString file, OrgContext* org_context) { return convert_cpp_execution<haxorg_SemIdOfDocument, haxorg_StdString>(&org::readProtobufFile, org_context, file); }

void exportToProtobufFile(haxorg_SemIdOfDocument doc, haxorg_StdString file, OrgContext* org_context) { return convert_cpp_execution<void, haxorg_SemIdOfDocument, haxorg_StdString>(&org::exportToProtobufFile, org_context, doc, file); }

haxorg_StdString exportToTreeString(haxorg_SemIdOfOrg node, haxorg_OrgTreeExportOpts opts, OrgContext* org_context) { return convert_cpp_execution<haxorg_StdString, haxorg_SemIdOfOrg, haxorg_OrgTreeExportOpts>(&org::exportToTreeString, org_context, node, opts); }

void exportToTreeFile(haxorg_SemIdOfOrg node, haxorg_StdString path, haxorg_OrgTreeExportOpts opts, OrgContext* org_context) { return convert_cpp_execution<void, haxorg_SemIdOfOrg, haxorg_StdString, haxorg_OrgTreeExportOpts>(&org::exportToTreeFile, org_context, node, path, opts); }
...
haxorg_CHstdVec getSubnodeGroups(haxorg_SemIdOfOrg node, haxorg_AstTrackingMap map, OrgContext* org_context) { return convert_cpp_execution<haxorg_CHstdVec, haxorg_SemIdOfOrg, haxorg_AstTrackingMap>(&org::getSubnodeGroups, org_context, node, map); }
...
void eachSubnodeRec(haxorg_SemIdOfOrg node, haxorg_NanobindCallable callback, OrgContext* org_context) { return convert_cpp_execution<void, haxorg_SemIdOfOrg, haxorg_NanobindCallable>(&org::bind::python::eachSubnodeRec, org_context, node, callback); }

void eachSubnodeRecSimplePath(haxorg_SemIdOfOrg node, haxorg_NanobindCallable callback, OrgContext* org_context) { return convert_cpp_execution<void, haxorg_SemIdOfOrg, haxorg_NanobindCallable>(&org::bind::python::eachSubnodeRecSimplePath, org_context, node, callback); }
...
haxorg_SemIdOfOrg evaluateCodeBlocks(haxorg_SemIdOfOrg node, haxorg_PyCodeEvalParameters conf, haxorg_StdShared_ptrOfParseContext parse_context, OrgContext* org_context) { return convert_cpp_execution<haxorg_SemIdOfOrg, haxorg_SemIdOfOrg, haxorg_PyCodeEvalParameters, haxorg_StdShared_ptrOfParseContext>(&org::bind::python::evaluateCodeBlocks, org_context, node, conf, parse_context); }
