...
void haxorg_destroy_ImmSubnodeAccessStep(OrgContext* org_context, haxorg_ImmSubnodeAccessStep* obj) { org::bind::c::execute_destroy<org::imm::ImmSubnodeAccessStep>(org_context, obj); }

haxorg_ImmId haxorg_ImmTreeAccessPath_get_root(OrgContext* org_context, haxorg_ImmTreeAccessPath __this) { return org::bind::c::get_cpp_field<haxorg_ImmId, org::imm::ImmTreeAccessPath, org::imm::ImmId, haxorg_ImmTreeAccessPath>(org_context, __this, &org::imm::ImmTreeAccessPath::root); }

haxorg_ImmTreeAccessPathStore haxorg_ImmTreeAccessPath_get_path(OrgContext* org_context, haxorg_ImmTreeAccessPath __this) { return org::bind::c::get_cpp_field<haxorg_ImmTreeAccessPathStore, org::imm::ImmTreeAccessPath, org::imm::ImmTreeAccessPath::Store, haxorg_ImmTreeAccessPath>(org_context, __this, &org::imm::ImmTreeAccessPath::path); }

bool haxorg_ImmTreeAccessPath_empty_const(OrgContext* org_context, haxorg_ImmTreeAccessPath __this) { return org::bind::c::execute_cpp<bool>(static_cast<bool(org::imm::ImmTreeAccessPath::*)() const>(&org::imm::ImmTreeAccessPath::empty), org_context, __this); }

void haxorg_destroy_ImmTreeAccessPath(OrgContext* org_context, haxorg_ImmTreeAccessPath* obj) { org::bind::c::execute_destroy<org::imm::ImmTreeAccessPath>(org_context, obj); }
...
haxorg_ImmAdapter haxorg_ImmAdapter_atPathStep_const(OrgContext* org_context, haxorg_ImmAdapter __this, haxorg_ImmId id, haxorg_ImmSubnodeAccessStep idx) { return org::bind::c::execute_cpp<haxorg_ImmAdapter>(static_cast<org::imm::ImmAdapter(org::imm::ImmAdapter::*)(org::imm::ImmId, org::imm::ImmSubnodeAccessStep) const>(&org::imm::ImmAdapter::at), org_context, __this, id, idx); }
...
haxorg_StdOptional haxorg_TblfmExprAxisRef_get_row(OrgContext* org_context, haxorg_TblfmExprAxisRef __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Tblfm::Expr::AxisRef, std::optional<org::sem::Tblfm::Expr::AxisRef::Position>, haxorg_TblfmExprAxisRef>(org_context, __this, &org::sem::Tblfm::Expr::AxisRef::row); }
...
haxorg_StdOptional haxorg_TblfmExprRangeRef_get_first(OrgContext* org_context, haxorg_TblfmExprRangeRef __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Tblfm::Expr::RangeRef, std::optional<org::sem::Tblfm::Expr::AxisRef>, haxorg_TblfmExprRangeRef>(org_context, __this, &org::sem::Tblfm::Expr::RangeRef::first); }

haxorg_StdOptional haxorg_TblfmExprRangeRef_get_last(OrgContext* org_context, haxorg_TblfmExprRangeRef __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Tblfm::Expr::RangeRef, std::optional<org::sem::Tblfm::Expr::AxisRef>, haxorg_TblfmExprRangeRef>(org_context, __this, &org::sem::Tblfm::Expr::RangeRef::last); }
...
haxorg_StdOptional haxorg_AttrValue_get_name(OrgContext* org_context, haxorg_AttrValue __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::AttrValue, std::optional<hstd::Str>, haxorg_AttrValue>(org_context, __this, &org::sem::AttrValue::name); }

haxorg_StdOptional haxorg_AttrValue_get_varname(OrgContext* org_context, haxorg_AttrValue __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::AttrValue, std::optional<hstd::Str>, haxorg_AttrValue>(org_context, __this, &org::sem::AttrValue::varname); }
...
haxorg_StdOptional haxorg_AttrValue_getBool_const(OrgContext* org_context, haxorg_AttrValue __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<bool>(org::sem::AttrValue::*)() const>(&org::sem::AttrValue::getBool), org_context, __this); }

haxorg_StdOptional haxorg_AttrValue_getInt_const(OrgContext* org_context, haxorg_AttrValue __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<int>(org::sem::AttrValue::*)() const>(&org::sem::AttrValue::getInt), org_context, __this); }
...
haxorg_StdOptional haxorg_AttrValue_getDouble_const(OrgContext* org_context, haxorg_AttrValue __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<double>(org::sem::AttrValue::*)() const>(&org::sem::AttrValue::getDouble), org_context, __this); }
...
haxorg_StdOptional haxorg_AttrValueDimensionSpan_get_last(OrgContext* org_context, haxorg_AttrValueDimensionSpan __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::AttrValue::DimensionSpan, std::optional<int>, haxorg_AttrValueDimensionSpan>(org_context, __this, &org::sem::AttrValue::DimensionSpan::last); }
...
haxorg_StdOptional haxorg_TodoKeyword_get_shortcut(OrgContext* org_context, haxorg_TodoKeyword __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::TodoKeyword, std::optional<hstd::Str>, haxorg_TodoKeyword>(org_context, __this, &org::sem::TodoKeyword::shortcut); }
...
haxorg_StdOptional haxorg_SubtreeLogHeadPriority_get_oldPriority(OrgContext* org_context, haxorg_SubtreeLogHeadPriority __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::SubtreeLogHead::Priority, std::optional<std::string>, haxorg_SubtreeLogHeadPriority>(org_context, __this, &org::sem::SubtreeLogHead::Priority::oldPriority); }

haxorg_StdOptional haxorg_SubtreeLogHeadPriority_get_newPriority(OrgContext* org_context, haxorg_SubtreeLogHeadPriority __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::SubtreeLogHead::Priority, std::optional<std::string>, haxorg_SubtreeLogHeadPriority>(org_context, __this, &org::sem::SubtreeLogHead::Priority::newPriority); }
...
haxorg_StdOptional haxorg_SubtreeLogHeadClock_get_to(OrgContext* org_context, haxorg_SubtreeLogHeadClock __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::SubtreeLogHead::Clock, std::optional<hstd::UserTime>, haxorg_SubtreeLogHeadClock>(org_context, __this, &org::sem::SubtreeLogHead::Clock::to); }
...
haxorg_StdOptional haxorg_SubtreeLogHeadDeadline_get_from(OrgContext* org_context, haxorg_SubtreeLogHeadDeadline __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::SubtreeLogHead::Deadline, std::optional<hstd::UserTime>, haxorg_SubtreeLogHeadDeadline>(org_context, __this, &org::sem::SubtreeLogHead::Deadline::from); }
...
haxorg_StdOptional haxorg_SubtreeLogHeadSchedule_get_from(OrgContext* org_context, haxorg_SubtreeLogHeadSchedule __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::SubtreeLogHead::Schedule, std::optional<hstd::UserTime>, haxorg_SubtreeLogHeadSchedule>(org_context, __this, &org::sem::SubtreeLogHead::Schedule::from); }
...
haxorg_HstdVecOfAttrValue haxorg_AttrGroup_getAttrs_const(OrgContext* org_context, haxorg_AttrGroup __this, haxorg_StdOptional key) { return org::bind::c::execute_cpp<haxorg_HstdVecOfAttrValue>(static_cast<hstd::Vec<org::sem::AttrValue>(org::sem::AttrGroup::*)(std::optional<hstd::Str> const&) const>(&org::sem::AttrGroup::getAttrs), org_context, __this, key); }
...
haxorg_StdOptional haxorg_AttrGroup_getPositional_const(OrgContext* org_context, haxorg_AttrGroup __this, int index) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::sem::AttrValue>(org::sem::AttrGroup::*)(int) const>(&org::sem::AttrGroup::getPositional), org_context, __this, index); }
...
haxorg_StdOptional haxorg_AttrGroup_getNamed_const(OrgContext* org_context, haxorg_AttrGroup __this, haxorg_HstdStr index) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::sem::AttrList>(org::sem::AttrGroup::*)(hstd::Str const&) const>(&org::sem::AttrGroup::getNamed), org_context, __this, index); }
...
haxorg_StdOptional haxorg_AttrGroup_getFirstNamed_const(OrgContext* org_context, haxorg_AttrGroup __this, haxorg_HstdStr index) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::sem::AttrValue>(org::sem::AttrGroup::*)(hstd::Str const&) const>(&org::sem::AttrGroup::getFirstNamed), org_context, __this, index); }
...
haxorg_StdOptional haxorg_AttrGroup_getVarNamed_const(OrgContext* org_context, haxorg_AttrGroup __this, haxorg_HstdStr index) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::sem::AttrList>(org::sem::AttrGroup::*)(hstd::Str const&) const>(&org::sem::AttrGroup::getVarNamed), org_context, __this, index); }
...
haxorg_StdOptional haxorg_AttrGroup_getFirstVarNamed_const(OrgContext* org_context, haxorg_AttrGroup __this, haxorg_HstdStr index) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::sem::AttrValue>(org::sem::AttrGroup::*)(hstd::Str const&) const>(&org::sem::AttrGroup::getFirstVarNamed), org_context, __this, index); }
...
haxorg_StdOptional haxorg_OrgCodeEvalInput_get_exportType(OrgContext* org_context, haxorg_OrgCodeEvalInput __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::OrgCodeEvalInput, std::optional<hstd::Str>, haxorg_OrgCodeEvalInput>(org_context, __this, &org::sem::OrgCodeEvalInput::exportType); }
...
haxorg_StdOptional haxorg_OrgCodeEvalInput_getVariable_const(OrgContext* org_context, haxorg_OrgCodeEvalInput __this, haxorg_HstdStr name) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::sem::OrgCodeEvalInput::Var>(org::sem::OrgCodeEvalInput::*)(hstd::Str const&) const>(&org::sem::OrgCodeEvalInput::getVariable), org_context, __this, name); }
...
haxorg_StdOptional haxorg_OrgCodeEvalOutput_get_cmd(OrgContext* org_context, haxorg_OrgCodeEvalOutput __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::OrgCodeEvalOutput, std::optional<hstd::Str>, haxorg_OrgCodeEvalOutput>(org_context, __this, &org::sem::OrgCodeEvalOutput::cmd); }
...
haxorg_StdOptional haxorg_ColumnViewSummaryMathAggregate_get_formatDigits(OrgContext* org_context, haxorg_ColumnViewSummaryMathAggregate __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::ColumnView::Summary::MathAggregate, std::optional<int>, haxorg_ColumnViewSummaryMathAggregate>(org_context, __this, &org::sem::ColumnView::Summary::MathAggregate::formatDigits); }

haxorg_StdOptional haxorg_ColumnViewSummaryMathAggregate_get_formatPrecision(OrgContext* org_context, haxorg_ColumnViewSummaryMathAggregate __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::ColumnView::Summary::MathAggregate, std::optional<int>, haxorg_ColumnViewSummaryMathAggregate>(org_context, __this, &org::sem::ColumnView::Summary::MathAggregate::formatPrecision); }
...
haxorg_StdOptional haxorg_ColumnViewColumn_get_summary(OrgContext* org_context, haxorg_ColumnViewColumn __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::ColumnView::Column, std::optional<org::sem::ColumnView::Summary>, haxorg_ColumnViewColumn>(org_context, __this, &org::sem::ColumnView::Column::summary); }

haxorg_StdOptional haxorg_ColumnViewColumn_get_width(OrgContext* org_context, haxorg_ColumnViewColumn __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::ColumnView::Column, std::optional<int>, haxorg_ColumnViewColumn>(org_context, __this, &org::sem::ColumnView::Column::width); }

haxorg_StdOptional haxorg_ColumnViewColumn_get_property(OrgContext* org_context, haxorg_ColumnViewColumn __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::ColumnView::Column, std::optional<hstd::Str>, haxorg_ColumnViewColumn>(org_context, __this, &org::sem::ColumnView::Column::property); }

haxorg_StdOptional haxorg_ColumnViewColumn_get_propertyTitle(OrgContext* org_context, haxorg_ColumnViewColumn __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::ColumnView::Column, std::optional<hstd::Str>, haxorg_ColumnViewColumn>(org_context, __this, &org::sem::ColumnView::Column::propertyTitle); }
...
haxorg_StdOptional haxorg_DocumentExportConfig_get_inlinetasks(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::inlinetasks); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_footnotes(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::footnotes); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_clock(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::clock); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_author(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::author); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_emphasis(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::emphasis); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_specialStrings(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::specialStrings); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_propertyDrawers(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::propertyDrawers); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_statisticsCookies(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::statisticsCookies); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_todoText(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::todoText); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_smartQuotes(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::smartQuotes); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_fixedWidth(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::fixedWidth); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_timestamps(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::timestamps); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_preserveBreaks(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::preserveBreaks); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_subSuperscripts(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::subSuperscripts); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_expandLinks(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::expandLinks); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_creator(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::creator); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_drawers(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::drawers); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_date(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::date); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_entities(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::entities); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_email(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::email); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_sectionNumbers(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::sectionNumbers); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_planning(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::planning); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_priority(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::priority); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_latex(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::latex); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_timestamp(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::timestamp); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_title(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::title); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_tables(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<bool>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::tables); }

haxorg_StdOptional haxorg_DocumentExportConfig_get_headlineLevels(OrgContext* org_context, haxorg_DocumentExportConfig __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentExportConfig, std::optional<int>, haxorg_DocumentExportConfig>(org_context, __this, &org::sem::DocumentExportConfig::headlineLevels); }
...
haxorg_StdOptional haxorg_SubtreePeriod_get_to(OrgContext* org_context, haxorg_SubtreePeriod __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::SubtreePeriod, std::optional<hstd::UserTime>, haxorg_SubtreePeriod>(org_context, __this, &org::sem::SubtreePeriod::to); }
...
bool haxorg_NamedProperty_isMatching_const(OrgContext* org_context, haxorg_NamedProperty __this, haxorg_HstdStr kind, haxorg_StdOptional subKind) { return org::bind::c::execute_cpp<bool>(static_cast<bool(org::sem::NamedProperty::*)(hstd::Str const&, std::optional<hstd::Str> const&) const>(&org::sem::NamedProperty::isMatching), org_context, __this, kind, subKind); }
...
haxorg_StdOptional haxorg_NamedProperty_getSubKind_const(OrgContext* org_context, haxorg_NamedProperty __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str>(org::sem::NamedProperty::*)() const>(&org::sem::NamedProperty::getSubKind), org_context, __this); }
...
haxorg_StdOptional haxorg_NamedPropertyCustomArgs_get_sub(OrgContext* org_context, haxorg_NamedPropertyCustomArgs __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::NamedProperty::CustomArgs, std::optional<hstd::Str>, haxorg_NamedPropertyCustomArgs>(org_context, __this, &org::sem::NamedProperty::CustomArgs::sub); }
...
haxorg_StdOptional haxorg_OrgDiagnosticsParseError_get_loc(OrgContext* org_context, haxorg_OrgDiagnosticsParseError __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::OrgDiagnostics::ParseError, std::optional<org::parse::SourceLoc>, haxorg_OrgDiagnosticsParseError>(org_context, __this, &org::sem::OrgDiagnostics::ParseError::loc); }
...
haxorg_StdOptional haxorg_OrgDiagnosticsConvertError_get_loc(OrgContext* org_context, haxorg_OrgDiagnosticsConvertError __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::OrgDiagnostics::ConvertError, std::optional<org::parse::SourceLoc>, haxorg_OrgDiagnosticsConvertError>(org_context, __this, &org::sem::OrgDiagnostics::ConvertError::loc); }
...
haxorg_StdOptional haxorg_OrgDiagnosticsInternalError_get_loc(OrgContext* org_context, haxorg_OrgDiagnosticsInternalError __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::OrgDiagnostics::InternalError, std::optional<org::parse::SourceLoc>, haxorg_OrgDiagnosticsInternalError>(org_context, __this, &org::sem::OrgDiagnostics::InternalError::loc); }
...
haxorg_HstdVecOfSemIdOfOrg haxorg_Stmt_getAttached_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_StdOptional kind) { return org::bind::c::execute_cpp<haxorg_HstdVecOfSemIdOfOrg>(static_cast<hstd::Vec<org::sem::SemId<org::sem::Org>>(org::sem::Stmt::*)(std::optional<hstd::Str> const&) const>(&org::sem::Stmt::getAttached), org_context, __this, kind); }
...
haxorg_HstdVecOfAttrValue haxorg_Stmt_getAttrs_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_StdOptional kind) { return org::bind::c::execute_cpp<haxorg_HstdVecOfAttrValue>(static_cast<hstd::Vec<org::sem::AttrValue>(org::sem::Stmt::*)(std::optional<hstd::Str> const&) const>(&org::sem::Stmt::getAttrs), org_context, __this, kind); }

haxorg_StdOptional haxorg_Stmt_getFirstAttr_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_HstdStr kind) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::sem::AttrValue>(org::sem::Stmt::*)(hstd::Str const&) const>(&org::sem::Stmt::getFirstAttr), org_context, __this, kind); }

haxorg_StdOptional haxorg_Stmt_getFirstAttrString_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_HstdStr kind) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str>(org::sem::Stmt::*)(hstd::Str const&) const>(&org::sem::Stmt::getFirstAttrString), org_context, __this, kind); }

haxorg_StdOptional haxorg_Stmt_getFirstAttrInt_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_HstdStr kind) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<int>(org::sem::Stmt::*)(hstd::Str const&) const>(&org::sem::Stmt::getFirstAttrInt), org_context, __this, kind); }

haxorg_StdOptional haxorg_Stmt_getFirstAttrBool_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_HstdStr kind) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<bool>(org::sem::Stmt::*)(hstd::Str const&) const>(&org::sem::Stmt::getFirstAttrBool), org_context, __this, kind); }

haxorg_StdOptional haxorg_Stmt_getFirstAttrDouble_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_HstdStr kind) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<double>(org::sem::Stmt::*)(hstd::Str const&) const>(&org::sem::Stmt::getFirstAttrDouble), org_context, __this, kind); }

haxorg_StdOptional haxorg_Stmt_getFirstAttrLisp_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_HstdStr kind) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::sem::AttrValue::LispValue>(org::sem::Stmt::*)(hstd::Str const&) const>(&org::sem::Stmt::getFirstAttrLisp), org_context, __this, kind); }

haxorg_StdOptional haxorg_Stmt_getFirstAttrKind_const(OrgContext* org_context, haxorg_Stmt __this, haxorg_HstdStr kind) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::sem::AttrValue::Kind>(org::sem::Stmt::*)(hstd::Str const&) const>(&org::sem::Stmt::getFirstAttrKind), org_context, __this, kind); }
...
haxorg_StdOptional haxorg_Time_getYear_const(OrgContext* org_context, haxorg_Time __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<int>(org::sem::Time::*)() const>(&org::sem::Time::getYear), org_context, __this); }

haxorg_StdOptional haxorg_Time_getMonth_const(OrgContext* org_context, haxorg_Time __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<int>(org::sem::Time::*)() const>(&org::sem::Time::getMonth), org_context, __this); }

haxorg_StdOptional haxorg_Time_getDay_const(OrgContext* org_context, haxorg_Time __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<int>(org::sem::Time::*)() const>(&org::sem::Time::getDay), org_context, __this); }

haxorg_StdOptional haxorg_Time_getHour_const(OrgContext* org_context, haxorg_Time __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<int>(org::sem::Time::*)() const>(&org::sem::Time::getHour), org_context, __this); }

haxorg_StdOptional haxorg_Time_getMinute_const(OrgContext* org_context, haxorg_Time __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<int>(org::sem::Time::*)() const>(&org::sem::Time::getMinute), org_context, __this); }

haxorg_StdOptional haxorg_Time_getSecond_const(OrgContext* org_context, haxorg_Time __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<int>(org::sem::Time::*)() const>(&org::sem::Time::getSecond), org_context, __this); }
...
haxorg_StdOptional haxorg_TimeStatic_get_warn(OrgContext* org_context, haxorg_TimeStatic __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Time::Static, std::optional<org::sem::Time::Repeat>, haxorg_TimeStatic>(org_context, __this, &org::sem::Time::Static::warn); }
...
haxorg_StdOptional haxorg_TimeRange_getClockedTimeSeconds_const(OrgContext* org_context, haxorg_TimeRange __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<int64_t>(org::sem::TimeRange::*)() const>(&org::sem::TimeRange::getClockedTimeSeconds), org_context, __this); }
...
haxorg_StdOptional haxorg_SymbolParam_get_key(OrgContext* org_context, haxorg_SymbolParam __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Symbol::Param, std::optional<hstd::Str>, haxorg_SymbolParam>(org_context, __this, &org::sem::Symbol::Param::key); }
...
haxorg_StdOptional haxorg_SubtreeLog_get_desc(OrgContext* org_context, haxorg_SubtreeLog __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::SubtreeLog, std::optional<org::sem::SemId<org::sem::StmtList>>, haxorg_SubtreeLog>(org_context, __this, &org::sem::SubtreeLog::desc); }
...
haxorg_StdOptional haxorg_Subtree_get_treeId(OrgContext* org_context, haxorg_Subtree __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Subtree, std::optional<hstd::Str>, haxorg_Subtree>(org_context, __this, &org::sem::Subtree::treeId); }

haxorg_StdOptional haxorg_Subtree_get_todo(OrgContext* org_context, haxorg_Subtree __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Subtree, std::optional<hstd::Str>, haxorg_Subtree>(org_context, __this, &org::sem::Subtree::todo); }

haxorg_StdOptional haxorg_Subtree_get_completion(OrgContext* org_context, haxorg_Subtree __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Subtree, std::optional<org::sem::SubtreeCompletion>, haxorg_Subtree>(org_context, __this, &org::sem::Subtree::completion); }

haxorg_StdOptional haxorg_Subtree_get_description(OrgContext* org_context, haxorg_Subtree __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Subtree, std::optional<org::sem::SemId<org::sem::Paragraph>>, haxorg_Subtree>(org_context, __this, &org::sem::Subtree::description); }
...
haxorg_StdOptional haxorg_Subtree_get_closed(OrgContext* org_context, haxorg_Subtree __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Subtree, std::optional<org::sem::SemId<org::sem::Time>>, haxorg_Subtree>(org_context, __this, &org::sem::Subtree::closed); }

haxorg_StdOptional haxorg_Subtree_get_deadline(OrgContext* org_context, haxorg_Subtree __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Subtree, std::optional<org::sem::SemId<org::sem::Time>>, haxorg_Subtree>(org_context, __this, &org::sem::Subtree::deadline); }

haxorg_StdOptional haxorg_Subtree_get_scheduled(OrgContext* org_context, haxorg_Subtree __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Subtree, std::optional<org::sem::SemId<org::sem::Time>>, haxorg_Subtree>(org_context, __this, &org::sem::Subtree::scheduled); }
...
haxorg_StdOptional haxorg_Subtree_get_priority(OrgContext* org_context, haxorg_Subtree __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Subtree, std::optional<hstd::Str>, haxorg_Subtree>(org_context, __this, &org::sem::Subtree::priority); }
...
haxorg_HstdVecOfNamedProperty haxorg_Subtree_getProperties_const(OrgContext* org_context, haxorg_Subtree __this, haxorg_HstdStr kind, haxorg_StdOptional subkind) { return org::bind::c::execute_cpp<haxorg_HstdVecOfNamedProperty>(static_cast<hstd::Vec<org::sem::NamedProperty>(org::sem::Subtree::*)(hstd::Str const&, std::optional<hstd::Str> const&) const>(&org::sem::Subtree::getProperties), org_context, __this, kind, subkind); }

haxorg_StdOptional haxorg_Subtree_getProperty_const(OrgContext* org_context, haxorg_Subtree __this, haxorg_HstdStr kind, haxorg_StdOptional subkind) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::sem::NamedProperty>(org::sem::Subtree::*)(hstd::Str const&, std::optional<hstd::Str> const&) const>(&org::sem::Subtree::getProperty), org_context, __this, kind, subkind); }

void haxorg_Subtree_removeProperty(OrgContext* org_context, haxorg_Subtree __this, haxorg_HstdStr kind, haxorg_StdOptional subkind) { return org::bind::c::execute_cpp<void>(static_cast<void(org::sem::Subtree::*)(hstd::Str const&, std::optional<hstd::Str> const&)>(&org::sem::Subtree::removeProperty), org_context, __this, kind, subkind); }
...
void haxorg_Subtree_setPropertyStrValue(OrgContext* org_context, haxorg_Subtree __this, haxorg_HstdStr value, haxorg_HstdStr kind, haxorg_StdOptional subkind) { return org::bind::c::execute_cpp<void>(static_cast<void(org::sem::Subtree::*)(hstd::Str const&, hstd::Str const&, std::optional<hstd::Str> const&)>(&org::sem::Subtree::setPropertyStrValue), org_context, __this, value, kind, subkind); }
...
haxorg_StdOptional haxorg_Subtree_getTodoKeyword_const(OrgContext* org_context, haxorg_Subtree __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str>(org::sem::Subtree::*)() const>(&org::sem::Subtree::getTodoKeyword), org_context, __this); }
...
haxorg_StdOptional haxorg_ListItem_get_header(OrgContext* org_context, haxorg_ListItem __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::ListItem, std::optional<org::sem::SemId<org::sem::Paragraph>>, haxorg_ListItem>(org_context, __this, &org::sem::ListItem::header); }

haxorg_StdOptional haxorg_ListItem_get_bullet(OrgContext* org_context, haxorg_ListItem __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::ListItem, std::optional<hstd::Str>, haxorg_ListItem>(org_context, __this, &org::sem::ListItem::bullet); }
...
haxorg_StdOptional haxorg_ListItem_getCleanHeader_const(OrgContext* org_context, haxorg_ListItem __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str>(org::sem::ListItem::*)() const>(&org::sem::ListItem::getCleanHeader), org_context, __this); }
...
haxorg_StdOptional haxorg_DocumentOptions_get_fixedWidthSections(OrgContext* org_context, haxorg_DocumentOptions __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentOptions, std::optional<bool>, haxorg_DocumentOptions>(org_context, __this, &org::sem::DocumentOptions::fixedWidthSections); }
...
haxorg_StdOptional haxorg_DocumentOptions_get_setupfile(OrgContext* org_context, haxorg_DocumentOptions __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentOptions, std::optional<hstd::Str>, haxorg_DocumentOptions>(org_context, __this, &org::sem::DocumentOptions::setupfile); }

haxorg_StdOptional haxorg_DocumentOptions_get_maxSubtreeLevelExport(OrgContext* org_context, haxorg_DocumentOptions __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentOptions, std::optional<int>, haxorg_DocumentOptions>(org_context, __this, &org::sem::DocumentOptions::maxSubtreeLevelExport); }

haxorg_StdOptional haxorg_DocumentOptions_get_columns(OrgContext* org_context, haxorg_DocumentOptions __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::DocumentOptions, std::optional<org::sem::ColumnView>, haxorg_DocumentOptions>(org_context, __this, &org::sem::DocumentOptions::columns); }
...
haxorg_HstdVecOfNamedProperty haxorg_DocumentOptions_getProperties_const(OrgContext* org_context, haxorg_DocumentOptions __this, haxorg_HstdStr kind, haxorg_StdOptional subKind) { return org::bind::c::execute_cpp<haxorg_HstdVecOfNamedProperty>(static_cast<hstd::Vec<org::sem::NamedProperty>(org::sem::DocumentOptions::*)(hstd::Str const&, std::optional<hstd::Str> const&) const>(&org::sem::DocumentOptions::getProperties), org_context, __this, kind, subKind); }

haxorg_StdOptional haxorg_DocumentOptions_getProperty_const(OrgContext* org_context, haxorg_DocumentOptions __this, haxorg_HstdStr kind, haxorg_StdOptional subKind) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::sem::NamedProperty>(org::sem::DocumentOptions::*)(hstd::Str const&, std::optional<hstd::Str> const&) const>(&org::sem::DocumentOptions::getProperty), org_context, __this, kind, subKind); }
...
haxorg_StdOptional haxorg_Document_get_title(OrgContext* org_context, haxorg_Document __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Document, std::optional<org::sem::SemId<org::sem::Paragraph>>, haxorg_Document>(org_context, __this, &org::sem::Document::title); }

haxorg_StdOptional haxorg_Document_get_author(OrgContext* org_context, haxorg_Document __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Document, std::optional<org::sem::SemId<org::sem::Paragraph>>, haxorg_Document>(org_context, __this, &org::sem::Document::author); }

haxorg_StdOptional haxorg_Document_get_creator(OrgContext* org_context, haxorg_Document __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Document, std::optional<org::sem::SemId<org::sem::Paragraph>>, haxorg_Document>(org_context, __this, &org::sem::Document::creator); }
...
haxorg_StdOptional haxorg_Document_get_email(OrgContext* org_context, haxorg_Document __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Document, std::optional<org::sem::SemId<org::sem::RawText>>, haxorg_Document>(org_context, __this, &org::sem::Document::email); }
...
haxorg_StdOptional haxorg_Document_get_exportFileName(OrgContext* org_context, haxorg_Document __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Document, std::optional<hstd::Str>, haxorg_Document>(org_context, __this, &org::sem::Document::exportFileName); }

haxorg_HstdVecOfNamedProperty haxorg_Document_getProperties_const(OrgContext* org_context, haxorg_Document __this, haxorg_HstdStr kind, haxorg_StdOptional subKind) { return org::bind::c::execute_cpp<haxorg_HstdVecOfNamedProperty>(static_cast<hstd::Vec<org::sem::NamedProperty>(org::sem::Document::*)(hstd::Str const&, std::optional<hstd::Str> const&) const>(&org::sem::Document::getProperties), org_context, __this, kind, subKind); }

haxorg_StdOptional haxorg_Document_getProperty_const(OrgContext* org_context, haxorg_Document __this, haxorg_HstdStr kind, haxorg_StdOptional subKind) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::sem::NamedProperty>(org::sem::Document::*)(hstd::Str const&, std::optional<hstd::Str> const&) const>(&org::sem::Document::getProperty), org_context, __this, kind, subKind); }
...
haxorg_StdOptional haxorg_FileTarget_get_line(OrgContext* org_context, haxorg_FileTarget __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::FileTarget, std::optional<int>, haxorg_FileTarget>(org_context, __this, &org::sem::FileTarget::line); }

haxorg_StdOptional haxorg_FileTarget_get_searchTarget(OrgContext* org_context, haxorg_FileTarget __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::FileTarget, std::optional<hstd::Str>, haxorg_FileTarget>(org_context, __this, &org::sem::FileTarget::searchTarget); }
...
haxorg_StdOptional haxorg_FileTarget_get_targetId(OrgContext* org_context, haxorg_FileTarget __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::FileTarget, std::optional<hstd::Str>, haxorg_FileTarget>(org_context, __this, &org::sem::FileTarget::targetId); }

haxorg_StdOptional haxorg_FileTarget_get_regexp(OrgContext* org_context, haxorg_FileTarget __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::FileTarget, std::optional<hstd::Str>, haxorg_FileTarget>(org_context, __this, &org::sem::FileTarget::regexp); }
...
haxorg_StdOptional haxorg_CmdInclude_get_firstLine(OrgContext* org_context, haxorg_CmdInclude __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::CmdInclude, std::optional<int>, haxorg_CmdInclude>(org_context, __this, &org::sem::CmdInclude::firstLine); }

haxorg_StdOptional haxorg_CmdInclude_get_lastLine(OrgContext* org_context, haxorg_CmdInclude __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::CmdInclude, std::optional<int>, haxorg_CmdInclude>(org_context, __this, &org::sem::CmdInclude::lastLine); }
...
haxorg_StdOptional haxorg_CmdIncludeOrgDocument_get_onlyContent(OrgContext* org_context, haxorg_CmdIncludeOrgDocument __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::CmdInclude::OrgDocument, std::optional<bool>, haxorg_CmdIncludeOrgDocument>(org_context, __this, &org::sem::CmdInclude::OrgDocument::onlyContent); }

haxorg_StdOptional haxorg_CmdIncludeOrgDocument_get_subtreePath(OrgContext* org_context, haxorg_CmdIncludeOrgDocument __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::CmdInclude::OrgDocument, std::optional<org::sem::SubtreePath>, haxorg_CmdIncludeOrgDocument>(org_context, __this, &org::sem::CmdInclude::OrgDocument::subtreePath); }

haxorg_StdOptional haxorg_CmdIncludeOrgDocument_get_minLevel(OrgContext* org_context, haxorg_CmdIncludeOrgDocument __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::CmdInclude::OrgDocument, std::optional<int>, haxorg_CmdIncludeOrgDocument>(org_context, __this, &org::sem::CmdInclude::OrgDocument::minLevel); }

haxorg_StdOptional haxorg_CmdIncludeOrgDocument_get_customIdTarget(OrgContext* org_context, haxorg_CmdIncludeOrgDocument __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::CmdInclude::OrgDocument, std::optional<hstd::Str>, haxorg_CmdIncludeOrgDocument>(org_context, __this, &org::sem::CmdInclude::OrgDocument::customIdTarget); }
...
void haxorg_destroy_ReportSourceStrCache(OrgContext* org_context, haxorg_ReportSourceStrCache* obj) { org::bind::c::execute_destroy<hstd::ext::ReportSourceStrCache>(org_context, obj); }
...
haxorg_StdOptional haxorg_ImmTimeStatic_get_warn(OrgContext* org_context, haxorg_ImmTimeStatic __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmTime::Static, hstd::ext::ImmBox<std::optional<org::imm::ImmTime::Repeat>>, haxorg_ImmTimeStatic>(org_context, __this, &org::imm::ImmTime::Static::warn); }
...
haxorg_StdOptional haxorg_ImmSymbolParam_get_key(OrgContext* org_context, haxorg_ImmSymbolParam __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmSymbol::Param, hstd::ext::ImmBox<std::optional<hstd::Str>>, haxorg_ImmSymbolParam>(org_context, __this, &org::imm::ImmSymbol::Param::key); }
...
haxorg_StdOptional haxorg_ImmSubtreeLog_get_desc(OrgContext* org_context, haxorg_ImmSubtreeLog __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmSubtreeLog, hstd::ext::ImmBox<std::optional<org::imm::ImmIdT<org::imm::ImmStmtList>>>, haxorg_ImmSubtreeLog>(org_context, __this, &org::imm::ImmSubtreeLog::desc); }
...
haxorg_StdOptional haxorg_ImmSubtree_get_treeId(OrgContext* org_context, haxorg_ImmSubtree __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmSubtree, hstd::ext::ImmBox<std::optional<hstd::Str>>, haxorg_ImmSubtree>(org_context, __this, &org::imm::ImmSubtree::treeId); }

haxorg_StdOptional haxorg_ImmSubtree_get_todo(OrgContext* org_context, haxorg_ImmSubtree __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmSubtree, hstd::ext::ImmBox<std::optional<hstd::Str>>, haxorg_ImmSubtree>(org_context, __this, &org::imm::ImmSubtree::todo); }

haxorg_StdOptional haxorg_ImmSubtree_get_completion(OrgContext* org_context, haxorg_ImmSubtree __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmSubtree, hstd::ext::ImmBox<std::optional<org::sem::SubtreeCompletion>>, haxorg_ImmSubtree>(org_context, __this, &org::imm::ImmSubtree::completion); }

haxorg_StdOptional haxorg_ImmSubtree_get_description(OrgContext* org_context, haxorg_ImmSubtree __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmSubtree, hstd::ext::ImmBox<std::optional<org::imm::ImmIdT<org::imm::ImmParagraph>>>, haxorg_ImmSubtree>(org_context, __this, &org::imm::ImmSubtree::description); }
...
haxorg_StdOptional haxorg_ImmSubtree_get_closed(OrgContext* org_context, haxorg_ImmSubtree __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmSubtree, hstd::ext::ImmBox<std::optional<org::imm::ImmIdT<org::imm::ImmTime>>>, haxorg_ImmSubtree>(org_context, __this, &org::imm::ImmSubtree::closed); }

haxorg_StdOptional haxorg_ImmSubtree_get_deadline(OrgContext* org_context, haxorg_ImmSubtree __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmSubtree, hstd::ext::ImmBox<std::optional<org::imm::ImmIdT<org::imm::ImmTime>>>, haxorg_ImmSubtree>(org_context, __this, &org::imm::ImmSubtree::deadline); }

haxorg_StdOptional haxorg_ImmSubtree_get_scheduled(OrgContext* org_context, haxorg_ImmSubtree __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmSubtree, hstd::ext::ImmBox<std::optional<org::imm::ImmIdT<org::imm::ImmTime>>>, haxorg_ImmSubtree>(org_context, __this, &org::imm::ImmSubtree::scheduled); }
...
haxorg_StdOptional haxorg_ImmSubtree_get_priority(OrgContext* org_context, haxorg_ImmSubtree __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmSubtree, hstd::ext::ImmBox<std::optional<hstd::Str>>, haxorg_ImmSubtree>(org_context, __this, &org::imm::ImmSubtree::priority); }
...
haxorg_StdOptional haxorg_ImmListItem_get_header(OrgContext* org_context, haxorg_ImmListItem __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmListItem, hstd::ext::ImmBox<std::optional<org::imm::ImmIdT<org::imm::ImmParagraph>>>, haxorg_ImmListItem>(org_context, __this, &org::imm::ImmListItem::header); }

haxorg_StdOptional haxorg_ImmListItem_get_bullet(OrgContext* org_context, haxorg_ImmListItem __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmListItem, hstd::ext::ImmBox<std::optional<hstd::Str>>, haxorg_ImmListItem>(org_context, __this, &org::imm::ImmListItem::bullet); }
...
haxorg_StdOptional haxorg_ImmDocumentOptions_get_category(OrgContext* org_context, haxorg_ImmDocumentOptions __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmDocumentOptions, hstd::ext::ImmBox<std::optional<hstd::Str>>, haxorg_ImmDocumentOptions>(org_context, __this, &org::imm::ImmDocumentOptions::category); }

haxorg_StdOptional haxorg_ImmDocumentOptions_get_setupfile(OrgContext* org_context, haxorg_ImmDocumentOptions __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmDocumentOptions, hstd::ext::ImmBox<std::optional<hstd::Str>>, haxorg_ImmDocumentOptions>(org_context, __this, &org::imm::ImmDocumentOptions::setupfile); }

haxorg_StdOptional haxorg_ImmDocumentOptions_get_maxSubtreeLevelExport(OrgContext* org_context, haxorg_ImmDocumentOptions __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmDocumentOptions, hstd::ext::ImmBox<std::optional<int>>, haxorg_ImmDocumentOptions>(org_context, __this, &org::imm::ImmDocumentOptions::maxSubtreeLevelExport); }

haxorg_StdOptional haxorg_ImmDocumentOptions_get_columns(OrgContext* org_context, haxorg_ImmDocumentOptions __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmDocumentOptions, hstd::ext::ImmBox<std::optional<org::sem::ColumnView>>, haxorg_ImmDocumentOptions>(org_context, __this, &org::imm::ImmDocumentOptions::columns); }
...
haxorg_StdOptional haxorg_ImmDocument_get_title(OrgContext* org_context, haxorg_ImmDocument __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmDocument, hstd::ext::ImmBox<std::optional<org::imm::ImmIdT<org::imm::ImmParagraph>>>, haxorg_ImmDocument>(org_context, __this, &org::imm::ImmDocument::title); }

haxorg_StdOptional haxorg_ImmDocument_get_author(OrgContext* org_context, haxorg_ImmDocument __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmDocument, hstd::ext::ImmBox<std::optional<org::imm::ImmIdT<org::imm::ImmParagraph>>>, haxorg_ImmDocument>(org_context, __this, &org::imm::ImmDocument::author); }

haxorg_StdOptional haxorg_ImmDocument_get_creator(OrgContext* org_context, haxorg_ImmDocument __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmDocument, hstd::ext::ImmBox<std::optional<org::imm::ImmIdT<org::imm::ImmParagraph>>>, haxorg_ImmDocument>(org_context, __this, &org::imm::ImmDocument::creator); }
...
haxorg_StdOptional haxorg_ImmDocument_get_email(OrgContext* org_context, haxorg_ImmDocument __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmDocument, hstd::ext::ImmBox<std::optional<org::imm::ImmIdT<org::imm::ImmRawText>>>, haxorg_ImmDocument>(org_context, __this, &org::imm::ImmDocument::email); }
...
haxorg_StdOptional haxorg_ImmDocument_get_exportFileName(OrgContext* org_context, haxorg_ImmDocument __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmDocument, hstd::ext::ImmBox<std::optional<hstd::Str>>, haxorg_ImmDocument>(org_context, __this, &org::imm::ImmDocument::exportFileName); }
...
haxorg_StdOptional haxorg_ImmFileTarget_get_line(OrgContext* org_context, haxorg_ImmFileTarget __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmFileTarget, hstd::ext::ImmBox<std::optional<int>>, haxorg_ImmFileTarget>(org_context, __this, &org::imm::ImmFileTarget::line); }

haxorg_StdOptional haxorg_ImmFileTarget_get_searchTarget(OrgContext* org_context, haxorg_ImmFileTarget __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmFileTarget, hstd::ext::ImmBox<std::optional<hstd::Str>>, haxorg_ImmFileTarget>(org_context, __this, &org::imm::ImmFileTarget::searchTarget); }
...
haxorg_StdOptional haxorg_ImmFileTarget_get_targetId(OrgContext* org_context, haxorg_ImmFileTarget __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmFileTarget, hstd::ext::ImmBox<std::optional<hstd::Str>>, haxorg_ImmFileTarget>(org_context, __this, &org::imm::ImmFileTarget::targetId); }

haxorg_StdOptional haxorg_ImmFileTarget_get_regexp(OrgContext* org_context, haxorg_ImmFileTarget __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmFileTarget, hstd::ext::ImmBox<std::optional<hstd::Str>>, haxorg_ImmFileTarget>(org_context, __this, &org::imm::ImmFileTarget::regexp); }
...
haxorg_StdOptional haxorg_ImmCmdInclude_get_firstLine(OrgContext* org_context, haxorg_ImmCmdInclude __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmCmdInclude, hstd::ext::ImmBox<std::optional<int>>, haxorg_ImmCmdInclude>(org_context, __this, &org::imm::ImmCmdInclude::firstLine); }

haxorg_StdOptional haxorg_ImmCmdInclude_get_lastLine(OrgContext* org_context, haxorg_ImmCmdInclude __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmCmdInclude, hstd::ext::ImmBox<std::optional<int>>, haxorg_ImmCmdInclude>(org_context, __this, &org::imm::ImmCmdInclude::lastLine); }
...
haxorg_StdOptional haxorg_ImmCmdIncludeOrgDocument_get_onlyContent(OrgContext* org_context, haxorg_ImmCmdIncludeOrgDocument __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmCmdInclude::OrgDocument, hstd::ext::ImmBox<std::optional<bool>>, haxorg_ImmCmdIncludeOrgDocument>(org_context, __this, &org::imm::ImmCmdInclude::OrgDocument::onlyContent); }

haxorg_StdOptional haxorg_ImmCmdIncludeOrgDocument_get_subtreePath(OrgContext* org_context, haxorg_ImmCmdIncludeOrgDocument __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmCmdInclude::OrgDocument, hstd::ext::ImmBox<std::optional<org::sem::SubtreePath>>, haxorg_ImmCmdIncludeOrgDocument>(org_context, __this, &org::imm::ImmCmdInclude::OrgDocument::subtreePath); }

haxorg_StdOptional haxorg_ImmCmdIncludeOrgDocument_get_minLevel(OrgContext* org_context, haxorg_ImmCmdIncludeOrgDocument __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmCmdInclude::OrgDocument, hstd::ext::ImmBox<std::optional<int>>, haxorg_ImmCmdIncludeOrgDocument>(org_context, __this, &org::imm::ImmCmdInclude::OrgDocument::minLevel); }

haxorg_StdOptional haxorg_ImmCmdIncludeOrgDocument_get_customIdTarget(OrgContext* org_context, haxorg_ImmCmdIncludeOrgDocument __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmCmdInclude::OrgDocument, hstd::ext::ImmBox<std::optional<hstd::Str>>, haxorg_ImmCmdIncludeOrgDocument>(org_context, __this, &org::imm::ImmCmdInclude::OrgDocument::customIdTarget); }
...
haxorg_HstdVecOfAttrValue haxorg_Cmd_getAttrs_const(OrgContext* org_context, haxorg_Cmd __this, haxorg_StdOptional key) { return org::bind::c::execute_cpp<haxorg_HstdVecOfAttrValue>(static_cast<hstd::Vec<org::sem::AttrValue>(org::sem::Cmd::*)(std::optional<hstd::Str> const&) const>(&org::sem::Cmd::getAttrs), org_context, __this, key); }

haxorg_StdOptional haxorg_Cmd_getFirstAttr_const(OrgContext* org_context, haxorg_Cmd __this, haxorg_HstdStr kind) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::sem::AttrValue>(org::sem::Cmd::*)(hstd::Str const&) const>(&org::sem::Cmd::getFirstAttr), org_context, __this, kind); }
...
haxorg_StdOptional haxorg_Link_get_description(OrgContext* org_context, haxorg_Link __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::Link, std::optional<org::sem::SemId<org::sem::Paragraph>>, haxorg_Link>(org_context, __this, &org::sem::Link::description); }
...
haxorg_StdOptional haxorg_Paragraph_getFootnoteName_const(OrgContext* org_context, haxorg_Paragraph __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str>(org::sem::Paragraph::*)() const>(&org::sem::Paragraph::getFootnoteName), org_context, __this); }
...
haxorg_StdOptional haxorg_InlineFootnote_get_definition(OrgContext* org_context, haxorg_InlineFootnote __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::InlineFootnote, std::optional<org::sem::SemId<org::sem::Org>>, haxorg_InlineFootnote>(org_context, __this, &org::sem::InlineFootnote::definition); }
...
haxorg_StdOptional haxorg_ImmLink_get_description(OrgContext* org_context, haxorg_ImmLink __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmLink, hstd::ext::ImmBox<std::optional<org::imm::ImmIdT<org::imm::ImmParagraph>>>, haxorg_ImmLink>(org_context, __this, &org::imm::ImmLink::description); }
...
haxorg_StdOptional haxorg_ImmInlineFootnote_get_definition(OrgContext* org_context, haxorg_ImmInlineFootnote __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmInlineFootnote, hstd::ext::ImmBox<std::optional<org::imm::ImmIdT<org::imm::ImmOrg>>>, haxorg_ImmInlineFootnote>(org_context, __this, &org::imm::ImmInlineFootnote::definition); }
...
haxorg_StdOptional haxorg_ImmAdapterTOfImmSubtree_getTreeId_const(OrgContext* org_context, haxorg_ImmSubtreeAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str> const&(org::imm::ImmAdapterT<org::imm::ImmSubtree>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmSubtree>::getTreeId), org_context, __this); }

haxorg_StdOptional haxorg_ImmAdapterTOfImmSubtree_getTodo_const(OrgContext* org_context, haxorg_ImmSubtreeAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str> const&(org::imm::ImmAdapterT<org::imm::ImmSubtree>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmSubtree>::getTodo), org_context, __this); }

haxorg_StdOptional haxorg_ImmAdapterTOfImmSubtree_getCompletion_const(OrgContext* org_context, haxorg_ImmSubtreeAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::sem::SubtreeCompletion> const&(org::imm::ImmAdapterT<org::imm::ImmSubtree>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmSubtree>::getCompletion), org_context, __this); }

haxorg_StdOptional haxorg_ImmAdapterTOfImmSubtree_getDescription_const(OrgContext* org_context, haxorg_ImmSubtreeAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::imm::ImmAdapterT<org::imm::ImmParagraph>>(org::imm::ImmAdapterT<org::imm::ImmSubtree>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmSubtree>::getDescription), org_context, __this); }
...
haxorg_StdOptional haxorg_ImmAdapterTOfImmSubtree_getClosed_const(OrgContext* org_context, haxorg_ImmSubtreeAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::imm::ImmAdapterT<org::imm::ImmTime>>(org::imm::ImmAdapterT<org::imm::ImmSubtree>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmSubtree>::getClosed), org_context, __this); }

haxorg_StdOptional haxorg_ImmAdapterTOfImmSubtree_getDeadline_const(OrgContext* org_context, haxorg_ImmSubtreeAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::imm::ImmAdapterT<org::imm::ImmTime>>(org::imm::ImmAdapterT<org::imm::ImmSubtree>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmSubtree>::getDeadline), org_context, __this); }

haxorg_StdOptional haxorg_ImmAdapterTOfImmSubtree_getScheduled_const(OrgContext* org_context, haxorg_ImmSubtreeAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::imm::ImmAdapterT<org::imm::ImmTime>>(org::imm::ImmAdapterT<org::imm::ImmSubtree>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmSubtree>::getScheduled), org_context, __this); }
...
haxorg_StdOptional haxorg_ImmAdapterTOfImmSubtree_getPriority_const(OrgContext* org_context, haxorg_ImmSubtreeAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str> const&(org::imm::ImmAdapterT<org::imm::ImmSubtree>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmSubtree>::getPriority), org_context, __this); }
...
haxorg_StdOptional haxorg_ImmAdapterTOfImmSubtreeLog_getDesc_const(OrgContext* org_context, haxorg_ImmSubtreeLogAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::imm::ImmAdapterT<org::imm::ImmStmtList>>(org::imm::ImmAdapterT<org::imm::ImmSubtreeLog>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmSubtreeLog>::getDesc), org_context, __this); }
...
haxorg_StdOptional haxorg_ImmAdapterTOfImmListItem_getHeader_const(OrgContext* org_context, haxorg_ImmListItemAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::imm::ImmAdapterT<org::imm::ImmParagraph>>(org::imm::ImmAdapterT<org::imm::ImmListItem>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmListItem>::getHeader), org_context, __this); }

haxorg_StdOptional haxorg_ImmAdapterTOfImmListItem_getBullet_const(OrgContext* org_context, haxorg_ImmListItemAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str> const&(org::imm::ImmAdapterT<org::imm::ImmListItem>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmListItem>::getBullet), org_context, __this); }
...
haxorg_StdOptional haxorg_ImmAdapterTOfImmDocumentOptions_getCategory_const(OrgContext* org_context, haxorg_ImmDocumentOptionsAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str> const&(org::imm::ImmAdapterT<org::imm::ImmDocumentOptions>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmDocumentOptions>::getCategory), org_context, __this); }

haxorg_StdOptional haxorg_ImmAdapterTOfImmDocumentOptions_getSetupfile_const(OrgContext* org_context, haxorg_ImmDocumentOptionsAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str> const&(org::imm::ImmAdapterT<org::imm::ImmDocumentOptions>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmDocumentOptions>::getSetupfile), org_context, __this); }

haxorg_StdOptional haxorg_ImmAdapterTOfImmDocumentOptions_getMaxSubtreeLevelExport_const(OrgContext* org_context, haxorg_ImmDocumentOptionsAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<int> const&(org::imm::ImmAdapterT<org::imm::ImmDocumentOptions>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmDocumentOptions>::getMaxSubtreeLevelExport), org_context, __this); }

haxorg_StdOptional haxorg_ImmAdapterTOfImmDocumentOptions_getColumns_const(OrgContext* org_context, haxorg_ImmDocumentOptionsAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::sem::ColumnView> const&(org::imm::ImmAdapterT<org::imm::ImmDocumentOptions>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmDocumentOptions>::getColumns), org_context, __this); }
...
haxorg_StdOptional haxorg_ImmAdapterTOfImmDocument_getTitle_const(OrgContext* org_context, haxorg_ImmDocumentAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::imm::ImmAdapterT<org::imm::ImmParagraph>>(org::imm::ImmAdapterT<org::imm::ImmDocument>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmDocument>::getTitle), org_context, __this); }

haxorg_StdOptional haxorg_ImmAdapterTOfImmDocument_getAuthor_const(OrgContext* org_context, haxorg_ImmDocumentAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::imm::ImmAdapterT<org::imm::ImmParagraph>>(org::imm::ImmAdapterT<org::imm::ImmDocument>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmDocument>::getAuthor), org_context, __this); }

haxorg_StdOptional haxorg_ImmAdapterTOfImmDocument_getCreator_const(OrgContext* org_context, haxorg_ImmDocumentAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::imm::ImmAdapterT<org::imm::ImmParagraph>>(org::imm::ImmAdapterT<org::imm::ImmDocument>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmDocument>::getCreator), org_context, __this); }
...
haxorg_StdOptional haxorg_ImmAdapterTOfImmDocument_getEmail_const(OrgContext* org_context, haxorg_ImmDocumentAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::imm::ImmAdapterT<org::imm::ImmRawText>>(org::imm::ImmAdapterT<org::imm::ImmDocument>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmDocument>::getEmail), org_context, __this); }
...
haxorg_StdOptional haxorg_ImmAdapterTOfImmDocument_getExportFileName_const(OrgContext* org_context, haxorg_ImmDocumentAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str> const&(org::imm::ImmAdapterT<org::imm::ImmDocument>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmDocument>::getExportFileName), org_context, __this); }
...
haxorg_StdOptional haxorg_ImmAdapterTOfImmFileTarget_getLine_const(OrgContext* org_context, haxorg_ImmFileTargetAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<int> const&(org::imm::ImmAdapterT<org::imm::ImmFileTarget>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmFileTarget>::getLine), org_context, __this); }

haxorg_StdOptional haxorg_ImmAdapterTOfImmFileTarget_getSearchTarget_const(OrgContext* org_context, haxorg_ImmFileTargetAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str> const&(org::imm::ImmAdapterT<org::imm::ImmFileTarget>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmFileTarget>::getSearchTarget), org_context, __this); }
...
haxorg_StdOptional haxorg_ImmAdapterTOfImmFileTarget_getTargetId_const(OrgContext* org_context, haxorg_ImmFileTargetAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str> const&(org::imm::ImmAdapterT<org::imm::ImmFileTarget>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmFileTarget>::getTargetId), org_context, __this); }

haxorg_StdOptional haxorg_ImmAdapterTOfImmFileTarget_getRegexp_const(OrgContext* org_context, haxorg_ImmFileTargetAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str> const&(org::imm::ImmAdapterT<org::imm::ImmFileTarget>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmFileTarget>::getRegexp), org_context, __this); }
...
haxorg_StdOptional haxorg_ImmAdapterTOfImmCmdInclude_getFirstLine_const(OrgContext* org_context, haxorg_ImmCmdIncludeAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<int> const&(org::imm::ImmAdapterT<org::imm::ImmCmdInclude>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmCmdInclude>::getFirstLine), org_context, __this); }

haxorg_StdOptional haxorg_ImmAdapterTOfImmCmdInclude_getLastLine_const(OrgContext* org_context, haxorg_ImmCmdIncludeAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<int> const&(org::imm::ImmAdapterT<org::imm::ImmCmdInclude>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmCmdInclude>::getLastLine), org_context, __this); }
...
haxorg_StdOptional haxorg_BlockExport_getPlacement_const(OrgContext* org_context, haxorg_BlockExport __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str>(org::sem::BlockExport::*)() const>(&org::sem::BlockExport::getPlacement), org_context, __this); }
...
haxorg_StdOptional haxorg_BlockCode_get_lang(OrgContext* org_context, haxorg_BlockCode __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::BlockCode, std::optional<hstd::Str>, haxorg_BlockCode>(org_context, __this, &org::sem::BlockCode::lang); }
...
haxorg_StdOptional haxorg_BlockCode_getVariable_const(OrgContext* org_context, haxorg_BlockCode __this, haxorg_HstdStr varname) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::sem::AttrValue>(org::sem::BlockCode::*)(hstd::Str const&) const>(&org::sem::BlockCode::getVariable), org_context, __this, varname); }
...
haxorg_StdOptional haxorg_ImmBlockCode_get_lang(OrgContext* org_context, haxorg_ImmBlockCode __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmBlockCode, hstd::ext::ImmBox<std::optional<hstd::Str>>, haxorg_ImmBlockCode>(org_context, __this, &org::imm::ImmBlockCode::lang); }
...
haxorg_StdOptional haxorg_ImmAdapterTOfImmLink_getDescription_const(OrgContext* org_context, haxorg_ImmLinkAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::imm::ImmAdapterT<org::imm::ImmParagraph>>(org::imm::ImmAdapterT<org::imm::ImmLink>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmLink>::getDescription), org_context, __this); }
...
haxorg_StdOptional haxorg_ImmAdapterTOfImmInlineFootnote_getDefinition_const(OrgContext* org_context, haxorg_ImmInlineFootnoteAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<org::imm::ImmAdapter>(org::imm::ImmAdapterT<org::imm::ImmInlineFootnote>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmInlineFootnote>::getDefinition), org_context, __this); }
...
haxorg_StdOptional haxorg_CmdCall_get_fileName(OrgContext* org_context, haxorg_CmdCall __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::sem::CmdCall, std::optional<hstd::Str>, haxorg_CmdCall>(org_context, __this, &org::sem::CmdCall::fileName); }
...
haxorg_StdOptional haxorg_ImmCmdCall_get_fileName(OrgContext* org_context, haxorg_ImmCmdCall __this) { return org::bind::c::get_cpp_field<haxorg_StdOptional, org::imm::ImmCmdCall, hstd::ext::ImmBox<std::optional<hstd::Str>>, haxorg_ImmCmdCall>(org_context, __this, &org::imm::ImmCmdCall::fileName); }
...
haxorg_StdOptional haxorg_ImmAdapterTOfImmBlockCode_getLang_const(OrgContext* org_context, haxorg_ImmBlockCodeAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str> const&(org::imm::ImmAdapterT<org::imm::ImmBlockCode>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmBlockCode>::getLang), org_context, __this); }
...
haxorg_StdOptional haxorg_ImmAdapterTOfImmCmdCall_getFileName_const(OrgContext* org_context, haxorg_ImmCmdCallAdapter __this) { return org::bind::c::execute_cpp<haxorg_StdOptional>(static_cast<std::optional<hstd::Str> const&(org::imm::ImmAdapterT<org::imm::ImmCmdCall>::*)() const>(&org::imm::ImmAdapterT<org::imm::ImmCmdCall>::getFileName), org_context, __this); }
