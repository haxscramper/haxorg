...
haxorg_SemId newSemTimeStatic(haxorg_UserTimeBreakdown breakdown, bool isActive, OrgContext* org_context) { return org::bind::c::execute_cpp<haxorg_SemId, org::sem::SemId<org::sem::Time>(*)(hstd::UserTimeBreakdown const&, bool), haxorg_UserTimeBreakdown, bool>(&org::newSemTimeStatic, org_context, breakdown, isActive); }

haxorg_ImmAstContext initImmutableAstContext(OrgContext* org_context) { return org::bind::c::execute_cpp<haxorg_ImmAstContext, std::shared_ptr<org::imm::ImmAstContext>(*)()>(&org::initImmutableAstContext, org_context); }

haxorg_SemId asOneNode(haxorg_SemId arg, OrgContext* org_context) { return org::bind::c::execute_cpp<haxorg_SemId, org::sem::SemId<org::sem::Org>(*)(org::sem::SemId<org::sem::Org> const&), haxorg_SemId>(&org::asOneNode, org_context, arg); }

haxorg_StdString formatToString(haxorg_SemId arg, OrgContext* org_context) { return org::bind::c::execute_cpp<haxorg_StdString, std::string(*)(org::sem::SemId<org::sem::Org>), haxorg_SemId>(&org::formatToString, org_context, arg); }
...
void exportToYamlFile(haxorg_SemId node, haxorg_StdString path, haxorg_OrgYamlExportOpts opts, OrgContext* org_context) { return org::bind::c::execute_cpp<void, void(*)(org::sem::SemId<org::sem::Org> const&, std::string, org::OrgYamlExportOpts const&), haxorg_SemId, haxorg_StdString, haxorg_OrgYamlExportOpts>(&org::exportToYamlFile, org_context, node, path, opts); }

haxorg_StdString exportToJsonString(haxorg_SemId node, OrgContext* org_context) { return org::bind::c::execute_cpp<haxorg_StdString, std::string(*)(org::sem::SemId<org::sem::Org> const&), haxorg_SemId>(&org::exportToJsonString, org_context, node); }

void exportToJsonFile(haxorg_SemId node, haxorg_StdString path, OrgContext* org_context) { return org::bind::c::execute_cpp<void, void(*)(org::sem::SemId<org::sem::Org> const&, std::string), haxorg_SemId, haxorg_StdString>(&org::exportToJsonFile, org_context, node, path); }

haxorg_SemId readProtobufFile(haxorg_StdString file, OrgContext* org_context) { return org::bind::c::execute_cpp<haxorg_SemId, org::sem::SemId<org::sem::Document>(*)(std::string const&), haxorg_StdString>(&org::readProtobufFile, org_context, file); }

void exportToProtobufFile(haxorg_SemId doc, haxorg_StdString file, OrgContext* org_context) { return org::bind::c::execute_cpp<void, void(*)(org::sem::SemId<org::sem::Document>, std::string const&), haxorg_SemId, haxorg_StdString>(&org::exportToProtobufFile, org_context, doc, file); }

haxorg_StdString exportToTreeString(haxorg_SemId node, haxorg_OrgTreeExportOpts opts, OrgContext* org_context) { return org::bind::c::execute_cpp<haxorg_StdString, std::string(*)(org::sem::SemId<org::sem::Org> const&, org::OrgTreeExportOpts const&), haxorg_SemId, haxorg_OrgTreeExportOpts>(&org::exportToTreeString, org_context, node, opts); }

void exportToTreeFile(haxorg_SemId node, haxorg_StdString path, haxorg_OrgTreeExportOpts opts, OrgContext* org_context) { return org::bind::c::execute_cpp<void, void(*)(org::sem::SemId<org::sem::Org> const&, std::string, org::OrgTreeExportOpts const&), haxorg_SemId, haxorg_StdString, haxorg_OrgTreeExportOpts>(&org::exportToTreeFile, org_context, node, path, opts); }

haxorg_AstTrackingMap getAstTrackingMap(haxorg_HstdVec nodes, OrgContext* org_context) { return org::bind::c::execute_cpp<haxorg_AstTrackingMap, org::AstTrackingMap(*)(hstd::Vec<org::sem::SemId<org::sem::Org>> const&), haxorg_HstdVec>(&org::getAstTrackingMap, org_context, nodes); }
...
haxorg_HstdVec annotateSequence(haxorg_HstdVec groups, int first, int last, OrgContext* org_context) { return org::bind::c::execute_cpp<haxorg_HstdVec, hstd::Vec<hstd::SequenceAnnotation>(*)(hstd::Vec<hstd::SequenceSegmentGroup> const&, int, int), haxorg_HstdVec, int, int>(&hstd::annotateSequence, org_context, groups, first, last); }

haxorg_GraphMapGraphState initMapGraphState(haxorg_ImmAstContext ast, OrgContext* org_context) { return org::bind::c::execute_cpp<haxorg_GraphMapGraphState, std::shared_ptr<org::graph::MapGraphState>(*)(std::shared_ptr<org::imm::ImmAstContext>), haxorg_ImmAstContext>(&org::graph::initMapGraphState, org_context, ast); }

haxorg_StdString serializeToText(haxorg_ImmAstContext store, OrgContext* org_context) { return org::bind::c::execute_cpp<haxorg_StdString, std::string(*)(std::shared_ptr<org::imm::ImmAstContext> const&), haxorg_ImmAstContext>(&org::imm::serializeToText, org_context, store); }

void serializeFromText(haxorg_StdString binary, haxorg_ImmAstContext store, OrgContext* org_context) { return org::bind::c::execute_cpp<void, void(*)(std::string const&, std::shared_ptr<org::imm::ImmAstContext> const&), haxorg_StdString, haxorg_ImmAstContext>(&org::imm::serializeFromText, org_context, binary, store); }

haxorg_StdString serializeToText(haxorg_ImmAstReplaceEpoch store, OrgContext* org_context) { return org::bind::c::execute_cpp<haxorg_StdString, std::string(*)(std::shared_ptr<org::imm::ImmAstReplaceEpoch> const&), haxorg_ImmAstReplaceEpoch>(&org::imm::serializeToText, org_context, store); }

void serializeFromText(haxorg_StdString binary, haxorg_ImmAstReplaceEpoch store, OrgContext* org_context) { return org::bind::c::execute_cpp<void, void(*)(std::string const&, std::shared_ptr<org::imm::ImmAstReplaceEpoch> const&), haxorg_StdString, haxorg_ImmAstReplaceEpoch>(&org::imm::serializeFromText, org_context, binary, store); }

haxorg_StdString serializeToText(haxorg_GraphMapGraph store, OrgContext* org_context) { return org::bind::c::execute_cpp<haxorg_StdString, std::string(*)(std::shared_ptr<org::graph::MapGraph> const&), haxorg_GraphMapGraph>(&org::imm::serializeToText, org_context, store); }

void serializeFromText(haxorg_StdString binary, haxorg_GraphMapGraph store, OrgContext* org_context) { return org::bind::c::execute_cpp<void, void(*)(std::string const&, std::shared_ptr<org::graph::MapGraph> const&), haxorg_StdString, haxorg_GraphMapGraph>(&org::imm::serializeFromText, org_context, binary, store); }

haxorg_StdString serializeFromTextToTreeDump(haxorg_StdString binary, OrgContext* org_context) { return org::bind::c::execute_cpp<haxorg_StdString, std::string(*)(std::string const&), haxorg_StdString>(&org::imm::serializeFromTextToTreeDump, org_context, binary); }
