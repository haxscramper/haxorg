...
Napi::Object InitModule(Napi::Env env, Napi::Object exports) {
  ...
  immerbox_bind<hstd::Str>::Init(env, exports, "immerboxOfStr");
  immerbox_bind<std::optional<hstd::Str>>::Init(env, exports, "immerboxOfstdoptionalOfStr");
  immerbox_bind<std::optional<int>>::Init(env, exports, "immerboxOfstdoptionalOfint");
  immerflex_vector_bind<org::imm::ImmIdT<org::imm::ImmErrorItem>>::Init(env, exports, "immerflex_vectorOfImmIdTOfImmErrorItem");
  immerflex_vector_bind<org::imm::ImmIdT<org::imm::ImmBlockCodeEvalResult>>::Init(env, exports, "immerflex_vectorOfImmIdTOfImmBlockCodeEvalResult");
  immerbox_bind<std::optional<org::imm::ImmIdT<org::imm::ImmOrg>>>::Init(env, exports, "immerboxOfstdoptionalOfImmIdTOfImmOrg");
  immerflex_vector_bind<org::imm::ImmSymbol::Param>::Init(env, exports, "immerflex_vectorOfImmSymbolParam");
  immerflex_vector_bind<org::imm::ImmIdT<org::imm::ImmOrg>>::Init(env, exports, "immerflex_vectorOfImmIdTOfImmOrg");
  immerflex_vector_bind<hstd::Str>::Init(env, exports, "immerflex_vectorOfStr");
  immerbox_bind<std::optional<org::imm::ImmIdT<org::imm::ImmParagraph>>>::Init(env, exports, "immerboxOfstdoptionalOfImmIdTOfImmParagraph");
  immerflex_vector_bind<org::sem::OrgCodeEvalOutput>::Init(env, exports, "immerflex_vectorOfOrgCodeEvalOutput");
  immerflex_vector_bind<org::sem::BlockCodeLine>::Init(env, exports, "immerflex_vectorOfBlockCodeLine");
  immerbox_bind<std::optional<org::imm::ImmIdT<org::imm::ImmStmtList>>>::Init(env, exports, "immerboxOfstdoptionalOfImmIdTOfImmStmtList");
  immerbox_bind<std::optional<org::sem::SubtreeCompletion>>::Init(env, exports, "immerboxOfstdoptionalOfSubtreeCompletion");
  immerflex_vector_bind<org::imm::ImmIdT<org::imm::ImmHashTag>>::Init(env, exports, "immerflex_vectorOfImmIdTOfImmHashTag");
  immerflex_vector_bind<org::imm::ImmIdT<org::imm::ImmSubtreeLog>>::Init(env, exports, "immerflex_vectorOfImmIdTOfImmSubtreeLog");
  immerflex_vector_bind<org::sem::NamedProperty>::Init(env, exports, "immerflex_vectorOfNamedProperty");
  immerbox_bind<std::optional<hstd::UserTime>>::Init(env, exports, "immerboxOfstdoptionalOfUserTime");
  immerflex_vector_bind<org::imm::ImmIdT<org::imm::ImmCell>>::Init(env, exports, "immerflex_vectorOfImmIdTOfImmCell");
  immerflex_vector_bind<org::imm::ImmIdT<org::imm::ImmRow>>::Init(env, exports, "immerflex_vectorOfImmIdTOfImmRow");
  immerbox_bind<std::optional<bool>>::Init(env, exports, "immerboxOfstdoptionalOfbool");
  immerbox_bind<std::optional<org::sem::ColumnView>>::Init(env, exports, "immerboxOfstdoptionalOfColumnView");
  immerbox_bind<std::optional<org::imm::ImmIdT<org::imm::ImmRawText>>>::Init(env, exports, "immerboxOfstdoptionalOfImmIdTOfImmRawText");
