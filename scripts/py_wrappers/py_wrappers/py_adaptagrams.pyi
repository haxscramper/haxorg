...
class GraphNodeConstraintMultiSeparate:
    def __init__(self, lines: list[GraphNodeConstraintAlign], alignPairs: list[stdpair[int, int]], dimension: GraphDimension, separationDistance: float, isExactSeparation: bool) -> None: ...
    def toColaString(self) -> str: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
