...
class GraphConstraintAlign:
    def __init__(self, nodes: List[GraphConstraintAlignSpec], dimension: vpscDim) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
...
class GraphConstraintSeparate:
    def __init__(self, left: GraphConstraintAlign, right: GraphConstraintAlign, separationDistance: double, isExactSeparation: bool, dimension: vpscDim) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
...
class GraphConstraintMultiSeparate:
    def __init__(self, lines: List[GraphConstraintAlign], alignPairs: List[stdpair[int, int]], dimension: vpscDim, separationDistance: double, isExactSeparation: bool) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
