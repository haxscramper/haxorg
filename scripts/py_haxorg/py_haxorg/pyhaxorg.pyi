...
class OrgDocumentContext:
    def getSubtreeById(self, id: str[str]) -> List[Subtree]: ...
    def getLinkTarget(self, link: SemId) -> List[Org]: ...
    def getRadioTarget(self, name: str[str]) -> List[Org]: ...
    def addNodes(self, node: SemId) -> None: ...
