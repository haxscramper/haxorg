...
class File(Org):
    def __init__(self, relPath: str, data: FileData) -> None: ...
...
class CmdInclude(Org):
    def __init__(self, path: str, firstLine: Optional[int], lastLine: Optional[int], resolved: File, data: CmdIncludeData) -> None: ...
