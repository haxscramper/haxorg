...
class ImmStmt(ImmAdapterTBase[ImmStmt], ImmAdapterStmtAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmStmtValueRead: ...

class ImmSubtree(ImmAdapterTBase[ImmSubtree], ImmAdapterSubtreeAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmSubtreeValueRead: ...

class ImmNoNode(ImmAdapterTBase[ImmNoNode], ImmAdapterNoNodeAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmNoNodeValueRead: ...

class ImmErrorItem(ImmAdapterTBase[ImmErrorItem], ImmAdapterErrorItemAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmErrorItemValueRead: ...

class ImmErrorGroup(ImmAdapterTBase[ImmErrorGroup], ImmAdapterErrorGroupAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmErrorGroupValueRead: ...

class ImmErrorSkipGroup(ImmAdapterTBase[ImmErrorSkipGroup], ImmAdapterErrorSkipGroupAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmErrorSkipGroupValueRead: ...

class ImmErrorSkipToken(ImmAdapterTBase[ImmErrorSkipToken], ImmAdapterErrorSkipTokenAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmErrorSkipTokenValueRead: ...

class ImmStmtList(ImmAdapterTBase[ImmStmtList], ImmAdapterStmtListAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmStmtListValueRead: ...

class ImmEmpty(ImmAdapterTBase[ImmEmpty], ImmAdapterEmptyAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
...
class ImmInline(ImmAdapterTBase[ImmInline], ImmAdapterInlineAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmInlineValueRead: ...

class ImmTime(ImmAdapterTBase[ImmTime], ImmAdapterTimeAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmTimeValueRead: ...

class ImmTimeRange(ImmAdapterTBase[ImmTimeRange], ImmAdapterTimeRangeAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmTimeRangeValueRead: ...

class ImmMacro(ImmAdapterTBase[ImmMacro], ImmAdapterMacroAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmMacroValueRead: ...

class ImmSymbol(ImmAdapterTBase[ImmSymbol], ImmAdapterSymbolAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
...
class ImmLeaf(ImmAdapterTBase[ImmLeaf], ImmAdapterLeafAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
...
class ImmMarkup(ImmAdapterTBase[ImmMarkup], ImmAdapterMarkupAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmMarkupValueRead: ...

class ImmLatex(ImmAdapterTBase[ImmLatex], ImmAdapterLatexAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmLatexValueRead: ...

class ImmSubtreeLog(ImmAdapterTBase[ImmSubtreeLog], ImmAdapterSubtreeLogAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmSubtreeLogValueRead: ...

class ImmColonExample(ImmAdapterTBase[ImmColonExample], ImmAdapterColonExampleAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmColonExampleValueRead: ...

class ImmCall(ImmAdapterTBase[ImmCall], ImmAdapterCallAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmCallValueRead: ...

class ImmFile(ImmAdapterTBase[ImmFile], ImmAdapterFileAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmFileValueRead: ...

class ImmDirectory(ImmAdapterTBase[ImmDirectory], ImmAdapterDirectoryAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmDirectoryValueRead: ...

class ImmSymlink(ImmAdapterTBase[ImmSymlink], ImmAdapterSymlinkAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmSymlinkValueRead: ...

class ImmDocumentFragment(ImmAdapterTBase[ImmDocumentFragment], ImmAdapterDocumentFragmentAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmDocumentFragmentValueRead: ...

class ImmCriticMarkup(ImmAdapterTBase[ImmCriticMarkup], ImmAdapterCriticMarkupAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmCriticMarkupValueRead: ...

class ImmListItem(ImmAdapterTBase[ImmListItem], ImmAdapterListItemAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmListItemValueRead: ...

class ImmDocumentOptions(ImmAdapterTBase[ImmDocumentOptions], ImmAdapterDocumentOptionsAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmDocumentOptionsValueRead: ...

class ImmDocument(ImmAdapterTBase[ImmDocument], ImmAdapterDocumentAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmDocumentValueRead: ...

class ImmFileTarget(ImmAdapterTBase[ImmFileTarget], ImmAdapterFileTargetAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmFileTargetValueRead: ...

class ImmTextSeparator(ImmAdapterTBase[ImmTextSeparator], ImmAdapterTextSeparatorAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmTextSeparatorValueRead: ...

class ImmCmdInclude(ImmAdapterTBase[ImmCmdInclude], ImmAdapterCmdIncludeAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmCmdIncludeValueRead: ...

class ImmDocumentGroup(ImmAdapterTBase[ImmDocumentGroup], ImmAdapterDocumentGroupAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
...
class ImmCmd(ImmAdapterTBase[ImmCmd], ImmAdapterCmdAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmCmdValueRead: ...

class ImmCmdCustomRaw(ImmAdapterTBase[ImmCmdCustomRaw], ImmAdapterCmdCustomRawAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmCmdCustomRawValueRead: ...

class ImmCmdCustomText(ImmAdapterTBase[ImmCmdCustomText], ImmAdapterCmdCustomTextAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmCmdCustomTextValueRead: ...

class ImmLink(ImmAdapterTBase[ImmLink], ImmAdapterLinkAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmLinkValueRead: ...

class ImmBlockComment(ImmAdapterTBase[ImmBlockComment], ImmAdapterBlockCommentAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmBlockCommentValueRead: ...

class ImmParagraph(ImmAdapterTBase[ImmParagraph], ImmAdapterParagraphAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmParagraphValueRead: ...

class ImmList(ImmAdapterTBase[ImmList], ImmAdapterListAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmListValueRead: ...

class ImmHashTag(ImmAdapterTBase[ImmHashTag], ImmAdapterHashTagAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmHashTagValueRead: ...

class ImmInlineFootnote(ImmAdapterTBase[ImmInlineFootnote], ImmAdapterInlineFootnoteAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmInlineFootnoteValueRead: ...

class ImmEscaped(ImmAdapterTBase[ImmEscaped], ImmAdapterEscapedAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmEscapedValueRead: ...

class ImmNewline(ImmAdapterTBase[ImmNewline], ImmAdapterNewlineAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmNewlineValueRead: ...

class ImmSpace(ImmAdapterTBase[ImmSpace], ImmAdapterSpaceAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmSpaceValueRead: ...

class ImmWord(ImmAdapterTBase[ImmWord], ImmAdapterWordAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmWordValueRead: ...

class ImmAtMention(ImmAdapterTBase[ImmAtMention], ImmAdapterAtMentionAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmAtMentionValueRead: ...

class ImmRawText(ImmAdapterTBase[ImmRawText], ImmAdapterRawTextAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmRawTextValueRead: ...

class ImmPunctuation(ImmAdapterTBase[ImmPunctuation], ImmAdapterPunctuationAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmPunctuationValueRead: ...

class ImmPlaceholder(ImmAdapterTBase[ImmPlaceholder], ImmAdapterPlaceholderAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmPlaceholderValueRead: ...

class ImmBigIdent(ImmAdapterTBase[ImmBigIdent], ImmAdapterBigIdentAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmBigIdentValueRead: ...

class ImmTextTarget(ImmAdapterTBase[ImmTextTarget], ImmAdapterTextTargetAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmTextTargetValueRead: ...

class ImmBold(ImmAdapterTBase[ImmBold], ImmAdapterBoldAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmBoldValueRead: ...

class ImmUnderline(ImmAdapterTBase[ImmUnderline], ImmAdapterUnderlineAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmUnderlineValueRead: ...

class ImmMonospace(ImmAdapterTBase[ImmMonospace], ImmAdapterMonospaceAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmMonospaceValueRead: ...

class ImmMarkQuote(ImmAdapterTBase[ImmMarkQuote], ImmAdapterMarkQuoteAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmMarkQuoteValueRead: ...

class ImmRadioTarget(ImmAdapterTBase[ImmRadioTarget], ImmAdapterRadioTargetAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmRadioTargetValueRead: ...

class ImmVerbatim(ImmAdapterTBase[ImmVerbatim], ImmAdapterVerbatimAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmVerbatimValueRead: ...

class ImmItalic(ImmAdapterTBase[ImmItalic], ImmAdapterItalicAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmItalicValueRead: ...

class ImmStrike(ImmAdapterTBase[ImmStrike], ImmAdapterStrikeAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmStrikeValueRead: ...

class ImmPar(ImmAdapterTBase[ImmPar], ImmAdapterParAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
...
class ImmLineCommand(ImmAdapterTBase[ImmLineCommand], ImmAdapterLineCommandAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmLineCommandValueRead: ...

class ImmCmdCustomArgs(ImmAdapterTBase[ImmCmdCustomArgs], ImmAdapterCmdCustomArgsAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmCmdCustomArgsValueRead: ...

class ImmCmdCreator(ImmAdapterTBase[ImmCmdCreator], ImmAdapterCmdCreatorAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmCmdCreatorValueRead: ...

class ImmCmdAuthor(ImmAdapterTBase[ImmCmdAuthor], ImmAdapterCmdAuthorAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmCmdAuthorValueRead: ...

class ImmCmdEmail(ImmAdapterTBase[ImmCmdEmail], ImmAdapterCmdEmailAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmCmdEmailValueRead: ...

class ImmCmdLanguage(ImmAdapterTBase[ImmCmdLanguage], ImmAdapterCmdLanguageAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmCmdLanguageValueRead: ...

class ImmCmdTblfm(ImmAdapterTBase[ImmCmdTblfm], ImmAdapterCmdTblfmAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
...
class ImmBlock(ImmAdapterTBase[ImmBlock], ImmAdapterBlockAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmBlockValueRead: ...

class ImmCell(ImmAdapterTBase[ImmCell], ImmAdapterCellAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmCellValueRead: ...

class ImmRow(ImmAdapterTBase[ImmRow], ImmAdapterRowAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
...
class ImmAttached(ImmAdapterTBase[ImmAttached], ImmAdapterAttachedAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmAttachedValueRead: ...

class ImmBlockCenter(ImmAdapterTBase[ImmBlockCenter], ImmAdapterBlockCenterAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmBlockCenterValueRead: ...

class ImmBlockQuote(ImmAdapterTBase[ImmBlockQuote], ImmAdapterBlockQuoteAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmBlockQuoteValueRead: ...

class ImmBlockVerse(ImmAdapterTBase[ImmBlockVerse], ImmAdapterBlockVerseAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmBlockVerseValueRead: ...

class ImmBlockExample(ImmAdapterTBase[ImmBlockExample], ImmAdapterBlockExampleAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmBlockExampleValueRead: ...

class ImmInlineExport(ImmAdapterTBase[ImmInlineExport], ImmAdapterInlineExportAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmInlineExportValueRead: ...

class ImmCmdExport(ImmAdapterTBase[ImmCmdExport], ImmAdapterCmdExportAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmCmdExportValueRead: ...

class ImmBlockExport(ImmAdapterTBase[ImmBlockExport], ImmAdapterBlockExportAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmBlockExportValueRead: ...

class ImmBlockDynamicFallback(ImmAdapterTBase[ImmBlockDynamicFallback], ImmAdapterBlockDynamicFallbackAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmBlockDynamicFallbackValueRead: ...

class ImmBlockAdmonition(ImmAdapterTBase[ImmBlockAdmonition], ImmAdapterBlockAdmonitionAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmBlockAdmonitionValueRead: ...

class ImmBlockCodeEvalResult(ImmAdapterTBase[ImmBlockCodeEvalResult], ImmAdapterBlockCodeEvalResultAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmBlockCodeEvalResultValueRead: ...

class ImmBlockCode(ImmAdapterTBase[ImmBlockCode], ImmAdapterBlockCodeAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmBlockCodeValueRead: ...

class ImmTable(ImmAdapterTBase[ImmTable], ImmAdapterTableAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmTableValueRead: ...

class ImmCmdCaption(ImmAdapterTBase[ImmCmdCaption], ImmAdapterCmdCaptionAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmCmdCaptionValueRead: ...

class ImmCmdColumns(ImmAdapterTBase[ImmCmdColumns], ImmAdapterCmdColumnsAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmCmdColumnsValueRead: ...

class ImmCmdName(ImmAdapterTBase[ImmCmdName], ImmAdapterCmdNameAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmCmdNameValueRead: ...

class ImmCmdCall(ImmAdapterTBase[ImmCmdCall], ImmAdapterCmdCallAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
    def getValue(self) -> ImmCmdCallValueRead: ...

class ImmCmdAttr(ImmAdapterTBase[ImmCmdAttr], ImmAdapterCmdAttrAPI):
    def __init__(self) -> None: ...
    def __init__(self, other: ImmAdapter): ...
