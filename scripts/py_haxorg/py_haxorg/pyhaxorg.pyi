...
class CmdCaption(Attached):
    def __init__(self, text: Paragraph, parameters: Optional[Attrs], attached: List[Org]) -> None: ...
    def getAttrs(self, key: Optional[str]) -> List[AttrValue]: ...
    def getFirstAttr(self, kind: str) -> Optional[AttrValue]: ...
    def getAttached(self, kind: Optional[str]) -> List[Org]: ...
    def getAttrs(self, kind: Optional[str]) -> List[AttrValue]: ...
...
class CmdCustomArgs(Cmd):
    def __init__(self, name: str, isAttached: bool, parameters: Optional[Attrs], attached: List[Org]) -> None: ...
    def getAttrs(self, key: Optional[str]) -> List[AttrValue]: ...
    def getFirstAttr(self, kind: str) -> Optional[AttrValue]: ...
    def getAttached(self, kind: Optional[str]) -> List[Org]: ...
    def getAttrs(self, kind: Optional[str]) -> List[AttrValue]: ...
...
class Macro(Org):
    def __init__(self, name: str, parameters: Attrs) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    name: str
    parameters: Attrs
...
class BlockExport(Block):
    def __init__(self, format: BlockExportFormat, exporter: str, placement: Optional[str], content: str, parameters: Optional[Attrs], attached: List[Org]) -> None: ...
    def getAttrs(self, key: Optional[str]) -> List[AttrValue]: ...
    def getFirstAttr(self, kind: str) -> Optional[AttrValue]: ...
    def getAttached(self, kind: Optional[str]) -> List[Org]: ...
    def getAttrs(self, kind: Optional[str]) -> List[AttrValue]: ...
...
class BlockCode(Block):
    def __init__(self, lang: Optional[str], switches: List[BlockCodeSwitch], exports: BlockCodeExports, result: Optional[BlockCodeEvalResult], lines: List[BlockCodeLine], cache: bool, eval: bool, noweb: bool, hlines: bool, tangle: bool, parameters: Optional[Attrs], attached: List[Org]) -> None: ...
    def getAttrs(self, key: Optional[str]) -> List[AttrValue]: ...
    def getFirstAttr(self, kind: str) -> Optional[AttrValue]: ...
    def getAttached(self, kind: Optional[str]) -> List[Org]: ...
    def getAttrs(self, kind: Optional[str]) -> List[AttrValue]: ...
...
class Cell(Cmd):
    def __init__(self, isBlock: bool, parameters: Optional[Attrs], attached: List[Org]) -> None: ...
    def getAttrs(self, key: Optional[str]) -> List[AttrValue]: ...
    def getFirstAttr(self, kind: str) -> Optional[AttrValue]: ...
    def getAttached(self, kind: Optional[str]) -> List[Org]: ...
    def getAttrs(self, kind: Optional[str]) -> List[AttrValue]: ...
...
class Row(Cmd):
    def __init__(self, cells: List[Cell], isBlock: bool, parameters: Optional[Attrs], attached: List[Org]) -> None: ...
    def getAttrs(self, key: Optional[str]) -> List[AttrValue]: ...
    def getFirstAttr(self, kind: str) -> Optional[AttrValue]: ...
    def getAttached(self, kind: Optional[str]) -> List[Org]: ...
    def getAttrs(self, kind: Optional[str]) -> List[AttrValue]: ...
...
class Table(Block):
    def __init__(self, rows: List[Row], isBlock: bool, parameters: Optional[Attrs], attached: List[Org]) -> None: ...
    def getAttrs(self, key: Optional[str]) -> List[AttrValue]: ...
    def getFirstAttr(self, kind: str) -> Optional[AttrValue]: ...
    def getAttached(self, kind: Optional[str]) -> List[Org]: ...
    def getAttrs(self, kind: Optional[str]) -> List[AttrValue]: ...
...
class CmdAttr(Attached):
    def __init__(self, target: str, parameters: Optional[Attrs], attached: List[Org]) -> None: ...
    def getAttrs(self, key: Optional[str]) -> List[AttrValue]: ...
    def getFirstAttr(self, kind: str) -> Optional[AttrValue]: ...
    def getAttached(self, kind: Optional[str]) -> List[Org]: ...
    def getAttrs(self, kind: Optional[str]) -> List[AttrValue]: ...
...
class Call(Org):
    def __init__(self, name: str, parameters: Attrs, isCommand: bool) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    name: str
    parameters: Attrs
