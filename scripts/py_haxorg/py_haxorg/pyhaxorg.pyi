...
class parseSourceFileId(parseSourceFileIdBaseId):
    def __init__(self) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
...
class ParseContext:
    ...
    def collectDiagnostics(self, tree: Org, cache: Cache) -> list[Report]: ...
    def collectErrorNodes(self, tree: Org) -> list[ErrorGroup]: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...

class ImmReflFieldId:
    def __init__(self) -> None: ...
...
class ImmSubtreeAdapter(ImmAdapterTBase[ImmSubtree], ImmAdapterSubtreeAPI):
    ...
    def getDescription(self) -> Optional[ImmParagraphAdapter]: ...
    ...
    def getClosed(self) -> Optional[ImmTimeAdapter]: ...
    def getDeadline(self) -> Optional[ImmTimeAdapter]: ...
    def getScheduled(self) -> Optional[ImmTimeAdapter]: ...
...
class ImmSubtreeLogAdapter(ImmAdapterTBase[ImmSubtreeLog], ImmAdapterSubtreeLogAPI):
    ...
    def getDesc(self) -> Optional[ImmStmtListAdapter]: ...
...
class ImmListItemAdapter(ImmAdapterTBase[ImmListItem], ImmAdapterListItemAPI):
    ...
    def getHeader(self) -> Optional[ImmParagraphAdapter]: ...
...
class ImmDocumentAdapter(ImmAdapterTBase[ImmDocument], ImmAdapterDocumentAPI):
    def __init__(self) -> None: ...
    def getTitle(self) -> Optional[ImmParagraphAdapter]: ...
    def getAuthor(self) -> Optional[ImmParagraphAdapter]: ...
    def getCreator(self) -> Optional[ImmParagraphAdapter]: ...
    def getFiletags(self) -> ImmVec[ImmIdTHashTag]: ...
    def getEmail(self) -> Optional[ImmRawTextAdapter]: ...
