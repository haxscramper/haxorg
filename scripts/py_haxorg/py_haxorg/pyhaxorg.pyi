...
class OrgParseParameters:
    def __init__(self, baseTokenTracePath: int, tokenTracePath: int, parseTracePath: int, semTracePath: int) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    baseTokenTracePath: int
    tokenTracePath: int
    parseTracePath: int
    semTracePath: int
...
class ParseContext:
    ...
    def parseDirectory(self, path: str) -> int: ...
    def parseDirectoryOpts(self, path: str, opts: OrgDirectoryParseParameters) -> int: ...
...
class ImmPath:
    def __init__(self, root: ImmId, path: int) -> None: ...
    def empty(self) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    root: ImmId
...
class ImmAdapterTreeReprConf:
    def __init__(self, maxDepth: int, withAuxFields: bool, withReflFields: bool, withFieldSubset: int) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    maxDepth: int
    withAuxFields: bool
...
class AstTrackingGroupTrackedHashtag:
    def __init__(self, tag: Org, targets: int) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    tag: Org
    targets: int
...
class AstTrackingMap:
    def __init__(self, footnotes: int, subtrees: int, names: int, anchorTargets: int, radioTargets: int, hashtagDefinitions: int) -> None: ...
    def getIdPath(self, id: str) -> int: ...
    def getNamePath(self, id: str) -> int: ...
    def getAnchorTarget(self, id: str) -> int: ...
    def getFootnotePath(self, id: str) -> int: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    footnotes: int
    subtrees: int
...
class graphMapNodeProp:
    ...
    def getSubtreeId(self, context: ImmAstContext) -> int: ...
    def getFootnoteName(self, context: ImmAstContext) -> int: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    id: ImmUniqId
...
class graphMapGraphState:
    ...
    def getUnresolvedLink(self, node: ImmAdapterT[ImmLink], conf: graphMapConfig) -> int: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    graph: graphMapGraph
    ast: ImmAstContext
...
class ExporterPython:
    ...
    def setVisitIdAround(self, kind: int, cb: function) -> None: ...
    def setEvalIdAround(self, kind: int, cb: function) -> None: ...
    def setVisitIdInCb(self, kind: int, cb: function) -> None: ...
    def setEvalIdIn(self, kind: int, cb: function) -> None: ...
    ...
    def setVisitOrgField(self, kind: int, cb: function) -> None: ...
    def setEvalOrgField(self, kind: int, cb: function) -> None: ...
    def setSelf(self, val: object) -> None: ...
    def setNewOrgRes(self, kind: int, cb: function) -> None: ...
    ...
    def setPushVisitId(self, kind: int, cb: function) -> None: ...
    def setPopVisitIdCb(self, kind: int, cb: function) -> None: ...
    def setVisitAnyHookCb(self, cb: function) -> None: ...
    def setVisitIdHook(self, kind: int, cb: function) -> None: ...
...
class ImmAdapterDirectoryAPI(ImmAdapterOrgAPI):
    def __init__(self) -> None: ...
    def getFsSubnode(self, name: str, withPath: bool) -> int: ...
...
class ImmSubtreeAdapter(ImmAdapterTBase[ImmSubtree], ImmAdapterSubtreeAPI):
    ...
    def getDescription(self) -> Optional[ImmAdapterT[ImmIdTParagraph]]: ...
    ...
    def getClosed(self) -> Optional[ImmAdapterT[ImmIdTTime]]: ...
    def getDeadline(self) -> Optional[ImmAdapterT[ImmIdTTime]]: ...
    def getScheduled(self) -> Optional[ImmAdapterT[ImmIdTTime]]: ...
...
class ImmSubtreeLogAdapter(ImmAdapterTBase[ImmSubtreeLog], ImmAdapterSubtreeLogAPI):
    ...
    def getDesc(self) -> Optional[ImmAdapterT[ImmIdTStmtList]]: ...
...
class ImmListItemAdapter(ImmAdapterTBase[ImmListItem], ImmAdapterListItemAPI):
    ...
    def getHeader(self) -> Optional[ImmAdapterT[ImmIdTParagraph]]: ...
...
class ImmDocumentAdapter(ImmAdapterTBase[ImmDocument], ImmAdapterDocumentAPI):
    def __init__(self) -> None: ...
    def getTitle(self) -> Optional[ImmAdapterT[ImmIdTParagraph]]: ...
    def getAuthor(self) -> Optional[ImmAdapterT[ImmIdTParagraph]]: ...
    def getCreator(self) -> Optional[ImmAdapterT[ImmIdTParagraph]]: ...
    def getFiletags(self) -> ImmVec[ImmIdTHashTag]: ...
    def getEmail(self) -> Optional[ImmAdapterT[ImmIdTRawText]]: ...
...
class ImmInlineFootnoteAdapter(ImmAdapterTBase[ImmInlineFootnote], ImmAdapterInlineFootnoteAPI):
    def __init__(self) -> None: ...
    def getTag(self) -> str: ...
    def getDefinition(self) -> Optional[ImmAdapterT[ImmIdTOrg]]: ...
