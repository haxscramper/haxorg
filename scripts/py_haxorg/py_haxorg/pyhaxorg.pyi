...
class SubtreeLogHeadPriority:
    def __init__(self, oldPriority: hstdOpt[str], newPriority: hstdOpt[str], on: hstdUserTime, action: SubtreeLogHeadPriorityAction) -> None: ...
...
class SubtreeLogHeadRefile:
    def __init__(self, on: hstdUserTime, from_: LinkTarget) -> None: ...
...
class SubtreeLogHeadTag:
    def __init__(self, on: hstdUserTime, tag: HashTagText, added: bool) -> None: ...
...
class AttrGroup:
    def __init__(self, positional: AttrList, named: hstdUnorderedMap[hstdStr, AttrList]) -> None: ...
    ...
    def __getattr__(self, name: str) -> object: ...
    positional: AttrList
    named: hstdUnorderedMap[hstdStr, AttrList]
...
class SubtreePeriod:
    def __init__(self, kind: SubtreePeriodKind, from_: hstdUserTime, to: hstdOpt[hstdUserTime]) -> None: ...
...
class TimeStatic:
    def __init__(self, repeat: hstdOpt[TimeRepeat], time: hstdUserTime) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
...
class Subtree(orgOrg):
    def __init__(self, level: int, treeId: hstdOpt[hstdStr], todo: hstdOpt[hstdStr], completion: hstdOpt[SubtreeCompletion], description: hstdOpt[orgSemId], tags: hstdVec[orgSemId], title: orgSemId, logbook: hstdVec[orgSemId], properties: hstdVec[NamedProperty], closed: hstdOpt[hstdUserTime], deadline: hstdOpt[hstdUserTime], scheduled: hstdOpt[hstdUserTime], isComment: bool, isArchived: bool, priority: hstdOpt[hstdStr]) -> None: ...
    def getTimePeriods(self, kinds: hstdIntSet[SubtreePeriodKind]) -> hstdVec[SubtreePeriod]: ...
