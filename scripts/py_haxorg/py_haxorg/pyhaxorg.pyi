...
class OperationsTracer:
    ...
    def begin_scope_event(self, value: Optional[str], function: str, line: int, file: str) -> None: ...
    def end_scope_event(self, value: Optional[str], function: str, line: int, file: str) -> None: ...
