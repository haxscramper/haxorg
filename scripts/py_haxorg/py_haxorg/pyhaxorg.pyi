...
class CmdArgumentValue:
    ...
    def operator==(self, other: CmdArgumentValue) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    name: Optional[str]
...
class CmdArgument(Org):
    def __init__(self, arg: CmdArgumentValue) -> None: ...
    def getName(self) -> str: ...
    def getValue(self) -> str: ...
    def getVarname(self) -> str: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    arg: CmdArgumentValue
...
class CmdArguments(Org):
    ...
    def getArguments(self, key: Optional[str]) -> List[CmdArgumentValue]: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
...
class Stmt(Org):
    ...
    def getArguments(self, kind: Optional[str]) -> List[CmdArgumentValue]: ...
    def getFirstArgument(self, kind: str) -> Optional[CmdArgumentValue]: ...
    attached: List[Org]
