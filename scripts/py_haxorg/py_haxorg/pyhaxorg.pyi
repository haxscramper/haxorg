...
class ParseSourceManager:
    def __init__(self) -> None: ...
    def getPath(self, id: ParseSourceFileId) -> str: ...
    def getId(self, path: str) -> ParseSourceFileId: ...
    def getSourceContent(self, id: ParseSourceFileId) -> str: ...
    def getContentTextForPath(self, path: str) -> str: ...
