...
class Org:
    def __init__(self, loc: Optional[ParseSourceLoc], subnodes: list[SemId]) -> None: ...
    def getKind(self) -> OrgSemKind: ...
    def push_back(self, sub: SemId) -> None: ...
    def size(self) -> int: ...
    def insert(self, pos: int, node: SemId) -> None: ...
    def at(self, idx: int) -> SemId: ...
...
class AstTrackingPath:
    def __init__(self, path: list[SemId]) -> None: ...
    def getParent(self, offset: int) -> SemId: ...
    def getNode(self) -> SemId: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    path: list[SemId]
...
class AstTrackingAlternatives:
    def __init__(self) -> None: ...
    def getAllNodes(self) -> list[SemId]: ...
    def getNode(self) -> SemId: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...

class AstTrackingGroupRadioTarget:
    def __init__(self, target: AstTrackingPath, nodes: list[SemId]) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
...
class AstTrackingGroupSingle:
    def __init__(self, node: SemId) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    node: SemId

class AstTrackingGroupTrackedHashtag:
    def __init__(self, tag: SemId, targets: int) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    tag: SemId
    targets: int
...
class GraphMapGraphState:
    ...
    @staticmethod
    def FromAstContextStatic(ast: ImmAstContext) -> GraphMapGraphState: ...
    ...
    def getUnresolvedLink(self, node: ImmLinkAdapter, conf: GraphMapConfig) -> int: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    graph: GraphMapGraph
    ast: ImmAstContext
...
class ExporterPython:
    ...
    def evalTop(self, org: SemId) -> ExporterPythonRes: ...
    def eval(self, org: SemId) -> ExporterPythonRes: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
...
class LispCode:
    ...
    @staticmethod
    def getKindStatic(__input: LispCodeData) -> LispCodeKind: ...
    def getKind(self) -> LispCodeKind: ...
    def sub_variant_get_name(self) -> str: ...
...
class TblfmExprAxisRefPosition:
    ...
    @staticmethod
    def getKindStatic(__input: TblfmExprAxisRefPositionData) -> TblfmExprAxisRefPositionKind: ...
...
class TblfmExpr:
    ...
    @staticmethod
    def getKindStatic(__input: TblfmExprData) -> TblfmExprKind: ...
...
class AttrValue:
    ...
    @staticmethod
    def getKindStatic(__input: AttrValueDataVariant) -> AttrValueKind: ...
...
class LinkTarget:
    ...
    @staticmethod
    def getKindStatic(__input: LinkTargetData) -> LinkTargetKind: ...
...
class SubtreeLogHead:
    ...
    @staticmethod
    def getLogKindStatic(__input: SubtreeLogHeadLogEntry) -> SubtreeLogHeadKind: ...
...
class ColumnViewSummary:
    ...
    @staticmethod
    def getKindStatic(__input: ColumnViewSummaryData) -> ColumnViewSummaryKind: ...
...
class BlockCodeLinePart:
    ...
    @staticmethod
    def getKindStatic(__input: BlockCodeLinePartData) -> BlockCodeLinePartKind: ...
...
class DocumentExportConfig:
    ...
    @staticmethod
    def getTocExportKindStatic(__input: DocumentExportConfigTocExport) -> DocumentExportConfigTocExportKind: ...
...
class NamedProperty:
    ...
    @staticmethod
    def getKindStatic(__input: NamedPropertyData) -> NamedPropertyKind: ...
...
class OrgDiagnostics:
    ...
    @staticmethod
    def getKindStatic(__input: OrgDiagnosticsData) -> OrgDiagnosticsKind: ...
...
class ErrorGroup(Org):
    def __init__(self, diagnostics: list[SemId]) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    diagnostics: list[SemId]

class Stmt(Org):
    def __init__(self, attached: list[SemId]) -> None: ...
    def getAttached(self, kind: Optional[str]) -> list[SemId]: ...
    def getCaption(self) -> list[SemId]: ...
...
class Time(Org):
    ...
    @staticmethod
    def getTimeKindStatic(__input: TimeTimeVariant) -> TimeTimeKind: ...
...
class TimeRange(Org):
    def __init__(self, from_: SemId, to: SemId) -> None: ...
...
class ErrorSkipGroup(Org):
    def __init__(self, skipped: list[SemId]) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    skipped: list[SemId]
...
class SubtreeLog(Org):
    def __init__(self, head: SubtreeLogHead, desc: Optional[SemId]) -> None: ...
    def setDescription(self, desc: SemId) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    head: SubtreeLogHead
    desc: Optional[SemId]
...
class File(Org):
    ...
    @staticmethod
    def getFileKindStatic(__input: FileData) -> FileKind: ...
...
class CmdInclude(Org):
    ...
    @staticmethod
    def getIncludeKindStatic(__input: CmdIncludeData) -> CmdIncludeKind: ...
...
class CmdCustomText(Stmt):
    def __init__(self, name: str, isAttached: bool, text: SemId) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    name: str
    isAttached: bool
...
class Link(Stmt):
    def __init__(self, description: Optional[SemId], target: LinkTarget) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    description: Optional[SemId]
    target: LinkTarget
...
class Paragraph(Stmt):
    ...
    def getAdmonitionNodes(self) -> list[SemId]: ...
    def hasTimestamp(self) -> bool: ...
    def getTimestamps(self) -> list[UserTime]: ...
    def getTimestampNodes(self) -> list[SemId]: ...
    def hasLeadHashtags(self) -> bool: ...
    def getLeadHashtags(self) -> list[SemId]: ...
    def getBody(self) -> list[SemId]: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
...
class InlineFootnote(Inline):
    def __init__(self, tag: str, definition: Optional[SemId]) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    tag: str
...
class CmdCreator(Cmd):
    def __init__(self, text: SemId) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    text: SemId
...
class Row(Cmd):
    def __init__(self, cells: list[SemId], isBlock: bool) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    cells: list[SemId]
    isBlock: bool
...
class ImmStmtAdapter(ImmAdapterStmtAPI):
    def __init__(self) -> None: ...
    def getAttached(self) -> ImmVec[ImmIdTOrg]: ...

class ImmSubtreeAdapter(ImmAdapterSubtreeAPI):
    def __init__(self) -> None: ...
...
class ImmNoNodeAdapter(ImmAdapterNoNodeAPI):
    def __init__(self) -> None: ...

class ImmErrorItemAdapter(ImmAdapterErrorItemAPI):
    def __init__(self) -> None: ...
    def getDiag(self) -> OrgDiagnostics: ...

class ImmErrorGroupAdapter(ImmAdapterErrorGroupAPI):
    def __init__(self) -> None: ...
    def getDiagnostics(self) -> ImmVec[ImmIdTErrorItem]: ...

class ImmErrorSkipGroupAdapter(ImmAdapterErrorSkipGroupAPI):
    def __init__(self) -> None: ...
    def getSkipped(self) -> ImmVec[ImmIdTErrorSkipToken]: ...

class ImmErrorSkipTokenAdapter(ImmAdapterErrorSkipTokenAPI):
    def __init__(self) -> None: ...

class ImmStmtListAdapter(ImmAdapterStmtListAPI):
    def __init__(self) -> None: ...

class ImmEmptyAdapter(ImmAdapterEmptyAPI):
    def __init__(self) -> None: ...
...
class ImmInlineAdapter(ImmAdapterInlineAPI):
    def __init__(self) -> None: ...

class ImmTimeAdapter(ImmAdapterTimeAPI):
    def __init__(self) -> None: ...
    def getIsActive(self) -> bool: ...
    def getTime(self) -> ImmTimeTimeVariant: ...

class ImmTimeRangeAdapter(ImmAdapterTimeRangeAPI):
    def __init__(self) -> None: ...
    def getFrom(self) -> ImmAdapter: ...
    def getTo(self) -> ImmAdapter: ...

class ImmMacroAdapter(ImmAdapterMacroAPI):
    def __init__(self) -> None: ...
    def getName(self) -> str: ...
    def getAttrs(self) -> AttrGroup: ...

class ImmSymbolAdapter(ImmAdapterSymbolAPI):
    def __init__(self) -> None: ...
    def getName(self) -> str: ...
...
class ImmLeafAdapter(ImmAdapterLeafAPI):
    def __init__(self) -> None: ...
    def getText(self) -> str: ...
...
class ImmMarkupAdapter(ImmAdapterMarkupAPI):
    def __init__(self) -> None: ...

class ImmLatexAdapter(ImmAdapterLatexAPI):
    def __init__(self) -> None: ...

class ImmSubtreeLogAdapter(ImmAdapterSubtreeLogAPI):
    def __init__(self) -> None: ...
    def getHead(self) -> SubtreeLogHead: ...
    def getDesc(self) -> Optional[ImmStmtListAdapter]: ...

class ImmColonExampleAdapter(ImmAdapterColonExampleAPI):
    def __init__(self) -> None: ...

class ImmCallAdapter(ImmAdapterCallAPI):
    def __init__(self) -> None: ...
    def getName(self) -> str: ...
    def getAttrs(self) -> AttrGroup: ...
    def getIsCommand(self) -> bool: ...

class ImmFileAdapter(ImmAdapterFileAPI):
    def __init__(self) -> None: ...
    def getRelPath(self) -> str: ...
    def getAbsPath(self) -> str: ...
    def getData(self) -> ImmFileData: ...

class ImmDirectoryAdapter(ImmAdapterDirectoryAPI):
    def __init__(self) -> None: ...
    def getRelPath(self) -> str: ...
    def getAbsPath(self) -> str: ...

class ImmSymlinkAdapter(ImmAdapterSymlinkAPI):
    def __init__(self) -> None: ...
    def getIsDirectory(self) -> bool: ...
    def getAbsPath(self) -> str: ...

class ImmDocumentFragmentAdapter(ImmAdapterDocumentFragmentAPI):
    def __init__(self) -> None: ...
    def getBaseLine(self) -> int: ...
    def getBaseCol(self) -> int: ...

class ImmCriticMarkupAdapter(ImmAdapterCriticMarkupAPI):
    def __init__(self) -> None: ...
    def getKind(self) -> ImmCriticMarkupKind: ...

class ImmListItemAdapter(ImmAdapterListItemAPI):
    def __init__(self) -> None: ...
    def getCheckbox(self) -> CheckboxState: ...
    def getHeader(self) -> Optional[ImmParagraphAdapter]: ...
    def getBullet(self) -> Optional[str]: ...

class ImmDocumentOptionsAdapter(ImmAdapterDocumentOptionsAPI):
    def __init__(self) -> None: ...
...
class ImmDocumentAdapter(ImmAdapterDocumentAPI):
    def __init__(self) -> None: ...
...
class ImmFileTargetAdapter(ImmAdapterFileTargetAPI):
    def __init__(self) -> None: ...
...
class ImmTextSeparatorAdapter(ImmAdapterTextSeparatorAPI):
    def __init__(self) -> None: ...

class ImmCmdIncludeAdapter(ImmAdapterCmdIncludeAPI):
    def __init__(self) -> None: ...
    def getPath(self) -> str: ...
...
class ImmDocumentGroupAdapter(ImmAdapterDocumentGroupAPI):
    def __init__(self) -> None: ...
...
class BlockCodeEvalResult(Block):
    def __init__(self, raw: list[OrgCodeEvalOutput], node: SemId) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
...
class Table(Block):
    def __init__(self, rows: list[SemId], isBlock: bool) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    rows: list[SemId]
    isBlock: bool
...
class ImmCmdAdapter(ImmAdapterCmdAPI):
    def __init__(self) -> None: ...
    def getAttrs(self) -> AttrGroup: ...

class ImmCmdCustomRawAdapter(ImmAdapterCmdCustomRawAPI):
    def __init__(self) -> None: ...
    def getName(self) -> str: ...
    def getIsAttached(self) -> bool: ...
    def getText(self) -> str: ...

class ImmCmdCustomTextAdapter(ImmAdapterCmdCustomTextAPI):
    def __init__(self) -> None: ...
    def getName(self) -> str: ...
    def getIsAttached(self) -> bool: ...
    def getText(self) -> ImmAdapter: ...

class ImmLinkAdapter(ImmAdapterLinkAPI):
    def __init__(self) -> None: ...
    def getDescription(self) -> Optional[ImmParagraphAdapter]: ...
    def getTarget(self) -> LinkTarget: ...

class ImmBlockCommentAdapter(ImmAdapterBlockCommentAPI):
    def __init__(self) -> None: ...

class ImmParagraphAdapter(ImmAdapterParagraphAPI):
    def __init__(self) -> None: ...

class ImmListAdapter(ImmAdapterListAPI):
    def __init__(self) -> None: ...

class ImmHashTagAdapter(ImmAdapterHashTagAPI):
    def __init__(self) -> None: ...
    def getText(self) -> HashTagText: ...

class ImmInlineFootnoteAdapter(ImmAdapterInlineFootnoteAPI):
    def __init__(self) -> None: ...
    def getTag(self) -> str: ...
    def getDefinition(self) -> Optional[ImmAdapter]: ...

class ImmEscapedAdapter(ImmAdapterEscapedAPI):
    def __init__(self) -> None: ...

class ImmNewlineAdapter(ImmAdapterNewlineAPI):
    def __init__(self) -> None: ...

class ImmSpaceAdapter(ImmAdapterSpaceAPI):
    def __init__(self) -> None: ...

class ImmWordAdapter(ImmAdapterWordAPI):
    def __init__(self) -> None: ...

class ImmAtMentionAdapter(ImmAdapterAtMentionAPI):
    def __init__(self) -> None: ...

class ImmRawTextAdapter(ImmAdapterRawTextAPI):
    def __init__(self) -> None: ...

class ImmPunctuationAdapter(ImmAdapterPunctuationAPI):
    def __init__(self) -> None: ...

class ImmPlaceholderAdapter(ImmAdapterPlaceholderAPI):
    def __init__(self) -> None: ...

class ImmBigIdentAdapter(ImmAdapterBigIdentAPI):
    def __init__(self) -> None: ...

class ImmTextTargetAdapter(ImmAdapterTextTargetAPI):
    def __init__(self) -> None: ...

class ImmBoldAdapter(ImmAdapterBoldAPI):
    def __init__(self) -> None: ...

class ImmUnderlineAdapter(ImmAdapterUnderlineAPI):
    def __init__(self) -> None: ...

class ImmMonospaceAdapter(ImmAdapterMonospaceAPI):
    def __init__(self) -> None: ...

class ImmMarkQuoteAdapter(ImmAdapterMarkQuoteAPI):
    def __init__(self) -> None: ...

class ImmRadioTargetAdapter(ImmAdapterRadioTargetAPI):
    def __init__(self) -> None: ...
    def getWords(self) -> ImmVec[str]: ...

class ImmVerbatimAdapter(ImmAdapterVerbatimAPI):
    def __init__(self) -> None: ...

class ImmItalicAdapter(ImmAdapterItalicAPI):
    def __init__(self) -> None: ...

class ImmStrikeAdapter(ImmAdapterStrikeAPI):
    def __init__(self) -> None: ...

class ImmParAdapter(ImmAdapterParAPI):
    def __init__(self) -> None: ...
...
class ImmLineCommandAdapter(ImmAdapterLineCommandAPI):
    def __init__(self) -> None: ...

class ImmCmdCustomArgsAdapter(ImmAdapterCmdCustomArgsAPI):
    def __init__(self) -> None: ...
    def getName(self) -> str: ...
    def getIsAttached(self) -> bool: ...

class ImmCmdCreatorAdapter(ImmAdapterCmdCreatorAPI):
    def __init__(self) -> None: ...
    def getText(self) -> ImmAdapter: ...

class ImmCmdAuthorAdapter(ImmAdapterCmdAuthorAPI):
    def __init__(self) -> None: ...
    def getText(self) -> ImmAdapter: ...

class ImmCmdEmailAdapter(ImmAdapterCmdEmailAPI):
    def __init__(self) -> None: ...
    def getText(self) -> str: ...

class ImmCmdLanguageAdapter(ImmAdapterCmdLanguageAPI):
    def __init__(self) -> None: ...
    def getText(self) -> str: ...

class ImmCmdTblfmAdapter(ImmAdapterCmdTblfmAPI):
    def __init__(self) -> None: ...
...
class ImmBlockAdapter(ImmAdapterBlockAPI):
    def __init__(self) -> None: ...

class ImmCellAdapter(ImmAdapterCellAPI):
    def __init__(self) -> None: ...
    def getIsBlock(self) -> bool: ...

class ImmRowAdapter(ImmAdapterRowAPI):
    def __init__(self) -> None: ...
...
class ImmAttachedAdapter(ImmAdapterAttachedAPI):
    def __init__(self) -> None: ...

class ImmBlockCenterAdapter(ImmAdapterBlockCenterAPI):
    def __init__(self) -> None: ...

class ImmBlockQuoteAdapter(ImmAdapterBlockQuoteAPI):
    def __init__(self) -> None: ...

class ImmBlockVerseAdapter(ImmAdapterBlockVerseAPI):
    def __init__(self) -> None: ...

class ImmBlockExampleAdapter(ImmAdapterBlockExampleAPI):
    def __init__(self) -> None: ...

class ImmInlineExportAdapter(ImmAdapterInlineExportAPI):
    def __init__(self) -> None: ...
    def getExporter(self) -> str: ...
    def getContent(self) -> str: ...

class ImmCmdExportAdapter(ImmAdapterCmdExportAPI):
    def __init__(self) -> None: ...
    def getExporter(self) -> str: ...
    def getContent(self) -> str: ...

class ImmBlockExportAdapter(ImmAdapterBlockExportAPI):
    def __init__(self) -> None: ...
    def getExporter(self) -> str: ...
    def getContent(self) -> str: ...

class ImmBlockDynamicFallbackAdapter(ImmAdapterBlockDynamicFallbackAPI):
    def __init__(self) -> None: ...
    def getName(self) -> str: ...

class ImmBlockAdmonitionAdapter(ImmAdapterBlockAdmonitionAPI):
    def __init__(self) -> None: ...

class ImmBlockCodeEvalResultAdapter(ImmAdapterBlockCodeEvalResultAPI):
    def __init__(self) -> None: ...
    def getRaw(self) -> ImmVec[OrgCodeEvalOutput]: ...
    def getNode(self) -> ImmAdapter: ...

class ImmBlockCodeAdapter(ImmAdapterBlockCodeAPI):
    def __init__(self) -> None: ...
...
class ImmTableAdapter(ImmAdapterTableAPI):
    def __init__(self) -> None: ...
    def getRows(self) -> ImmVec[ImmIdTRow]: ...
    def getIsBlock(self) -> bool: ...

class ImmCmdCaptionAdapter(ImmAdapterCmdCaptionAPI):
    def __init__(self) -> None: ...
    def getText(self) -> ImmAdapter: ...

class ImmCmdColumnsAdapter(ImmAdapterCmdColumnsAPI):
    def __init__(self) -> None: ...
    def getView(self) -> ColumnView: ...

class ImmCmdNameAdapter(ImmAdapterCmdNameAPI):
    def __init__(self) -> None: ...
    def getName(self) -> str: ...

class ImmCmdCallAdapter(ImmAdapterCmdCallAPI):
    def __init__(self) -> None: ...
    def getName(self) -> str: ...
...
class ImmCmdAttrAdapter(ImmAdapterCmdAttrAPI):
    def __init__(self) -> None: ...
