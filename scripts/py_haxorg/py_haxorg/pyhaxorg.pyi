...
class OrgExporterJson:
    ...
    def exportToString() -> str[char]: ...
    def exportToFile(path: str[char]) -> None: ...
...
class OrgExporterTree:
    def toString(node: SemId, opts: ExporterTreeOpts) -> str[char]: ...
    def toFile(node: SemId, path: str[char], opts: ExporterTreeOpts) -> None: ...
...
class OrgContext:
    ...
    def parseFile(file: str[char]) -> None: ...
    def loadStore(path: str[char]) -> None: ...
    def writeStore(path: str[char]) -> None: ...
    def parseString(text: str[char]) -> None: ...
    def getNode() -> SemDocument: ...

class ExporterPython:
    def enablePyStreamTrace(stream: object) -> None: ...
    def enableBufferTrace() -> None: ...
    def getTraceBuffer() -> str[char]: ...
    def enableFileTrace(path: str[char]) -> None: ...
