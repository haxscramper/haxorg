...
class SubtreeLogPriority(SubtreeLogDescribedLog):
    def __init__(self, oldPriority: Optional[str], newPriority: Optional[str], on: UserTime, action: SubtreeLogPriorityAction) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
...
class SubtreeLogRefile(SubtreeLogDescribedLog):
    def __init__(self, on: UserTime, from_: Link) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    on: UserTime
    from_: Link
...
class SubtreeLogDeadline(SubtreeLogDescribedLog):
...
class SubtreeLogSchedule(SubtreeLogDescribedLog):
    def __init__(self, from_: Optional[UserTime], to: UserTime, on: UserTime) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    from_: Optional[UserTime]
...
class SubtreeLogTag(SubtreeLogDescribedLog):
    def __init__(self, on: UserTime, tag: HashTag, added: bool) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    on: UserTime
    tag: HashTag
...
SubtreeLogLogEntry = Union[SubtreeLogPriority, SubtreeLogNote, SubtreeLogRefile, SubtreeLogClock, SubtreeLogState, SubtreeLogDeadline, SubtreeLogSchedule, SubtreeLogTag, SubtreeLogUnknown]
...
class SubtreeLog(Org):
    ...
    def getDeadline(self) -> SubtreeLogDeadline: ...
    def isSchedule(self) -> bool: ...
    def getSchedule(self) -> SubtreeLogSchedule: ...
    def isTag(self) -> bool: ...
