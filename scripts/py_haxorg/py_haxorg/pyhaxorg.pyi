...
class AstTrackingMap:
    def __init__(self, footnotes: Dict[str, AstTrackingAlternatives], subtrees: Dict[str, AstTrackingAlternatives], names: Dict[str, AstTrackingAlternatives], anchorTargets: Dict[str, AstTrackingAlternatives], radioTargets: Dict[str, AstTrackingAlternatives]) -> None: ...
