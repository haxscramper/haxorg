...
class immImmNoneValue(immImmNoneValueRead):
    def __init__(self) -> None: ...
...
class immImmErrorItemValue(immImmErrorItemValueRead):
    def __init__(self) -> None: ...
...
class immImmErrorGroupValue(immImmErrorGroupValueRead):
    def __init__(self) -> None: ...
...
class immImmStmtListValue(immImmStmtListValueRead):
    def __init__(self) -> None: ...

class immImmEmptyValueRead:
    def __init__(self) -> None: ...

class immImmEmptyValue(immImmEmptyValueRead):
    def __init__(self) -> None: ...
...
class immImmCmdCaptionValue(immImmCmdCaptionValueRead):
    def __init__(self) -> None: ...
...
class immImmCmdColumnsValue(immImmCmdColumnsValueRead):
    def __init__(self) -> None: ...
...
class immImmCmdNameValue(immImmCmdNameValueRead):
    def __init__(self) -> None: ...
...
class immImmCmdCustomArgsValue(immImmCmdCustomArgsValueRead):
    def __init__(self) -> None: ...
    def setName(self, value: immerbox[str]) -> None: ...
...
class immImmCmdCustomRawValue(immImmCmdCustomRawValueRead):
    def __init__(self) -> None: ...
    def setName(self, value: immerbox[str]) -> None: ...
    def setIsattached(self, value: bool) -> None: ...
...
class immImmCmdCustomTextValue(immImmCmdCustomTextValueRead):
    def __init__(self) -> None: ...
    def setName(self, value: immerbox[str]) -> None: ...
    def setIsattached(self, value: bool) -> None: ...
    def setText(self, value: immImmIdT[immImmParagraph]) -> None: ...
...
class immImmCmdCallValue(immImmCmdCallValueRead):
    def __init__(self) -> None: ...
    def setName(self, value: immerbox[str]) -> None: ...
...
class immImmCmdTblfmValue(immImmCmdTblfmValueRead):
    def __init__(self) -> None: ...
...
class immImmHashTagValue(immImmHashTagValueRead):
    def __init__(self) -> None: ...
...
class immImmInlineFootnoteValue(immImmInlineFootnoteValueRead):
    def __init__(self) -> None: ...
...
class immImmInlineExportValue(immImmInlineExportValueRead):
    def __init__(self) -> None: ...
...
class immImmTimeValue(immImmTimeValueRead):
    def __init__(self) -> None: ...
...
class immImmTimeRangeValue(immImmTimeRangeValueRead):
    def __init__(self) -> None: ...
...
class immImmMacroValue(immImmMacroValueRead):
    def __init__(self) -> None: ...
    def setName(self, value: immerbox[str]) -> None: ...
...
class immImmSymbolValueRead:
    def __init__(self) -> None: ...
    def getName(self) -> immerbox[str]: ...
    def getParameters(self) -> immerflex_vector[immImmSymbolParam]: ...
    def getPositional(self) -> immerflex_vector[immImmIdT[immImmOrg]]: ...

class immImmSymbolValue(immImmSymbolValueRead):
    def __init__(self) -> None: ...
    def setName(self, value: immerbox[str]) -> None: ...
    def setParameters(self, value: immerflex_vector[immImmSymbolParam]) -> None: ...
    def setPositional(self, value: immerflex_vector[immImmIdT[immImmOrg]]) -> None: ...

class immImmEscapedValueRead:
    def __init__(self) -> None: ...

class immImmEscapedValue(immImmEscapedValueRead):
    def __init__(self) -> None: ...

class immImmNewlineValueRead:
    def __init__(self) -> None: ...

class immImmNewlineValue(immImmNewlineValueRead):
    def __init__(self) -> None: ...

class immImmSpaceValueRead:
    def __init__(self) -> None: ...

class immImmSpaceValue(immImmSpaceValueRead):
    def __init__(self) -> None: ...

class immImmWordValueRead:
    def __init__(self) -> None: ...

class immImmWordValue(immImmWordValueRead):
    def __init__(self) -> None: ...

class immImmAtMentionValueRead:
    def __init__(self) -> None: ...

class immImmAtMentionValue(immImmAtMentionValueRead):
    def __init__(self) -> None: ...

class immImmRawTextValueRead:
    def __init__(self) -> None: ...

class immImmRawTextValue(immImmRawTextValueRead):
    def __init__(self) -> None: ...

class immImmPunctuationValueRead:
    def __init__(self) -> None: ...

class immImmPunctuationValue(immImmPunctuationValueRead):
    def __init__(self) -> None: ...

class immImmPlaceholderValueRead:
    def __init__(self) -> None: ...

class immImmPlaceholderValue(immImmPlaceholderValueRead):
    def __init__(self) -> None: ...

class immImmBigIdentValueRead:
    def __init__(self) -> None: ...

class immImmBigIdentValue(immImmBigIdentValueRead):
    def __init__(self) -> None: ...

class immImmTextTargetValueRead:
    def __init__(self) -> None: ...

class immImmTextTargetValue(immImmTextTargetValueRead):
    def __init__(self) -> None: ...

class immImmBoldValueRead:
    def __init__(self) -> None: ...

class immImmBoldValue(immImmBoldValueRead):
    def __init__(self) -> None: ...

class immImmUnderlineValueRead:
    def __init__(self) -> None: ...

class immImmUnderlineValue(immImmUnderlineValueRead):
    def __init__(self) -> None: ...

class immImmMonospaceValueRead:
    def __init__(self) -> None: ...

class immImmMonospaceValue(immImmMonospaceValueRead):
    def __init__(self) -> None: ...

class immImmMarkQuoteValueRead:
    def __init__(self) -> None: ...

class immImmMarkQuoteValue(immImmMarkQuoteValueRead):
    def __init__(self) -> None: ...

class immImmVerbatimValueRead:
    def __init__(self) -> None: ...

class immImmVerbatimValue(immImmVerbatimValueRead):
    def __init__(self) -> None: ...

class immImmItalicValueRead:
    def __init__(self) -> None: ...

class immImmItalicValue(immImmItalicValueRead):
    def __init__(self) -> None: ...

class immImmStrikeValueRead:
    def __init__(self) -> None: ...

class immImmStrikeValue(immImmStrikeValueRead):
    def __init__(self) -> None: ...

class immImmParValueRead:
    def __init__(self) -> None: ...

class immImmParValue(immImmParValueRead):
    def __init__(self) -> None: ...
...
class immImmRadioTargetValue(immImmRadioTargetValueRead):
    def __init__(self) -> None: ...
...
class immImmLatexValue(immImmLatexValueRead):
    def __init__(self) -> None: ...
...
class immImmLinkValue(immImmLinkValueRead):
    def __init__(self) -> None: ...
...
class immImmBlockCenterValue(immImmBlockCenterValueRead):
    def __init__(self) -> None: ...

class immImmBlockQuoteValueRead:
    def __init__(self) -> None: ...

class immImmBlockQuoteValue(immImmBlockQuoteValueRead):
    def __init__(self) -> None: ...

class immImmBlockCommentValueRead:
    def __init__(self) -> None: ...

class immImmBlockCommentValue(immImmBlockCommentValueRead):
    def __init__(self) -> None: ...

class immImmBlockVerseValueRead:
    def __init__(self) -> None: ...

class immImmBlockVerseValue(immImmBlockVerseValueRead):
    def __init__(self) -> None: ...
...
class immImmBlockDynamicFallbackValue(immImmBlockDynamicFallbackValueRead):
    def __init__(self) -> None: ...
    def setName(self, value: immerbox[str]) -> None: ...
...
class immImmBlockExampleValue(immImmBlockExampleValueRead):
    def __init__(self) -> None: ...
...
class immImmBlockExportValue(immImmBlockExportValueRead):
    def __init__(self) -> None: ...
    def setExporter(self, value: immerbox[str]) -> None: ...
    def setContent(self, value: immerbox[str]) -> None: ...
...
class immImmBlockAdmonitionValue(immImmBlockAdmonitionValueRead):
    def __init__(self) -> None: ...
...
class immImmBlockCodeEvalResultValue(immImmBlockCodeEvalResultValueRead):
    def __init__(self) -> None: ...
...
class immImmBlockCodeValue(immImmBlockCodeValueRead):
    def __init__(self) -> None: ...
...
class immImmSubtreeLogValue(immImmSubtreeLogValueRead):
    def __init__(self) -> None: ...
...
class immImmSubtreeValue(immImmSubtreeValueRead):
    def __init__(self) -> None: ...
...
class immImmCellValue(immImmCellValueRead):
    def __init__(self) -> None: ...
...
class immImmRowValue(immImmRowValueRead):
    def __init__(self) -> None: ...
...
class immImmTableValue(immImmTableValueRead):
    def __init__(self) -> None: ...
...
class immImmParagraphValue(immImmParagraphValueRead):
    def __init__(self) -> None: ...

class immImmColonExampleValueRead:
    def __init__(self) -> None: ...

class immImmColonExampleValue(immImmColonExampleValueRead):
    def __init__(self) -> None: ...
...
class immImmCmdAttrValue(immImmCmdAttrValueRead):
    def __init__(self) -> None: ...
...
class immImmCmdExportValue(immImmCmdExportValueRead):
    def __init__(self) -> None: ...
    def setExporter(self, value: immerbox[str]) -> None: ...
    def setContent(self, value: immerbox[str]) -> None: ...
...
class immImmCallValue(immImmCallValueRead):
    def __init__(self) -> None: ...
    def setName(self, value: immerbox[str]) -> None: ...
    def setAttrs(self, value: AttrGroup) -> None: ...
...
class immImmListValue(immImmListValueRead):
    def __init__(self) -> None: ...

class immImmListItemValueRead:
    def __init__(self) -> None: ...
    def getCheckbox(self) -> immImmListItemCheckbox: ...
    def getHeader(self) -> immerbox[Optional[immImmIdT[immImmParagraph]]]: ...
    def getBullet(self) -> immerbox[Optional[str]]: ...

class immImmListItemValue(immImmListItemValueRead):
    def __init__(self) -> None: ...
    def setCheckbox(self, value: immImmListItemCheckbox) -> None: ...
...
class immImmDocumentOptionsValue(immImmDocumentOptionsValueRead):
    def __init__(self) -> None: ...
...
class immImmDocumentFragmentValue(immImmDocumentFragmentValueRead):
    def __init__(self) -> None: ...
...
class immImmCriticMarkupValueRead:
    def __init__(self) -> None: ...
    def getKind(self) -> immImmCriticMarkupKind: ...

class immImmCriticMarkupValue(immImmCriticMarkupValueRead):
    def __init__(self) -> None: ...
    def setKind(self, value: immImmCriticMarkupKind) -> None: ...
...
class immImmDocumentValue(immImmDocumentValueRead):
    def __init__(self) -> None: ...
...
class immImmFileTargetValue(immImmFileTargetValueRead):
    def __init__(self) -> None: ...
...
class immImmTextSeparatorValue(immImmTextSeparatorValueRead):
    def __init__(self) -> None: ...

class immImmDocumentGroupValueRead:
    def __init__(self) -> None: ...

class immImmDocumentGroupValue(immImmDocumentGroupValueRead):
    def __init__(self) -> None: ...
...
class immImmFileValue(immImmFileValueRead):
    def __init__(self) -> None: ...
...
class immImmDirectoryValue(immImmDirectoryValueRead):
    def __init__(self) -> None: ...
    def setRelpath(self, value: immerbox[str]) -> None: ...
    def setAbspath(self, value: immerbox[str]) -> None: ...
...
class immImmSymlinkValue(immImmSymlinkValueRead):
    def __init__(self) -> None: ...
...
class immImmCmdIncludeValue(immImmCmdIncludeValueRead):
    def __init__(self) -> None: ...
    def setPath(self, value: immerbox[str]) -> None: ...
...
class immImmAdapterOrgAPI(immImmAdapterVirtualBase):
    def __init__(self) -> None: ...

class immImmAdapterStmtAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterCmdAPI(immImmAdapterStmtAPI):
    def __init__(self) -> None: ...

class immImmAdapterSubtreeAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterNoneAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterAttrAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterAttrListAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterAttrsAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterErrorItemAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterErrorGroupAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterStmtListAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterEmptyAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterLineCommandAPI(immImmAdapterCmdAPI):
    def __init__(self) -> None: ...

class immImmAdapterAttachedAPI(immImmAdapterLineCommandAPI):
    def __init__(self) -> None: ...

class immImmAdapterCmdCaptionAPI(immImmAdapterAttachedAPI):
    def __init__(self) -> None: ...

class immImmAdapterCmdColumnsAPI(immImmAdapterAttachedAPI):
    def __init__(self) -> None: ...

class immImmAdapterCmdNameAPI(immImmAdapterAttachedAPI):
    def __init__(self) -> None: ...

class immImmAdapterCmdCallAPI(immImmAdapterAttachedAPI):
    def __init__(self) -> None: ...

class immImmAdapterCmdCustomArgsAPI(immImmAdapterCmdAPI):
    def __init__(self) -> None: ...

class immImmAdapterCmdCustomRawAPI(immImmAdapterStmtAPI):
    def __init__(self) -> None: ...

class immImmAdapterCmdCustomTextAPI(immImmAdapterStmtAPI):
    def __init__(self) -> None: ...

class immImmAdapterCmdResultsAPI(immImmAdapterAttachedAPI):
    def __init__(self) -> None: ...

class immImmAdapterCmdTblfmAPI(immImmAdapterCmdAPI):
    def __init__(self) -> None: ...

class immImmAdapterInlineAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterHashTagAPI(immImmAdapterInlineAPI):
    def __init__(self) -> None: ...

class immImmAdapterInlineFootnoteAPI(immImmAdapterInlineAPI):
    def __init__(self) -> None: ...

class immImmAdapterTimeAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterTimeRangeAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterMacroAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterSymbolAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterLeafAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterEscapedAPI(immImmAdapterLeafAPI):
    def __init__(self) -> None: ...

class immImmAdapterNewlineAPI(immImmAdapterLeafAPI):
    def __init__(self) -> None: ...

class immImmAdapterSpaceAPI(immImmAdapterLeafAPI):
    def __init__(self) -> None: ...

class immImmAdapterWordAPI(immImmAdapterLeafAPI):
    def __init__(self) -> None: ...

class immImmAdapterAtMentionAPI(immImmAdapterLeafAPI):
    def __init__(self) -> None: ...

class immImmAdapterRawTextAPI(immImmAdapterLeafAPI):
    def __init__(self) -> None: ...

class immImmAdapterPunctuationAPI(immImmAdapterLeafAPI):
    def __init__(self) -> None: ...

class immImmAdapterPlaceholderAPI(immImmAdapterLeafAPI):
    def __init__(self) -> None: ...

class immImmAdapterBigIdentAPI(immImmAdapterLeafAPI):
    def __init__(self) -> None: ...

class immImmAdapterTextTargetAPI(immImmAdapterLeafAPI):
    def __init__(self) -> None: ...

class immImmAdapterMarkupAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterBoldAPI(immImmAdapterMarkupAPI):
    def __init__(self) -> None: ...

class immImmAdapterUnderlineAPI(immImmAdapterMarkupAPI):
    def __init__(self) -> None: ...

class immImmAdapterMonospaceAPI(immImmAdapterMarkupAPI):
    def __init__(self) -> None: ...

class immImmAdapterMarkQuoteAPI(immImmAdapterMarkupAPI):
    def __init__(self) -> None: ...

class immImmAdapterRadioTargetAPI(immImmAdapterMarkupAPI):
    def __init__(self) -> None: ...

class immImmAdapterVerbatimAPI(immImmAdapterMarkupAPI):
    def __init__(self) -> None: ...

class immImmAdapterItalicAPI(immImmAdapterMarkupAPI):
    def __init__(self) -> None: ...

class immImmAdapterStrikeAPI(immImmAdapterMarkupAPI):
    def __init__(self) -> None: ...

class immImmAdapterParAPI(immImmAdapterMarkupAPI):
    def __init__(self) -> None: ...

class immImmAdapterLatexAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterLinkAPI(immImmAdapterStmtAPI):
    def __init__(self) -> None: ...

class immImmAdapterBlockAPI(immImmAdapterCmdAPI):
    def __init__(self) -> None: ...

class immImmAdapterBlockCenterAPI(immImmAdapterBlockAPI):
    def __init__(self) -> None: ...

class immImmAdapterBlockQuoteAPI(immImmAdapterBlockAPI):
    def __init__(self) -> None: ...

class immImmAdapterBlockCommentAPI(immImmAdapterStmtAPI):
    def __init__(self) -> None: ...

class immImmAdapterBlockVerseAPI(immImmAdapterBlockAPI):
    def __init__(self) -> None: ...

class immImmAdapterBlockExampleAPI(immImmAdapterBlockAPI):
    def __init__(self) -> None: ...

class immImmAdapterInlineExportAPI(immImmAdapterBlockAPI):
    def __init__(self) -> None: ...

class immImmAdapterCmdExportAPI(immImmAdapterBlockAPI):
    def __init__(self) -> None: ...

class immImmAdapterBlockExportAPI(immImmAdapterBlockAPI):
    def __init__(self) -> None: ...

class immImmAdapterBlockDynamicFallbackAPI(immImmAdapterBlockAPI):
    def __init__(self) -> None: ...

class immImmAdapterBlockAdmonitionAPI(immImmAdapterBlockAPI):
    def __init__(self) -> None: ...

class immImmAdapterBlockCodeEvalResultAPI(immImmAdapterBlockAPI):
    def __init__(self) -> None: ...

class immImmAdapterBlockCodeAPI(immImmAdapterBlockAPI):
    def __init__(self) -> None: ...

class immImmAdapterSubtreeLogAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterSubtreeCompletionAPI(immImmAdapterInlineAPI):
    def __init__(self) -> None: ...

class immImmAdapterCellAPI(immImmAdapterCmdAPI):
    def __init__(self) -> None: ...

class immImmAdapterRowAPI(immImmAdapterCmdAPI):
    def __init__(self) -> None: ...

class immImmAdapterTableAPI(immImmAdapterBlockAPI):
    def __init__(self) -> None: ...

class immImmAdapterParagraphAPI(immImmAdapterStmtAPI):
    def __init__(self) -> None: ...

class immImmAdapterColonExampleAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterCmdAttrAPI(immImmAdapterAttachedAPI):
    def __init__(self) -> None: ...

class immImmAdapterCallAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterFileAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterDirectoryAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterSymlinkAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterDocumentFragmentAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterCriticMarkupAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterListAPI(immImmAdapterStmtAPI):
    def __init__(self) -> None: ...

class immImmAdapterListItemAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterDocumentOptionsAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterDocumentAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterFileTargetAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterTextSeparatorAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterCmdIncludeAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class immImmAdapterDocumentGroupAPI(immImmAdapterOrgAPI):
    def __init__(self) -> None: ...

class ImmNoneAdapter(immImmAdapterTBase[immImmNone], immImmAdapterNoneAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmNoneValueRead: ...

class ImmErrorItemAdapter(immImmAdapterTBase[immImmErrorItem], immImmAdapterErrorItemAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmErrorItemValueRead: ...

class ImmErrorGroupAdapter(immImmAdapterTBase[immImmErrorGroup], immImmAdapterErrorGroupAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmErrorGroupValueRead: ...

class ImmStmtListAdapter(immImmAdapterTBase[immImmStmtList], immImmAdapterStmtListAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmStmtListValueRead: ...

class ImmEmptyAdapter(immImmAdapterTBase[immImmEmpty], immImmAdapterEmptyAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmEmptyValueRead: ...

class ImmCmdCaptionAdapter(immImmAdapterTBase[immImmCmdCaption], immImmAdapterCmdCaptionAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmCmdCaptionValueRead: ...

class ImmCmdColumnsAdapter(immImmAdapterTBase[immImmCmdColumns], immImmAdapterCmdColumnsAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmCmdColumnsValueRead: ...

class ImmCmdNameAdapter(immImmAdapterTBase[immImmCmdName], immImmAdapterCmdNameAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmCmdNameValueRead: ...

class ImmCmdCustomArgsAdapter(immImmAdapterTBase[immImmCmdCustomArgs], immImmAdapterCmdCustomArgsAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmCmdCustomArgsValueRead: ...

class ImmCmdCustomRawAdapter(immImmAdapterTBase[immImmCmdCustomRaw], immImmAdapterCmdCustomRawAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmCmdCustomRawValueRead: ...

class ImmCmdCustomTextAdapter(immImmAdapterTBase[immImmCmdCustomText], immImmAdapterCmdCustomTextAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmCmdCustomTextValueRead: ...

class ImmCmdCallAdapter(immImmAdapterTBase[immImmCmdCall], immImmAdapterCmdCallAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmCmdCallValueRead: ...

class ImmCmdTblfmAdapter(immImmAdapterTBase[immImmCmdTblfm], immImmAdapterCmdTblfmAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmCmdTblfmValueRead: ...

class ImmHashTagAdapter(immImmAdapterTBase[immImmHashTag], immImmAdapterHashTagAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmHashTagValueRead: ...

class ImmInlineFootnoteAdapter(immImmAdapterTBase[immImmInlineFootnote], immImmAdapterInlineFootnoteAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmInlineFootnoteValueRead: ...

class ImmInlineExportAdapter(immImmAdapterTBase[immImmInlineExport], immImmAdapterInlineExportAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmInlineExportValueRead: ...

class ImmTimeAdapter(immImmAdapterTBase[immImmTime], immImmAdapterTimeAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmTimeValueRead: ...

class ImmTimeRangeAdapter(immImmAdapterTBase[immImmTimeRange], immImmAdapterTimeRangeAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmTimeRangeValueRead: ...

class ImmMacroAdapter(immImmAdapterTBase[immImmMacro], immImmAdapterMacroAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmMacroValueRead: ...

class ImmSymbolAdapter(immImmAdapterTBase[immImmSymbol], immImmAdapterSymbolAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmSymbolValueRead: ...

class ImmEscapedAdapter(immImmAdapterTBase[immImmEscaped], immImmAdapterEscapedAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmEscapedValueRead: ...

class ImmNewlineAdapter(immImmAdapterTBase[immImmNewline], immImmAdapterNewlineAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmNewlineValueRead: ...

class ImmSpaceAdapter(immImmAdapterTBase[immImmSpace], immImmAdapterSpaceAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmSpaceValueRead: ...

class ImmWordAdapter(immImmAdapterTBase[immImmWord], immImmAdapterWordAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmWordValueRead: ...

class ImmAtMentionAdapter(immImmAdapterTBase[immImmAtMention], immImmAdapterAtMentionAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmAtMentionValueRead: ...

class ImmRawTextAdapter(immImmAdapterTBase[immImmRawText], immImmAdapterRawTextAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmRawTextValueRead: ...

class ImmPunctuationAdapter(immImmAdapterTBase[immImmPunctuation], immImmAdapterPunctuationAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmPunctuationValueRead: ...

class ImmPlaceholderAdapter(immImmAdapterTBase[immImmPlaceholder], immImmAdapterPlaceholderAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmPlaceholderValueRead: ...

class ImmBigIdentAdapter(immImmAdapterTBase[immImmBigIdent], immImmAdapterBigIdentAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmBigIdentValueRead: ...

class ImmTextTargetAdapter(immImmAdapterTBase[immImmTextTarget], immImmAdapterTextTargetAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmTextTargetValueRead: ...

class ImmBoldAdapter(immImmAdapterTBase[immImmBold], immImmAdapterBoldAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmBoldValueRead: ...

class ImmUnderlineAdapter(immImmAdapterTBase[immImmUnderline], immImmAdapterUnderlineAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmUnderlineValueRead: ...

class ImmMonospaceAdapter(immImmAdapterTBase[immImmMonospace], immImmAdapterMonospaceAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmMonospaceValueRead: ...

class ImmMarkQuoteAdapter(immImmAdapterTBase[immImmMarkQuote], immImmAdapterMarkQuoteAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmMarkQuoteValueRead: ...

class ImmVerbatimAdapter(immImmAdapterTBase[immImmVerbatim], immImmAdapterVerbatimAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmVerbatimValueRead: ...

class ImmItalicAdapter(immImmAdapterTBase[immImmItalic], immImmAdapterItalicAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmItalicValueRead: ...

class ImmStrikeAdapter(immImmAdapterTBase[immImmStrike], immImmAdapterStrikeAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmStrikeValueRead: ...

class ImmParAdapter(immImmAdapterTBase[immImmPar], immImmAdapterParAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmParValueRead: ...

class ImmRadioTargetAdapter(immImmAdapterTBase[immImmRadioTarget], immImmAdapterRadioTargetAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmRadioTargetValueRead: ...

class ImmLatexAdapter(immImmAdapterTBase[immImmLatex], immImmAdapterLatexAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmLatexValueRead: ...

class ImmLinkAdapter(immImmAdapterTBase[immImmLink], immImmAdapterLinkAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmLinkValueRead: ...

class ImmBlockCenterAdapter(immImmAdapterTBase[immImmBlockCenter], immImmAdapterBlockCenterAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmBlockCenterValueRead: ...

class ImmBlockQuoteAdapter(immImmAdapterTBase[immImmBlockQuote], immImmAdapterBlockQuoteAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmBlockQuoteValueRead: ...

class ImmBlockCommentAdapter(immImmAdapterTBase[immImmBlockComment], immImmAdapterBlockCommentAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmBlockCommentValueRead: ...

class ImmBlockVerseAdapter(immImmAdapterTBase[immImmBlockVerse], immImmAdapterBlockVerseAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmBlockVerseValueRead: ...

class ImmBlockDynamicFallbackAdapter(immImmAdapterTBase[immImmBlockDynamicFallback], immImmAdapterBlockDynamicFallbackAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmBlockDynamicFallbackValueRead: ...

class ImmBlockExampleAdapter(immImmAdapterTBase[immImmBlockExample], immImmAdapterBlockExampleAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmBlockExampleValueRead: ...

class ImmBlockExportAdapter(immImmAdapterTBase[immImmBlockExport], immImmAdapterBlockExportAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmBlockExportValueRead: ...

class ImmBlockAdmonitionAdapter(immImmAdapterTBase[immImmBlockAdmonition], immImmAdapterBlockAdmonitionAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmBlockAdmonitionValueRead: ...

class ImmBlockCodeEvalResultAdapter(immImmAdapterTBase[immImmBlockCodeEvalResult], immImmAdapterBlockCodeEvalResultAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmBlockCodeEvalResultValueRead: ...

class ImmBlockCodeAdapter(immImmAdapterTBase[immImmBlockCode], immImmAdapterBlockCodeAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmBlockCodeValueRead: ...

class ImmSubtreeLogAdapter(immImmAdapterTBase[immImmSubtreeLog], immImmAdapterSubtreeLogAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmSubtreeLogValueRead: ...

class ImmSubtreeAdapter(immImmAdapterTBase[immImmSubtree], immImmAdapterSubtreeAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmSubtreeValueRead: ...

class ImmCellAdapter(immImmAdapterTBase[immImmCell], immImmAdapterCellAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmCellValueRead: ...

class ImmRowAdapter(immImmAdapterTBase[immImmRow], immImmAdapterRowAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmRowValueRead: ...

class ImmTableAdapter(immImmAdapterTBase[immImmTable], immImmAdapterTableAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmTableValueRead: ...

class ImmParagraphAdapter(immImmAdapterTBase[immImmParagraph], immImmAdapterParagraphAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmParagraphValueRead: ...

class ImmColonExampleAdapter(immImmAdapterTBase[immImmColonExample], immImmAdapterColonExampleAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmColonExampleValueRead: ...

class ImmCmdAttrAdapter(immImmAdapterTBase[immImmCmdAttr], immImmAdapterCmdAttrAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmCmdAttrValueRead: ...

class ImmCmdExportAdapter(immImmAdapterTBase[immImmCmdExport], immImmAdapterCmdExportAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmCmdExportValueRead: ...

class ImmCallAdapter(immImmAdapterTBase[immImmCall], immImmAdapterCallAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmCallValueRead: ...

class ImmListAdapter(immImmAdapterTBase[immImmList], immImmAdapterListAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmListValueRead: ...

class ImmListItemAdapter(immImmAdapterTBase[immImmListItem], immImmAdapterListItemAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmListItemValueRead: ...

class ImmDocumentOptionsAdapter(immImmAdapterTBase[immImmDocumentOptions], immImmAdapterDocumentOptionsAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmDocumentOptionsValueRead: ...

class ImmDocumentFragmentAdapter(immImmAdapterTBase[immImmDocumentFragment], immImmAdapterDocumentFragmentAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmDocumentFragmentValueRead: ...

class ImmCriticMarkupAdapter(immImmAdapterTBase[immImmCriticMarkup], immImmAdapterCriticMarkupAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmCriticMarkupValueRead: ...

class ImmDocumentAdapter(immImmAdapterTBase[immImmDocument], immImmAdapterDocumentAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmDocumentValueRead: ...

class ImmFileTargetAdapter(immImmAdapterTBase[immImmFileTarget], immImmAdapterFileTargetAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmFileTargetValueRead: ...

class ImmTextSeparatorAdapter(immImmAdapterTBase[immImmTextSeparator], immImmAdapterTextSeparatorAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmTextSeparatorValueRead: ...

class ImmDocumentGroupAdapter(immImmAdapterTBase[immImmDocumentGroup], immImmAdapterDocumentGroupAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmDocumentGroupValueRead: ...

class ImmFileAdapter(immImmAdapterTBase[immImmFile], immImmAdapterFileAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmFileValueRead: ...

class ImmDirectoryAdapter(immImmAdapterTBase[immImmDirectory], immImmAdapterDirectoryAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmDirectoryValueRead: ...

class ImmSymlinkAdapter(immImmAdapterTBase[immImmSymlink], immImmAdapterSymlinkAPI):
    def __init__(self) -> None: ...
    def getValue(self) -> immImmSymlinkValueRead: ...

class ImmCmdIncludeAdapter(immImmAdapterTBase[immImmCmdInclude], immImmAdapterCmdIncludeAPI):
    def __init__(self) -> None: ...
