...
class DocumentOptions(Org):
    def __init__(self, initialVisibility: InitialSubtreeVisibility, properties: list[NamedProperty], exportConfig: DocumentExportConfig, fixedWidthSections: Optional[bool], linkVisibility: Optional[LinkVisibility], startupIndented: Optional[bool], category: Optional[str], setupfile: Optional[str], maxSubtreeLevelExport: Optional[int], columns: Optional[ColumnView], todoKeywords: list[TodoKeyword], doneKeywords: list[TodoKeyword]) -> None: ...
    def getProperties(self, kind: str, subKind: Optional[str]) -> list[NamedProperty]: ...
    def getProperty(self, kind: str, subKind: Optional[str]) -> Optional[NamedProperty]: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
