...
class BlockCodeLinePart:
    ...
    def getRaw(self) -> BlockCodeBlockCodeLineBlockCodeLinePartRaw: ...
    def getCallout(self) -> BlockCodeBlockCodeLineBlockCodeLinePartCallout: ...
    def getTangle(self) -> BlockCodeBlockCodeLineBlockCodeLinePartTangle: ...
    @staticmethod
...
BlockCodeBlockCodeEvalResultData = Union[None, OrgValue, File, Raw]
...
class BlockCodeEvalResult:
    ...
    def getNone(self) -> BlockCodeBlockCodeEvalResultNone: ...
    def getOrgValue(self) -> BlockCodeBlockCodeEvalResultOrgValue: ...
    def getFile(self) -> BlockCodeBlockCodeEvalResultFile: ...
    def getRaw(self) -> BlockCodeBlockCodeEvalResultRaw: ...
    @staticmethod
...
class SubtreeLogPriorityNote(SubtreeLogDescribedLog):
    def __init__(self, on: Time) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    on: Time

class SubtreeLogPriorityRefile(SubtreeLogDescribedLog):
...
class SubtreeLogPriorityClock(SubtreeLogDescribedLog):
...
class SubtreeLogPriorityState(SubtreeLogDescribedLog):
...
class SubtreeLogPriorityTag(SubtreeLogDescribedLog):
...
class SubtreeLogPriorityUnknown(SubtreeLogDescribedLog):
    def __init__(self) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...

SubtreeLogLogEntry = Union[SubtreeLogPriority, SubtreeLogPriorityNote, SubtreeLogPriorityRefile, SubtreeLogPriorityClock, SubtreeLogPriorityState, SubtreeLogPriorityTag, SubtreeLogPriorityUnknown]
...
class ExportLatexClass:
    def __init__(self, latexClass: str) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    latexClass: str

class ExportLatexClassOptions:
    def __init__(self, options: List[str]) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    options: List[str]

class ExportLatexHeader:
    def __init__(self, header: str) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    header: str

class ExportLatexCompiler:
...
class CustomArgs:
    def __init__(self, name: str, sub: Optional[str], parameters: CmdArguments) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    name: str
    sub: Optional[str]
...
SubtreePropertyData = Union[Nonblocking, Trigger, Origin, ExportLatexClass, ExportLatexClassOptions, ExportLatexHeader, ExportLatexCompiler, Ordered, Effort, Visibility, ExportOptions, Blocker, Unnumbered, Created, CustomArgs, CustomRaw]
...
AnnotatedParagraphData = Union[None, Footnote, Admonition, Timestamp]
...
DocumentOptionsExportConfigTocExport = Union[DoExport, ExportFixed]
...
IncludeData = Union[Example, Export, Src, OrgDocument]
