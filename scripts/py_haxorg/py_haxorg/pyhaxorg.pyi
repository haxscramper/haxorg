...
class OrgCodeEvalInput:
    def __init__(self, blockAttrs: AttrGroup, tangledCode: str, resultType: OrgCodeEvalInputResultType, resultFormat: OrgCodeEvalInputResultFormat, resultHandling: OrgCodeEvalInputResultHandling, language: str) -> None: ...
