...
class OrgCodeEvalInput:
    def __init__(self, blockAttrs: AttrGroup, tangledCode: str, resultType: OrgCodeEvalInputResultType, resultFormat: OrgCodeEvalInputResultFormat, resultHandling: OrgCodeEvalInputResultHandling) -> None: ...
...
class BlockCode(Block):
    ...
    def getCodeForEvaluation(self) -> OrgCodeEvalInputResultType: ...
    def getAttrs(self, key: Optional[str]) -> List[AttrValue]: ...
    def getFirstAttr(self, kind: str) -> Optional[AttrValue]: ...
    def getAttached(self, kind: Optional[str]) -> List[Org]: ...
    def getCaption(self) -> List[Org]: ...
