...
class AttrValue:
    def __init__(self, name: Optional[str], varname: Optional[str], value: str, isQuoted: bool) -> None: ...
...
class BlockCode(Block):
    def __init__(self, lang: Optional[str], switches: List[BlockCodeSwitch], exports: BlockCodeExports, result: Optional[BlockCodeEvalResult], lines: List[BlockCodeLine], cache: bool, eval: bool, noweb: bool, hlines: bool, tangle: bool, attrs: Optional[AttrGroup], attached: List[Org]) -> None: ...
    def getAttrs(self, key: Optional[str]) -> List[AttrValue]: ...
    def getFirstAttr(self, kind: str) -> Optional[AttrValue]: ...
    def getAttached(self, kind: Optional[str]) -> List[Org]: ...
    def getCaption(self) -> List[Org]: ...
...
class bindpythonExporterPython:
    def __init__(self) -> None: ...
    ...
    def setVisitLeafField(self, kind: bindpythonLeafFieldType, cb: function) -> None: ...
    def setEvalLeafField(self, kind: bindpythonLeafFieldType, cb: function) -> None: ...
    ...
    def setNewLeafRes(self, kind: bindpythonLeafFieldType, cb: function) -> None: ...
    ...
    def evalTop(self, org: Org) -> bindpythonExporterPythonRes: ...
    def eval(self, org: Org) -> bindpythonExporterPythonRes: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
...
class bindpythonLeafFieldType(Enum):
    Int = 1
    UserTimeKind = 2
    QDate = 3
    Bool = 4
