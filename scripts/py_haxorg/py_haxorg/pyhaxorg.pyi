...
class BlockCode(Block):
    def __init__(self, lang: Optional[str], exports: BlockCodeExports, result: List[BlockCodeEvalResult], lines: List[BlockCodeLine], cache: bool, eval: bool, noweb: bool, hlines: bool, tangle: bool, executionVars: AttrGroup, switches: AttrGroup, attrs: Optional[AttrGroup], attached: List[Org]) -> None: ...
