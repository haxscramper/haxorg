...
class NamedPropertyRadioTarget:
    def __init__(self, words: List[str]) -> None: ...
    def operator==(self, other: NamedPropertyRadioTarget) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    words: List[str]
...
class NamedProperty:
    ...
    def getRadioTarget(self) -> NamedPropertyRadioTarget: ...
