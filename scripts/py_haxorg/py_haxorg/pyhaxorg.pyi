...
class Table(Stmt):
    def __init__(self, rows: List[Row], isBlock: bool, attached: List[Org]) -> None: ...
    def getAttached(self, kind: Optional[str]) -> List[Org]: ...
    def getArguments(self, kind: Optional[str]) -> Optional[CmdArgumentList]: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
...
class Caption(Attached):
    def __init__(self, text: Paragraph, attached: List[Org]) -> None: ...
    def getAttached(self, kind: Optional[str]) -> List[Org]: ...
    def getArguments(self, kind: Optional[str]) -> Optional[CmdArgumentList]: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
...
class CmdAttr(Attached):
    def __init__(self, target: str, parameters: CmdArguments, attached: List[Org]) -> None: ...
    def getAttached(self, kind: Optional[str]) -> List[Org]: ...
    def getArguments(self, kind: Optional[str]) -> Optional[CmdArgumentList]: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
...
class Code(Block):
    def __init__(self, lang: Optional[str], switches: List[CodeSwitch], exports: CodeExports, lines: List[CodeLine], cache: bool, eval: bool, noweb: bool, hlines: bool, tangle: bool, parameters: Optional[CmdArguments], attached: List[Org]) -> None: ...
    def getArguments(self, key: Optional[str]) -> Optional[CmdArgumentList]: ...
    def getAttached(self, kind: Optional[str]) -> List[Org]: ...
    def getArguments(self, kind: Optional[str]) -> Optional[CmdArgumentList]: ...
    def __repr__(self) -> str: ...
