...
class UserTime:
    ...
    def format(self) -> str: ...
    def getTimeDeltaSeconds(self, other: UserTime) -> int: ...
...
class graphMapGraphState:
    ...
    def getUnresolvedSubtreeLinks(self, node: ImmAdapterT[ImmSubtree], conf: graphMapConfig) -> List[graphMapLink]: ...
    def getUnresolvedLink(self, node: ImmAdapterT[ImmLink], conf: graphMapConfig) -> Optional[graphMapLink]: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    graph: graphMapGraph
    ast: ImmAstContext
...
class PyCodeEvalParameters:
    def __init__(self, evalBlock: Callable) -> None: ...
...
class ExporterPython(Exporter[ExporterPython, object]):
    ...
    def setVisitAnyIdAround(self, cb: Callable) -> None: ...
    def setVisitAnyIdIn(self, cb: Callable) -> None: ...
    def setVisitAnyField(self, cb: Callable) -> None: ...
    def setEvalTopCb(self, cb: Callable) -> None: ...
    def setVisitIdAround(self, kind: OrgSemKind, cb: Callable) -> None: ...
    def setEvalIdAround(self, kind: OrgSemKind, cb: Callable) -> None: ...
    def setVisitIdInCb(self, kind: OrgSemKind, cb: Callable) -> None: ...
    def setEvalIdIn(self, kind: OrgSemKind, cb: Callable) -> None: ...
    def setVisitLeafField(self, kind: LeafFieldType, cb: Callable) -> None: ...
    def setEvalLeafField(self, kind: LeafFieldType, cb: Callable) -> None: ...
    def setVisitOrgField(self, kind: OrgSemKind, cb: Callable) -> None: ...
    def setEvalOrgField(self, kind: OrgSemKind, cb: Callable) -> None: ...
    def setSelf(self, val: object) -> None: ...
    def setNewOrgRes(self, kind: OrgSemKind, cb: Callable) -> None: ...
    def setNewAnyOrgRes(self, cb: Callable) -> None: ...
    def setNewLeafRes(self, kind: LeafFieldType, cb: Callable) -> None: ...
    def setNewAnyLeafRes(self, cb: Callable) -> None: ...
    def setPushVisitAnyId(self, cb: Callable) -> None: ...
    def setPopVisitAnyId(self, cb: Callable) -> None: ...
    def setPushVisitId(self, kind: OrgSemKind, cb: Callable) -> None: ...
    def setPopVisitIdCb(self, kind: OrgSemKind, cb: Callable) -> None: ...
    def setVisitAnyHookCb(self, cb: Callable) -> None: ...
    def setVisitIdHook(self, kind: OrgSemKind, cb: Callable) -> None: ...
...
class AttrValue:
    ...
    def getString(self) -> str: ...
    def getDouble(self) -> Optional[float]: ...
...
class ImmAdapterNoNodeBase:
    def __init__(self) -> None: ...

class ImmAdapterErrorItemBase:
    def __init__(self) -> None: ...

class ImmAdapterErrorGroupBase:
    def __init__(self) -> None: ...

class ImmAdapterStmtBase:
    def __init__(self) -> None: ...

class ImmAdapterInlineBase:
    def __init__(self) -> None: ...

class ImmAdapterStmtListBase:
    def __init__(self) -> None: ...

class ImmAdapterEmptyBase:
    def __init__(self) -> None: ...

class ImmAdapterCmdBase:
    def __init__(self) -> None: ...

class ImmAdapterBlockBase:
    def __init__(self) -> None: ...

class ImmAdapterLineCommandBase:
    def __init__(self) -> None: ...

class ImmAdapterAttachedBase:
    def __init__(self) -> None: ...

class ImmAdapterLeafBase:
    def __init__(self) -> None: ...

class ImmAdapterCmdCaptionBase:
    def __init__(self) -> None: ...

class ImmAdapterCmdCreatorBase:
    def __init__(self) -> None: ...

class ImmAdapterCmdAuthorBase:
    def __init__(self) -> None: ...

class ImmAdapterCmdEmailBase:
    def __init__(self) -> None: ...

class ImmAdapterCmdLanguageBase:
    def __init__(self) -> None: ...

class ImmAdapterCmdColumnsBase:
    def __init__(self) -> None: ...

class ImmAdapterCmdNameBase:
    def __init__(self) -> None: ...

class ImmAdapterCmdCustomArgsBase:
    def __init__(self) -> None: ...

class ImmAdapterCmdCustomRawBase:
    def __init__(self) -> None: ...

class ImmAdapterCmdCustomTextBase:
    def __init__(self) -> None: ...

class ImmAdapterCmdCallBase:
    def __init__(self) -> None: ...

class ImmAdapterCmdTblfmBase:
    def __init__(self) -> None: ...

class ImmAdapterHashTagBase:
    def __init__(self) -> None: ...

class ImmAdapterInlineFootnoteBase:
    def __init__(self) -> None: ...

class ImmAdapterInlineExportBase:
    def __init__(self) -> None: ...

class ImmAdapterTimeBase:
    def __init__(self) -> None: ...

class ImmAdapterTimeRangeBase:
    def __init__(self) -> None: ...

class ImmAdapterMacroBase:
    def __init__(self) -> None: ...

class ImmAdapterSymbolBase:
    def __init__(self) -> None: ...

class ImmAdapterEscapedBase:
    def __init__(self) -> None: ...

class ImmAdapterNewlineBase:
    def __init__(self) -> None: ...

class ImmAdapterSpaceBase:
    def __init__(self) -> None: ...

class ImmAdapterWordBase:
    def __init__(self) -> None: ...

class ImmAdapterAtMentionBase:
    def __init__(self) -> None: ...

class ImmAdapterRawTextBase:
    def __init__(self) -> None: ...

class ImmAdapterPunctuationBase:
    def __init__(self) -> None: ...

class ImmAdapterPlaceholderBase:
    def __init__(self) -> None: ...

class ImmAdapterBigIdentBase:
    def __init__(self) -> None: ...

class ImmAdapterTextTargetBase:
    def __init__(self) -> None: ...

class ImmAdapterErrorSkipTokenBase:
    def __init__(self) -> None: ...

class ImmAdapterErrorSkipGroupBase:
    def __init__(self) -> None: ...

class ImmAdapterMarkupBase:
    def __init__(self) -> None: ...

class ImmAdapterBoldBase:
    def __init__(self) -> None: ...

class ImmAdapterUnderlineBase:
    def __init__(self) -> None: ...

class ImmAdapterMonospaceBase:
    def __init__(self) -> None: ...

class ImmAdapterMarkQuoteBase:
    def __init__(self) -> None: ...

class ImmAdapterVerbatimBase:
    def __init__(self) -> None: ...

class ImmAdapterItalicBase:
    def __init__(self) -> None: ...

class ImmAdapterStrikeBase:
    def __init__(self) -> None: ...

class ImmAdapterParBase:
    def __init__(self) -> None: ...

class ImmAdapterRadioTargetBase:
    def __init__(self) -> None: ...

class ImmAdapterLatexBase:
    def __init__(self) -> None: ...

class ImmAdapterLinkBase:
    def __init__(self) -> None: ...

class ImmAdapterBlockCenterBase:
    def __init__(self) -> None: ...

class ImmAdapterBlockQuoteBase:
    def __init__(self) -> None: ...

class ImmAdapterBlockCommentBase:
    def __init__(self) -> None: ...

class ImmAdapterBlockVerseBase:
    def __init__(self) -> None: ...

class ImmAdapterBlockDynamicFallbackBase:
    def __init__(self) -> None: ...

class ImmAdapterBlockExampleBase:
    def __init__(self) -> None: ...

class ImmAdapterBlockExportBase:
    def __init__(self) -> None: ...

class ImmAdapterBlockAdmonitionBase:
    def __init__(self) -> None: ...

class ImmAdapterBlockCodeEvalResultBase:
    def __init__(self) -> None: ...

class ImmAdapterBlockCodeBase:
    def __init__(self) -> None: ...

class ImmAdapterSubtreeLogBase:
    def __init__(self) -> None: ...

class ImmAdapterSubtreeBase:
    def __init__(self) -> None: ...

class ImmAdapterCellBase:
    def __init__(self) -> None: ...

class ImmAdapterRowBase:
    def __init__(self) -> None: ...

class ImmAdapterTableBase:
    def __init__(self) -> None: ...

class ImmAdapterParagraphBase:
    def __init__(self) -> None: ...

class ImmAdapterColonExampleBase:
    def __init__(self) -> None: ...

class ImmAdapterCmdAttrBase:
    def __init__(self) -> None: ...

class ImmAdapterCmdExportBase:
    def __init__(self) -> None: ...

class ImmAdapterCallBase:
    def __init__(self) -> None: ...

class ImmAdapterListBase:
    def __init__(self) -> None: ...

class ImmAdapterListItemBase:
    def __init__(self) -> None: ...

class ImmAdapterDocumentOptionsBase:
    def __init__(self) -> None: ...

class ImmAdapterDocumentFragmentBase:
    def __init__(self) -> None: ...

class ImmAdapterCriticMarkupBase:
    def __init__(self) -> None: ...

class ImmAdapterDocumentBase:
    def __init__(self) -> None: ...

class ImmAdapterFileTargetBase:
    def __init__(self) -> None: ...

class ImmAdapterTextSeparatorBase:
    def __init__(self) -> None: ...

class ImmAdapterDocumentGroupBase:
    def __init__(self) -> None: ...

class ImmAdapterFileBase:
    def __init__(self) -> None: ...

class ImmAdapterDirectoryBase:
    def __init__(self) -> None: ...

class ImmAdapterSymlinkBase:
    def __init__(self) -> None: ...

class ImmAdapterCmdIncludeBase:
    def __init__(self) -> None: ...
...
class Stmt(Org):
    ...
    def getFirstAttrDouble(self, kind: str) -> Optional[float]: ...
...
class TimeRange(Org):
    ...
    def getClockedTimeSeconds(self) -> Optional[int]: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    from_: Time
    to: Time
...
class ImmStmtAdapter(ImmAdapterTBase[ImmStmt], ImmAdapterStmtAPI):
    def __init__(self) -> None: ...
    def getAttached(self) -> ImmVec[ImmIdTOrg]: ...

class ImmSubtreeAdapter(ImmAdapterTBase[ImmSubtree], ImmAdapterSubtreeAPI):
    def __init__(self) -> None: ...
    def getLevel(self) -> int: ...
    def getTreeId(self) -> Optional[str]: ...
    def getTodo(self) -> Optional[str]: ...
    def getCompletion(self) -> Optional[SubtreeCompletion]: ...
    def getDescription(self) -> Optional[ImmAdapterT[ImmParagraph]]: ...
    def getTags(self) -> ImmVec[ImmIdTHashTag]: ...
    def getTitle(self) -> ImmAdapter: ...
    def getLogbook(self) -> ImmVec[ImmIdTSubtreeLog]: ...
    def getProperties(self) -> ImmVec[NamedProperty]: ...
    def getClosed(self) -> Optional[ImmAdapterT[ImmTime]]: ...
    def getDeadline(self) -> Optional[ImmAdapterT[ImmTime]]: ...
    def getScheduled(self) -> Optional[ImmAdapterT[ImmTime]]: ...
...
class ImmErrorGroupAdapter(ImmAdapterTBase[ImmErrorGroup], ImmAdapterErrorGroupAPI):
    def __init__(self) -> None: ...
    def getDiagnostics(self) -> ImmVec[ImmIdTErrorItem]: ...

class ImmErrorSkipGroupAdapter(ImmAdapterTBase[ImmErrorSkipGroup], ImmAdapterErrorSkipGroupAPI):
    def __init__(self) -> None: ...
    def getSkipped(self) -> ImmVec[ImmIdTErrorSkipToken]: ...
...
class ImmInlineAdapter(ImmAdapterTBase[ImmInline], ImmAdapterInlineAPI):
    def __init__(self) -> None: ...
...
class ImmTimeRangeAdapter(ImmAdapterTBase[ImmTimeRange], ImmAdapterTimeRangeAPI):
    def __init__(self) -> None: ...
    def getFrom(self) -> ImmAdapter: ...
    def getTo(self) -> ImmAdapter: ...
...
class ImmSymbolAdapter(ImmAdapterTBase[ImmSymbol], ImmAdapterSymbolAPI):
    def __init__(self) -> None: ...
    def getName(self) -> str: ...
    def getParameters(self) -> ImmVec[ImmSymbolParam]: ...
    def getPositional(self) -> ImmVec[ImmIdTOrg]: ...
...
class ImmLeafAdapter(ImmAdapterTBase[ImmLeaf], ImmAdapterLeafAPI):
    def __init__(self) -> None: ...
    def getText(self) -> str: ...
...
class ImmMarkupAdapter(ImmAdapterTBase[ImmMarkup], ImmAdapterMarkupAPI):
    def __init__(self) -> None: ...
...
class ImmSubtreeLogAdapter(ImmAdapterTBase[ImmSubtreeLog], ImmAdapterSubtreeLogAPI):
    ...
    def getDesc(self) -> Optional[ImmAdapterT[ImmStmtList]]: ...
...
class ImmListItemAdapter(ImmAdapterTBase[ImmListItem], ImmAdapterListItemAPI):
    ...
    def getHeader(self) -> Optional[ImmAdapterT[ImmParagraph]]: ...
    def getBullet(self) -> Optional[str]: ...
...
class ImmDocumentOptionsAdapter(ImmAdapterTBase[ImmDocumentOptions], ImmAdapterDocumentOptionsAPI):
    ...
    def getMaxSubtreeLevelExport(self) -> Optional[int]: ...
    def getColumns(self) -> Optional[ColumnView]: ...
    def getTodoKeywords(self) -> ImmVec[TodoKeyword]: ...
    def getDoneKeywords(self) -> ImmVec[TodoKeyword]: ...

class ImmDocumentAdapter(ImmAdapterTBase[ImmDocument], ImmAdapterDocumentAPI):
    def __init__(self) -> None: ...
    def getTitle(self) -> Optional[ImmAdapterT[ImmParagraph]]: ...
    def getAuthor(self) -> Optional[ImmAdapterT[ImmParagraph]]: ...
    def getCreator(self) -> Optional[ImmAdapterT[ImmParagraph]]: ...
    def getFiletags(self) -> ImmVec[ImmIdTHashTag]: ...
    def getEmail(self) -> Optional[ImmAdapterT[ImmRawText]]: ...
    def getLanguage(self) -> ImmVec[str]: ...
    def getOptions(self) -> ImmAdapter: ...
    def getExportFileName(self) -> Optional[str]: ...

class ImmFileTargetAdapter(ImmAdapterTBase[ImmFileTarget], ImmAdapterFileTargetAPI):
    def __init__(self) -> None: ...
    def getPath(self) -> str: ...
    def getLine(self) -> Optional[int]: ...
    def getSearchTarget(self) -> Optional[str]: ...
    def getRestrictToHeadlines(self) -> bool: ...
    def getTargetId(self) -> Optional[str]: ...
    def getRegexp(self) -> Optional[str]: ...
...
class ImmCmdIncludeAdapter(ImmAdapterTBase[ImmCmdInclude], ImmAdapterCmdIncludeAPI):
    def __init__(self) -> None: ...
    def getPath(self) -> str: ...
    def getFirstLine(self) -> Optional[int]: ...
    def getLastLine(self) -> Optional[int]: ...
...
class ImmCmdAdapter(ImmAdapterTBase[ImmCmd], ImmAdapterCmdAPI):
    def __init__(self) -> None: ...
    def getAttrs(self) -> AttrGroup: ...
...
class ImmInlineFootnoteAdapter(ImmAdapterTBase[ImmInlineFootnote], ImmAdapterInlineFootnoteAPI):
    def __init__(self) -> None: ...
    def getTag(self) -> str: ...
    def getDefinition(self) -> Optional[ImmAdapter]: ...
...
class ImmLineCommandAdapter(ImmAdapterTBase[ImmLineCommand], ImmAdapterLineCommandAPI):
    def __init__(self) -> None: ...
...
class ImmBlockAdapter(ImmAdapterTBase[ImmBlock], ImmAdapterBlockAPI):
    def __init__(self) -> None: ...
...
class ImmRowAdapter(ImmAdapterTBase[ImmRow], ImmAdapterRowAPI):
    def __init__(self) -> None: ...
    def getCells(self) -> ImmVec[ImmIdTCell]: ...
    def getIsBlock(self) -> bool: ...
...
class ImmAttachedAdapter(ImmAdapterTBase[ImmAttached], ImmAdapterAttachedAPI):
    def __init__(self) -> None: ...
...
class ImmBlockCodeEvalResultAdapter(ImmAdapterTBase[ImmBlockCodeEvalResult], ImmAdapterBlockCodeEvalResultAPI):
    def __init__(self) -> None: ...
    def getRaw(self) -> ImmVec[OrgCodeEvalOutput]: ...
    def getNode(self) -> ImmAdapter: ...

class ImmBlockCodeAdapter(ImmAdapterTBase[ImmBlockCode], ImmAdapterBlockCodeAPI):
    def __init__(self) -> None: ...
    def getLang(self) -> Optional[str]: ...
    def getResult(self) -> ImmVec[ImmIdTBlockCodeEvalResult]: ...
    def getLines(self) -> ImmVec[BlockCodeLine]: ...
    def getSwitches(self) -> AttrGroup: ...

class ImmTableAdapter(ImmAdapterTBase[ImmTable], ImmAdapterTableAPI):
    def __init__(self) -> None: ...
    def getRows(self) -> ImmVec[ImmIdTRow]: ...
    def getIsBlock(self) -> bool: ...
...
def eachSubnodeRec(node: Org, callback: Callable) -> None: ...

def eachSubnodeRecSimplePath(node: Org, callback: Callable) -> None: ...
