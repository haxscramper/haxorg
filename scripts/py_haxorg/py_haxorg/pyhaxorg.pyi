...
class SubtreePropertyNonblocking:
    ...
    def operator==(self, other: SubtreePropertyNonblocking) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    isBlocking: bool
...
class SubtreePropertyTrigger:
    ...
    def operator==(self, other: SubtreePropertyTrigger) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...

class SubtreePropertyExportLatexClass:
    def __init__(self, latexClass: str) -> None: ...
    def operator==(self, other: SubtreePropertyExportLatexClass) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    latexClass: str
...
class SubtreePropertyExportLatexClassOptions:
    ...
    def operator==(self, other: SubtreePropertyExportLatexClassOptions) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    options: List[str]
...
class SubtreePropertyExportLatexHeader:
    ...
    def operator==(self, other: SubtreePropertyExportLatexHeader) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    header: str
...
class SubtreePropertyExportLatexCompiler:
    ...
    def operator==(self, other: SubtreePropertyExportLatexCompiler) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    compiler: str
...
class SubtreePropertyOrdered:
    ...
    def operator==(self, other: SubtreePropertyOrdered) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    isOrdered: bool
...
class SubtreePropertyEffort:
    ...
    def operator==(self, other: SubtreePropertyEffort) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    hours: int
    minutes: int
...
class SubtreePropertyVisibility:
    ...
    def operator==(self, other: SubtreePropertyVisibility) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
...
class SubtreePropertyExportOptions:
    ...
    def operator==(self, other: SubtreePropertyExportOptions) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    backend: str
    values: Dict[str, str]
...
class SubtreePropertyBlocker:
    ...
    def operator==(self, other: SubtreePropertyBlocker) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    blockers: List[str]
...
class SubtreePropertyUnnumbered:
    def __init__(self) -> None: ...
    def operator==(self, other: SubtreePropertyUnnumbered) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...

class SubtreePropertyCreated:
    def __init__(self, time: UserTime) -> None: ...
    def operator==(self, other: SubtreePropertyCreated) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    time: UserTime

class SubtreePropertyCustomArgs:
    def __init__(self, name: str, sub: Optional[str], parameters: List[str]) -> None: ...
    def operator==(self, other: SubtreePropertyCustomArgs) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    name: str
    sub: Optional[str]
...
class SubtreePropertyCustomRaw:
    def __init__(self, name: str, value: str) -> None: ...
    def operator==(self, other: SubtreePropertyCustomRaw) -> bool: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    name: str
    value: str

SubtreePropertyData = Union[SubtreePropertyNonblocking, SubtreePropertyTrigger, SubtreePropertyExportLatexClass, SubtreePropertyExportLatexClassOptions, SubtreePropertyExportLatexHeader, SubtreePropertyExportLatexCompiler, SubtreePropertyOrdered, SubtreePropertyEffort, SubtreePropertyVisibility, SubtreePropertyExportOptions, SubtreePropertyBlocker, SubtreePropertyUnnumbered, SubtreePropertyCreated, SubtreePropertyCustomArgs, SubtreePropertyCustomRaw]
class SubtreePropertyKind(Enum):
    Nonblocking = 1
    Trigger = 2
    ExportLatexClass = 3
    ExportLatexClassOptions = 4
    ExportLatexHeader = 5
    ExportLatexCompiler = 6
    Ordered = 7
    Effort = 8
    Visibility = 9
    ExportOptions = 10
...
class SubtreeProperty:
    ...
    def operator==(self, other: SubtreeProperty) -> bool: ...
