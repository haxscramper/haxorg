...
class GraphMapNodeProp:
    def __init__(self, unresolved: list[GraphMapLink]) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
...
class GraphMapGraphState:
    ...
    def addNode(self, node: ImmAdapter, conf: GraphMapConfig) -> GraphVertexID: ...
    def addNodeRec(self, ast: ImmAstContext, node: ImmAdapter, conf: GraphMapConfig) -> None: ...
    def getUnresolvedSubtreeLinks(self, node: ImmSubtreeAdapter) -> list[GraphMapLink]: ...
    def getUnresolvedLink(self, node: ImmLinkAdapter) -> Optional[GraphMapLink]: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    graph: GraphMapGraph
    ast: ImmAstContext
...
class GraphMapGraph(OperationsTracer):
    def __init__(self) -> None: ...
    @overload
    def isRegisteredNode(self, id: GraphMapNode) -> bool: ...
    @overload
    def isRegisteredNode(self, id: ImmUniqId) -> bool: ...
    def addEdge(self, edge: GraphMapEdge, prop: GraphMapEdgeProp, source: GraphVertexID, target: GraphVertexID) -> GraphEdgeID: ...
    def addNode(self, node: GraphMapNode, prop: GraphMapNodeProp) -> GraphVertexID: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
...
class GraphEdgeID(GraphEdgeIDBase):
    def __init__(self) -> None: ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
