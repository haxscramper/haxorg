...
class CmdIncludeIncludeBase:
    def __init__(self, minLineRange: Optional[int], maxLineRange: Optional[int]) -> None: ...
    def IncludeBase(self) ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    minLineRange: Optional[int]
    maxLineRange: Optional[int]
...
class CmdIncludeOrgDocument(CmdIncludeIncludeBase):
    def __init__(self, subtreePath: Optional[str], minLevel: Optional[int], customIdTarget: Optional[str]) -> None: ...
    def OrgDocument(self) ...
    def __repr__(self) -> str: ...
    def __getattr__(self, name: str) -> object: ...
    subtreePath: Optional[str]
    minLevel: Optional[int]
    customIdTarget: Optional[str]

CmdIncludeData = Union[CmdIncludeExample, CmdIncludeExport, CmdIncludeSrc, CmdIncludeOrgDocument]
