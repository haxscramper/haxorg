            ...
            nested=[
                GenTuTypeGroup(
                    [
                        ...
                        GenTuStruct(t_nest("Footnote", ["AnnotatedParagraph"]), fields=[GenTuField(t_str(), "name")]),
                        GenTuStruct(
                ...
                org_struct(
                    ...
                    nested=[
                        ...
                        GenTuTypeGroup(
                            [
                                org_struct(
                                    t_nest("DoExport", ["DocumentOptions", "ExportConfig"]),
                                    fields=[org_field(t_bool(), "exportToc")],
                                ),
                                org_struct(
                                    t_nest("ExportFixed", ["DocumentOptions", "ExportConfig"]),
