...
function initialDocumentVisibility(d) {
  switch (d.visibility) {
    case "overview":
      ...
      if (d.depth > 1) hideDirectSubnodes(d);
      break;
    case "content":
      // Show the root and its direct children
      if (d.depth > 2) hideDirectSubnodes(d);
      break;
    case "showall":
      // No-op, since all nodes are initially visible
      break;
    case "show2levels":
      ...
      break;
    case "show3levels":
      if (d.depth > 3) hideDirectSubnodes(d);
      break;
    case "show4levels":
      if (d.depth > 4) hideDirectSubnodes(d);
      break;
    case "show5levels":
      if (d.depth > 5) hideDirectSubnodes(d);
      break;
    case "showeverything":
      // No-op, since all nodes are initially visible
      break;
