...
//            << "\n";
//         Vec<Pair<FormattedDiff::DiffLine, FormattedDiff::DiffLine>>
//         lines; for (auto const& pair : text.unifiedLines()) {
...
//            auto lhsStyle = useQFormat ? ColStyle() :
//            toStyle(lhs.prefix); auto rhsStyle = useQFormat ? ColStyle()
//            : toStyle(rhs.prefix);
...
//                        ? ColText("")
//                        : ColText(
//                            lhsStyle, formatCb(lhs.index().value(),
//                            true)))
//                   <<= lhsSize)
//               << (useQFormat
//                       ? ColText("")
...
//                       node.isTerminal()
//                           ? "tok=" +
//                           to_string(node.getToken().getIndex()) : "ext="
...
//        if (spec.dbg.doParse) {
//            MockFull::ParserMethod parseCb =
//            getParser(spec.parseImplName);
...
//                .with_message(
//                    "Original definition of " + fiveColorized + " is
//                    here")
//                .with_color(a))
//        .with_note(
//            natColorized
...
//                .with_message("This is of type Str"_qs))
//        .with_label(
//            Label(std::make_shared<TupleCodeSpan>(id, slice(81, 124 +
//            1)))
//                .with_message("This is of type Nat"_qs))
//        .with_label(
//            Label(std::make_shared<TupleCodeSpan>(id, slice(100, 126 +
//            1)))
//                .with_message("This is an inner multi-line"_qs))
//        .with_label(
//            Label(std::make_shared<TupleCodeSpan>(id, slice(106, 120 +
//            1)))
//                .with_message("This is another inner multi-line"_qs))
//        .with_label(
//            Label(std::make_shared<TupleCodeSpan>(id, slice(108, 122 +
//            1)))
//                .with_message("This is *really* nested multi-line"_qs))
//        .with_label(
//            Label(std::make_shared<TupleCodeSpan>(id, slice(110, 111 +
//            1)))
//                .with_message(
//                    "This is an inline within the ne  b   bsting!"_qs))
//        .with_label(
//            Label(std::make_shared<TupleCodeSpan>(id, slice(111, 112 +
//            1)))
//                .with_message("And another!"_qs))
//        .with_label(
//            Label(std::make_shared<TupleCodeSpan>(id, slice(103, 123 +
//            1)))
//                .with_message("This is *really* nested multi-line"_qs))
//        .with_label(
//            Label(std::make_shared<TupleCodeSpan>(id, slice(105, 125 +
//            1)))
//                .with_message("This is *really* nested multi-line"_qs))
//        .with_label(
//            Label(std::make_shared<TupleCodeSpan>(id, slice(112, 116 +
//            1)))
//                .with_message("This is *really* nested multi-line"_qs))
//        .with_label(
//            Label(std::make_shared<TupleCodeSpan>(id, slice(26, 100 +
//            1)))
//                .with_message("Hahaha!"_qs))
//        .with_label(
//            Label(std::make_shared<TupleCodeSpan>(id, slice(85, 110 +
//            1)))
//                .with_message("Oh god, no more 1"_qs))
//        .with_label(
//            Label(std::make_shared<TupleCodeSpan>(id, slice(84, 114 +
//            1)))
//                .with_message("Oh god, no more 2"_qs))
//        .with_label(
//            Label(std::make_shared<TupleCodeSpan>(id, slice(89, 113 +
//            1)))
