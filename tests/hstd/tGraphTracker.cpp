...
//         .Times(0);
//     EXPECT_CALL(*mock_processor, track_function_end(_, _, _,
//     _)).Times(0);
...
//     EXPECT_CALL(*mock_processor, track_started(_, _, _)).Times(1);
//     EXPECT_CALL(
//         *mock_processor, track_signal_emit("test_signal", args, _, _,
//         _)) .Times(1);
...
//     EXPECT_CALL(*mock_processor, track_started(_, _, _)).Times(1);
//     EXPECT_CALL(*mock_processor, track_scope_enter("test_scope", _, _,
//     _))
//         .Times(1);
//     EXPECT_CALL(*mock_processor, track_scope_exit("test_scope", _, _,
//     _))
//         .Times(1);
...
//     EXPECT_CALL(*mock_processor, track_started(_, _, _)).Times(1);
//     EXPECT_CALL(*mock_processor, track_named_text("key", "value", _, _,
//     _))
//         .Times(1);
...
//         } tracker->notify_named_jump("i calls k"); k(tracker);
//     }
// }
