...
TEST_F(GraphAdaptagramsRaw_Test, LibcolaApi) {
...
TEST_F(GraphAdaptagramsRaw_Test, LibcolaRaw3) {
    std::vector<std::pair<unsigned, unsigned>> edges{
        {0, 1},
        {1, 2},
        {2, 3},
...
TEST_F(GraphAdaptagramsRaw_Test, BuildsAndRendersFinalizedGraphWithPins) {
...
TEST_F(GraphAdaptagramsRaw_Test, HolaLayoutRaw1) {
    dialect::Graph g;
...
TEST_F(GraphAdaptagramsRaw_Test, tHolaIr1) {
    dialect::Graph g;
